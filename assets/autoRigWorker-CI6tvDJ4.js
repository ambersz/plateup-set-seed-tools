var Ns=Object.defineProperty;var ws=(_,se,he)=>se in _?Ns(_,se,{enumerable:!0,configurable:!0,writable:!0,value:he}):_[se]=he;var y=(_,se,he)=>ws(_,typeof se!="symbol"?se+"":se,he);(function(){"use strict";class _{constructor(e,a){y(this,"array");y(this,"objectiveFunctions");this.array=se(e,a),this.objectiveFunctions=a}clear(){this.array=[]}add(e){let a=this.array.length;for(;a--;){let{better:l,worse:r}=he(e,this.array[a],this.objectiveFunctions);if(r)return!1;l&&this.array.splice(a,1)}return this.array.push(e),!0}}function se(s,e){if(!s.length)return s;const a=[...s];let l=[];l.push(a.pop());e:for(;a.length;){const r=a.pop();let t=l.length;for(;t--;){let{better:F,worse:c}=he(r,l[t],e);if(c)continue e;F&&l.splice(t,1)}l.push(r)}return l}function he(s,e,a){let l=!0,r=!0,t=0;for(;(l||r)&&t<a.length;){const F=a[t](s,e);F<0?r=!1:F>0&&(l=!1),t++}return{better:l,worse:r}}var Ze=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False,False,60\r
...
`;const Xe=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing","AllowRefreshes","PurchaseCost"],es=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean","boolean","number"],ne=Ze.trim().split(`\r
`).map(s=>{const e=s.split(",");let a={};for(let l=0;l<e.length;l++){let r;switch(es[l]){case"number":r=Number(e[l]);break;case"boolean":r=e[l]==="True";break;case"number[]":e[l]===""?r=[]:r=e[l].split(":").map(t=>Number(t));break;default:r=e[l]}a[Xe[l]]=r}return a});class ss{constructor(e){y(this,"Staple");y(this,"Tags");y(this,"StapleWhenMissing");y(this,"Appliance");y(this,"IsRemoved");y(this,"Filter");y(this,"DecorationRequired");y(this,"SellAsUpgrade");this.Appliance=e,this.Tags=e.ShoppingTags,this.DecorationRequired=e.ThemeRequired,this.SellAsUpgrade=e.IsPurchasableAsUpgrade,this.Filter=e.ShopRequirementFilter,this.StapleWhenMissing=e.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(e){return e&1?this.Staple!==0:e&this.Tags?this.Staple===0:!1}}var ae=(s=>(s[s.NonStaple=0]="NonStaple",s[s.FixedStaple=1]="FixedStaple",s[s.BonusStaple=2]="BonusStaple",s[s.WhenMissing=3]="WhenMissing",s))(ae||{}),de=(s=>(s[s.None=0]="None",s[s.Basic=1]="Basic",s[s.Decoration=2]="Decoration",s[s.Technology=4]="Technology",s[s.FrontOfHouse=8]="FrontOfHouse",s[s.Plumbing=16]="Plumbing",s[s.Cooking=32]="Cooking",s[s.Automation=64]="Automation",s[s.Christmas=128]="Christmas",s[s.Misc=256]="Misc",s[s.Office=512]="Office",s[s.BlueprintUpgrader=1024]="BlueprintUpgrader",s[s.BlueprintStore=2048]="BlueprintStore",s[s.Halloween=4096]="Halloween",s[s.SpecialEvent=8192]="SpecialEvent",s))(de||{});const Oe={DefaultShoppingTag:892};var Ee=(s=>(s[s.None=0]="None",s[s.RefreshableProvider=1]="RefreshableProvider",s))(Ee||{}),De=(s=>(s[s.Null=0]="Null",s[s.Exclusive=1]="Exclusive",s[s.Affordable=2]="Affordable",s[s.Charming=4]="Charming",s[s.Formal=8]="Formal",s[s.Kitchen=16]="Kitchen",s))(De||{}),as="38";const ls=Number(as);function rs(s,e){return Math.floor(Math.random()*(e-s))+s}function Fs(s,e){let a=s.length;for(;a-- >1;){let l=e===void 0?rs(0,a+1):e.range(0,a+1);[s[a],s[l]]=[s[l],s[a]]}return s}const ns="1c,1d,1e,1f,1g,1h,1i,1j,1k,1l,1m,1n,1o,1p,1q,1r,1s,1t,1u,1v,1w,1x,1y,1z,13,14,15,16,17,18,19,2c,2d,2e,2f,2g,2h,2i,2j,2k,2l,2m,2n,2o,2p,2q,2r,2s,2t,2u,2v,2w,2x,2y,2z,23,24,25,26,27,28,29,3c,3d,3e,3f,3g,3h,3i,3j,3k,3l,3m,3n,3o,3p,3q,3r,3s,3t,3u,3v,3w,3x,3y,3z,33,34,35,36,37,38,39,4c,4d,4e,4f,4g,4h,4i,4j,4k,4l,4m,4n,4o,4p,4q,4r,4s,4t,4u,4v,4w,4x,4y,4z,43,44,45,46,47,48,49,5c,5d,5e,5f,5g,5h,5i,5j,5k,5l,5m,5n,5o,5p,5q,5r,5s,5t,5u,5v,5w,5x,5y,5z,53,54,55,56,57,58,59,6c,6d,6e,6f,6g,6h,6i,6j,6k,6l,6m,6n,6o,6p,6q,6r,6s,6t,6u,6v,6w,6x,6y,6z,63,64,65,66,67,68,69,7c,7d,7e,7f,7g,7h,7i,7j,7k,7l,7m,7n,7o,7p,7q,7r,7s,7t,7u,7v,7w,7x,7y,7z,73,74,75,76,77,78,79,8c,8d,8e,8f,8g,8h,8i,8j,8k,8l,8m,8n,8o,8p,8q,8r,8s,8t,8u,8v,8w,8x,8y,8z,83,84,85,86,87,88,89".split(",");for(const s of ns);function Me(s){return s.length?s.reduce((e,a)=>e+a,0)/s.length:0}class fe{constructor(e,a){y(this,"fixedSeed");y(this,"instance");y(this,"random");typeof e=="string"&&(e=ts(e)),this.fixedSeed=e,this.instance=a,this.random=new He(e+Math.imul(124192293,a))}useSubcontext(e){return new fe(this.fixedSeed,124192293*e+this.instance)}}class He{constructor(e){y(this,"seed");const a=c=>Math.imul(1812433253,c)+1>>0,l=e>>0,r=a(l),t=a(r),F=a(t);this.seed=[l,r,t,F]}get value(){let e=this.seed.shift(),a=this.seed[2];return e^=e<<11,e^=e>>>8,a^=a>>>19,a=(a^e)>>0,this.seed.push(a),a}range(e,a){return(this.value>>>0)%(a-e)+e}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(e){return e[this.range(0,e.length)]}}function ts(s){const a=new TextEncoder().encode(s);let l=5381,r=a.length;for(;r--;)l=(l<<5)+l+a[r];return l>>0}function qe(s,e,a){return new fe(a,s*1231231+e)}var me=(s=>(s[s.Generic=0]="Generic",s[s.Dish=1]="Dish",s[s.PrimaryTheme=3]="PrimaryTheme",s[s.SecondaryTheme=4]="SecondaryTheme",s[s.Franchise=5]="Franchise",s[s.Special=6]="Special",s))(me||{}),H=(s=>(s[s.Base=0]="Base",s[s.Main=1]="Main",s[s.Extra=2]="Extra",s[s.Side=3]="Side",s[s.Starter=4]="Starter",s[s.Dessert=5]="Dessert",s[s.Null=6]="Null",s))(H||{});const is=["Sink","Plates","Dish Rack","Dish Washer","Power Sink","Soaking Sink","Auto Plater"],Ge={};for(const s of is)Ge[s]=!0;const os=ne.filter(s=>s.IsPurchasable||s.IsPurchasableAsUpgrade).length;class us{constructor(e,a=0){y(this,"seed");y(this,"mapSize");y(this,"numTiles");y(this,"baseUpgradeChance");y(this,"OwnedAppliances");y(this,"Cards");y(this,"Theme");y(this,"cache",new Map);y(this,"cacheDay");this.seed=e,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=a,this.OwnedAppliances=[],this.Cards=[],this.Theme=De.Null,this.cacheDay=-1}getLayoutInfo(){const a=new fe(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,r;switch(a){case 0:r=70,l=2;break;case 4:r=84,l=2;break;case 1:case 5:r=60,l=1;break;case 2:case 6:r=9*13,l=3;break;case 3:case 7:r=12*16,l=4;break;default:throw new Error}return[l,r]}handleNewCardSpawnEffects(e){e!==void 0&&(e.Name==="Turbo"&&(this.baseUpgradeChance=.25),e.UnlockGroup===me.PrimaryTheme&&(this.Theme=De[e.Name]))}handleNewCardRerollEffects(e){e!==void 0&&(this.OwnedAppliances=this.OwnedAppliances.concat(e.IngredientProviders.flatMap(a=>ne.filter(l=>l.ID===a))))}addCard(e){e!==void 0&&(this.handleNewCardSpawnEffects(e),this.handleNewCardRerollEffects(e),this.Cards.push(e))}getPrngAdvancements(e,a){let l=0;for(let r=0;r<e.length;r++){const t=e[r];let F=t.blueprintCount;a%5===0&&(F+=3,r===0&&(F+=2)),l+=F*(os-1+1),t.spawnInside||(l+=cs(t.playerInside,this.numTiles)),l+=ls}return l}buildShopOptions(e,a,l){const r=l.some(c=>c.Name==="Couples");let t=[];for(const c of ne)if(!(!c.IsPurchasable&&!c.IsPurchasableAsUpgrade)){var F=new ss(c);const d=F.Appliance.Name;(F.Staple==ae.NonStaple||F.Staple==ae.WhenMissing)&&((F.Tags&de.Basic)>de.None?F.Staple=ae.FixedStaple:F.StapleWhenMissing?(d!="Research Desk"&&d!="Blueprint Cabinet"&&d!="Plates"&&console.log(`Unexpected ${d} StapleWhenMissing Appliance`),e.some(i=>i.ID===F.Appliance.ID)?F.Staple=ae.NonStaple:F.Staple=ae.WhenMissing):r&&d==="Flower Pot"&&(F.Staple=ae.BonusStaple));const u=F.Appliance;if(u.SellOnlyAsDuplicate)e.some(i=>i.ID===u.ID)||(F.IsRemoved=!0);else if(u.RequiresForShop.length>0){let i=!1;for(const p of u.RequiresForShop)e.some(v=>v.ID===p)&&(i=!0);F.IsRemoved=!i}else u.SellOnlyAsUnique&&(u.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${u.Name}, ${u.ID}`),e.some(i=>i.ID===u.ID)&&(F.IsRemoved=!0));Ge[d]&&l.every(i=>!i.isMain||i.Name==="Tacos")&&(F.IsRemoved=!0),F.Filter==Ee.RefreshableProvider&&(e.some(i=>i.AllowRefreshes)||(F.IsRemoved=!0)),F.DecorationRequired!=De.Null&&F.DecorationRequired!=a&&(F.IsRemoved=!0),u.RequiresProcessForShop.length>0&&(u.RequiresProcessForShop.some(i=>l.some(p=>p.RequiredProcesses.includes(i)))||(F.IsRemoved=!0)),t.push(F)}return t}initRandom(e){return qe(823828,e,this.seed)}getAppliances(e,a){a!==this.cacheDay&&(this.cacheDay=a,this.cache.clear());const l=e.length===1,r=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards);let t=e[e.length-1].blueprintCount,F;if(a%5==0){l?t=10:t+=3,F=[];for(let u=0;u<t;u++)F[u]=de.Decoration;if(l)for(const u of[1,2])F[F.length-u]=de.SpecialEvent}else if(e.length>1){F=[];for(let u=0;u<t;u++)F[u]=Oe.DefaultShoppingTag}else{const u=Oe.DefaultShoppingTag,i=Math.max(1,t),p=Math.max(0,Math.min(r.filter(g=>g.Staple!==ae.NonStaple&&!g.IsRemoved).length,Math.max(2,4-Math.floor(a/5)),i)),v=Math.max(0,i-p);t=i,F=[];for(let g=0;g<p;g++)F[g]=de.Basic;for(let g=p;g<p+v;g++)F[g]=u}const c=this.initRandom(a).random;let o=this.getPrngAdvancements(e.slice(0,e.length-1),a);if(this.cache.has(o)&&this.cache.get(o).length>=t)return this.cache.get(o).slice(0,t);const d=o;for(;o--;)c.value;{const u=[...r],i=[],p=this.getUpgradeChance(a),v=[];for(let g=0;g<t;g++){const C=F[g],B=c.valueFloat<p;Fs(u,c);for(let L=0;L<u.length;L++){const q=u[L];if(q.IsRemoved||v.includes(q.Appliance)||!q.MatchesRequestTags(C)||!B&&q.Staple==ae.NonStaple&&q.SellAsUpgrade)continue;C!=de.Decoration&&v.push(q.Appliance),i[g]=q.Appliance;break}i[g]==null}return this.cache.set(d,i),i}}getUpgradeChance(e){return 1-(1-Math.floor(e/5)*.1)*(1-this.baseUpgradeChance)}}function cs(s,e){return s?e-2:e-1}var hs=`373996608,Ice Cream,1,,,,-1533430406,False,False,5,1,2\r
...
`,ds=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0,0,5\r
1356267749,Salad,1,2087693779,1193867305:-712909563:380220741,True,False,0,-1,5\r
550743424,Pizza,1,2087693779:-1706154991:-523839730,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0,0,5\r
367917843,Dumplings,1,1972879238:-523839730:2087693779,925796718:-484165118:-452101383:380220741,True,False,0,2,8\r
16318784,Black Coffee,1,-1316622579,-1609758240,False,False,0,-2,1\r
...
-2075899,Breakfast,1,-523839730:-1706154991,380220741:925796718,True,False,0,0,5\r
-1653221873,Stir Fry,1,2087693779:1972879238,-452101383:-1573812073:380220741:-1201769154:314862254,True,False,0,1,10\r
`;const be=hs.trim().split(`\r
`).filter(s=>s).map(s=>{var U,Se;const[e,a,l,r,t,F,c,o,d,u,i,p]=s.split(","),v=Number(e),g=Number(l),C=r!=null&&r.length?r.split(":").map(le=>Number(le)):[],S=t.length?t.split(":").map(le=>Number(le)):[],B=F!=null&&F.length?(U=F==null?void 0:F.split(":"))==null?void 0:U.map(le=>Number(le)):[],L=c!=null&&c.length?(Se=c==null?void 0:c.split(":"))==null?void 0:Se.map(le=>Number(le)):[],q=o==="True",j=d==="True",k=Number(u),ie=Number(i),K=Number(p);return{ID:v,Name:a,UnlockGroup:g,Requires:C,BlockedBy:S,RequiredProcesses:B,IngredientProviders:L,isMain:q,isStarterOrSide:j,DishType:k,CustomerMultiplier:ie,DishValue:K}}),fs=[...[{ID:447437163,Name:"Country",UnlockGroup:me.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:H.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:me.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:H.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:me.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:H.Null,CustomerMultiplier:0,DishValue:0},be.filter(s=>s.Name==="Community")[0],be.filter(s=>s.Name==="Couples")[0],{ID:1958825350,Name:"Turbo",UnlockGroup:me.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:H.Null,CustomerMultiplier:0,DishValue:0},be.filter(s=>s.Name==="Christmas Rush")[0]]].sort((s,e)=>s.Name<e.Name?-1:1);["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(s=>be.filter(e=>e.Name===s)[0]),ds.trim().split(`\r
`).filter(s=>s).map(s=>{var j,k;const[e,a,l,r,t,F,c,o,d,u]=s.split(","),i=Number(e),p=Number(l),v=r!=null&&r.length?(j=r==null?void 0:r.split(":"))==null?void 0:j.map(ie=>Number(ie)):[],g=t!=null&&t.length?(k=t==null?void 0:t.split(":"))==null?void 0:k.map(ie=>Number(ie)):[],C=F==="True",S=c==="True",B=Number(o),L=Number(d),q=Number(u);return{ID:i,Name:a,UnlockGroup:p,Requires:[],BlockedBy:[],RequiredProcesses:v,IngredientProviders:g,isMain:C,isStarterOrSide:S,DishType:B,CustomerMultiplier:L,DishValue:q}}).sort((s,e)=>s.Name<e.Name?-1:1);const gs=[7,8,8,8,8,10,10,8,9,9,9,10,9,10,10],ps=[122,143,159,169,169,215,215,218,240,252,252,288,263,300,300],Re={};function te(s){if(Re[s]===void 0&&(Re[s]=ne.filter(e=>e.Name===s)[0]),Re[s]===void 0){console.error(`Could not find ${s} appliance`);debugger}return Re[s]}const ms=[(s,e)=>s[0]-e[0],(s,e)=>s[1]-e[1]];function Ce(s){let e=0;(s==null?void 0:s.deskTime)!==void 0&&(e+=s.deskTime);for(const a of Object.values(s.achieved))e+=s.cumulativeRerolls*2,e+=s.actionHistory.filter(l=>l==="spawn OI"||l==="spawn OO").length*3,e+=s.actionHistory.reduce((l,r)=>{var t;return r.includes("take ")?l+3+Number((t=r.match(/(\d+)/))==null?void 0:t[0]):l},0),e+=a.goalsPurchased+a.substitutesPurchased;return e}function we(s,e){return(a,l)=>{const r=a.achieved[e],t=l.achieved[e],F=Math.min(r.goalsPurchased,s);let o=Math.min(t.goalsPurchased,s)-F;return o===0?r.goalsPurchased>=s||r.goalsPurchased+r.substitutesPurchased>=s&&t.goalsPurchased+t.substitutesPurchased>=s?r.goalsPurchased+r.substitutesPurchased-(t.goalsPurchased+t.substitutesPurchased):t.substitutesPurchased-r.substitutesPurchased:o}}const ze={"Copying Desk":3,"Metal Table":4,"Power Sink":4,"Dish Washer":4,"Wash Basin":4,"Soaking Sink":4,"Heated Mixer":3,"Conveyor Mixer":3,"Rapid Mixer":3,"Danger Hob":2,"Safety Hob":2,"Grabber - Rotating":2,"Smart Grabber":2};function Ts(s,e,a,l,r=!0,t=ps,F=gs,c=()=>{}){var Ke,_e,Ye,Je;let o={},d=[];const u=[],i=new Array(l.length).fill(0).map(()=>({})),p={};let v=0,g=0;const C={},S=e.some(m=>m.Name==="Turbo"),B=[];let L=[],q=0;const j={};for(const m of l){for(const h of m){const{goal:P,number:I,substitutes:x,skipMissing:R=!1}=h;for(const M of x)p[M]||(p[M]=[]),p[M].push(P),M==="Flower Pot"&&console.log({substitutesToGoalMap:p});j[P]?R||(j[P].number+=I):(j[P]={...h},R&&(j[P].number=0));for(let M=0;M<=q;M++){if(i[M]===void 0)debugger;i[M][P]?i[M][P].number+=I:i[M][P]={...h}}for(let M=q+1;M<i.length;M++){if(i[M]===void 0)debugger;i[M][P]||(i[M][P]={...h,number:0})}R||(g+=te(P).PurchaseCost*I*(S?.5:1))}try{u.push(JSON.parse(JSON.stringify(j)))}catch{console.log(i),console.log(i[0]);debugger}q++}const k=i[0],ie=Object.values(k).sort((m,h)=>te(m.goal).PurchaseCost-te(h.goal).PurchaseCost).map(m=>m.goal);o=u.shift();for(const m of Object.values(k)){const{goal:h,number:P}=m;C[h]={...m,substitutesPurchased:0,goalsPurchased:0},m.goal!=="Starter Bin"&&(B.push(we(P,h)),L.push(we(P,h)))}const K=new _([],[...B,(m,h)=>h.money-m.money,(m,h)=>Ce(m)-Ce(h),(m,h)=>m.actionHistory.length-h.actionHistory.length,(m,h)=>m.cumulativeRerolls-h.cumulativeRerolls,(m,h)=>(m.day+1)%5?m.upgradesInProgress-h.upgradesInProgress:0]),U=S?7:5,Se=[{spawnInside:!0,blueprintCount:U},{spawnInside:!1,playerInside:!1,blueprintCount:U}];r||Se.push({spawnInside:!1,playerInside:!0,blueprintCount:U});const le=[{spawnInside:!0,blueprintCount:U},{spawnInside:!1,playerInside:!0,blueprintCount:U},{spawnInside:!1,playerInside:!1,blueprintCount:U}];function Ue(m,h,P){const I={...m};for(const x of Object.values(h)){const R=x.goal;I[R]={...I[R]},R==="Copying Desk"&&(I[R].goalsPurchased+=I[R].substitutesPurchased,I[R].substitutesPurchased=0),I[R].goalsPurchased+=x.goalsPurchased,P&&(I[R].substitutesPurchased+=x.substitutesPurchased)}return I}let ye=[];function Ve(m,h,P,I=!1){var Z,W,b,A,O,f,n;const x=h.fodderUsed,R=Object.values(h.achieved).some(T=>T.substitutesPurchased)&&!((Z=h.achieved["Research Desk"])!=null&&Z.goalsPurchased),M=h.actionHistory.at(-1)==="buy Blueprint Cabinet"&&((W=h.actionHistory.at(-2))!=null&&W.includes("reroll"))?1:0;e:for(const T of m){if(R&&!We&&!((b=T.achieved["Research Desk"])!=null&&b.goalsPurchased))continue;let D=1+(T.achieved["Copying Desk"].goalsPurchased?1:0);const Y=Math.floor(Math.max(0,T.achieved["Blueprint Cabinet"].goalsPurchased-d.length));let z=Y;if(z-=T.upgradesInProgress,z*=D,z<0||z<x)continue;let E=T.cumulativeRerolls+h.cumulativeRerolls,X=E*(E+1)/2*10+T.applianceCosts;const Te=h.actionHistory.length?Ue(T.achieved,h.achieved,!1):T.achieved,N=h.actionHistory.length?Ue(T.achieved,h.achieved,!0):T.achieved,J=bs(o,Te);if(Q<=0&&J>0||h.cumulativeRerolls&&X>$)continue;let oe=0,re=0,ue=[],pe=0,Pe=1;const ve=N["Blueprint Cabinet"].goalsPurchased-d.length-M,xe=(((A=T.achieved["Discount Desk"])==null?void 0:A.goalsPurchased)??0)+(((O=T.achieved["Discount Desk"])==null?void 0:O.substitutesPurchased)??0)?.5:1;{let Fe=$-X;for(const ee of ie){const G=h.achieved[ee];Fe-=G.goalsPurchased*te(G.goal).PurchaseCost*(S?.5:1)*xe;let Qe=!1;(Fe<0||G.substitutesPurchased)&&(G.goal==="Copying Desk"&&re&&(re=0,pe--),Qe=!0,Fe<0&&(oe+=G.goalsPurchased),oe+=G.substitutesPurchased,G.substitutesPurchased&&(pe++,ze[G.goal]&&(Pe*=ze[G.goal]))),(G.goal==="Metal Table"||G.goal==="Grabber - Rotating"||G.goal==="Portioner"||G.goal==="Grabber")&&G.goalsPurchased+G.substitutesPurchased&&N[ee].goalsPurchased+N[ee].substitutesPurchased<N[ee].number&&(T.achieved["Copying Desk"].goalsPurchased||N["Copying Desk"].goalsPurchased&&Fe>60)&&(Qe||re++,re++,ue.push(G.goal),pe++)}if(oe>ve)continue e}X+=h.applianceCosts*xe;const Bs=T.deskTime+(Pe-1)*20+Math.max(0,x-Y)*5*((f=T.achieved["Clipboard Stand"])!=null&&f.goalsPurchased?.5:1)+(pe*Pe*5+(F[h.day]??F.at(-1)??0))*((n=N["Clipboard Stand"])!=null&&n.goalsPurchased?.5:1),ce={...h,rerollConfigs:[...T.rerollConfigs,h.rerollConfigs],achieved:N,money:$-X,actionHistory:[...T.actionHistory,...h.actionHistory],upgradesInProgress:oe,cumulativeRerolls:T.cumulativeRerolls+h.cumulativeRerolls,applianceCosts:T.applianceCosts+h.applianceCosts*xe,deskTime:Bs};if(!(oe>ve)){if(re&&(re===1||oe+1<=ve))for(const Fe of ue)ce.upgradesInProgress+=re,N[Fe].goalsPurchased++,ce.actionHistory.push(`copy ${Fe}`),ce.applianceCosts+=30;if(ce.money>=0&&(!ce.upgradesInProgress||u.length)){if(J<Q&&(Q=J,console.log(`best so far missing ${J} pieces `+Be(ce,$))),J<=0){if(K.add(ce)){if(je(),K.array[0].deskTime<-1e4*60){console.log("uh, can I quit from this function?");break}continue}}else if(Q<=0)continue}if(z>v&&(v=z),I){const Fe=T.cumulativeRerolls;for(let ee=0;ee<=z;ee++)ye[ee]===void 0&&(ye[ee]=new _([],ms)),ye[ee].add([Fe,X]);continue}P.add(ce)}}return Q}const Ae={...C};Ae["Blueprint Cabinet"]={...Ae["Blueprint Cabinet"],goalsPurchased:1};const ke=new _([{achieved:Ae,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,rerollConfigs:[],upgradesInProgress:0,day:0,numFloor:0,money:0,fodderAvailable:0,deskTime:0}],[...B,(m,h)=>m.applianceCosts-h.applianceCosts,(m,h)=>m.cumulativeRerolls-h.cumulativeRerolls]);let Q=1/0,w=0,$=0;const V=new us(s),Ne=["Research Desk"];let We=!1,ge=[];{const m=["Booking Desk","Blueprint Cabinet"];ne.filter(h=>m.includes(h.Name)).forEach(h=>V.OwnedAppliances.push(h))}for(const m of e)V.addCard(m);function Rs(m,h,P){var Z;let I=[{...m}],x=[],R=[];const M=JSON.parse(JSON.stringify(m.achieved));for(const W of h){let b=W.Name,A=M[b],O=!1,f=A&&w>3&&A.goal==="Research Desk";if(!A||A.goalsPurchased>=(((Z=i[0][b])==null?void 0:Z.number)??0)||f){const n=p[W.Name],T=n&&W.Name==="Research Desk"?w>6?"Copying Desk":"Discount Desk":n==null?void 0:n[Math.floor(Math.random()*n.length)];if(A=M[T],!A)continue;O=!0,b=T}if(O&&A.goalsPurchased+A.substitutesPurchased>=i[0][b].number&&(A=M["Starter Bin"],b="Starter Bin"),!A)debugger;if(A.goalsPurchased>=(i[0][b]?i[0][b].number:9)){A=M["Starter Bin"],b="Starter Bin",O=!0;continue}b==="Table - Fancy Cloth"&&(O=!1),W.ThemeRequired&&(O=!1),O?A.substitutesPurchased++:A.goalsPurchased++;{const n=T=>{const D={...T};if(D.achieved={...D.achieved},D.numFloor--,D.achieved[b])D.achieved[b]={...D.achieved[b],goalsPurchased:D.achieved[b].goalsPurchased+(O?0:1),substitutesPurchased:D.achieved[b].substitutesPurchased+(O?1:0)};else if(D.achieved[b]={...A,goalsPurchased:O?0:1,substitutesPurchased:O?1:0},Number.isNaN(D.achieved[b].goalsPurchased))debugger;const Y=b==="Starter Bin"||b==="Table - Fancy Cloth"?te(W.Name).PurchaseCost:Math.max(te(W.Name).PurchaseCost,te(b).PurchaseCost);return D.applianceCosts+=Y*(S?.5:1),D.actionHistory=[...D.actionHistory,`buy ${W.Name}`+(O?` for ${b}`:"")],b==="Starter Bin"&&(D.fodderPurchases=[...D.fodderPurchases],D.fodderPurchases[1]++,D.achieved[b].substitutesPurchased--),D};if(b!=="Starter Bin"){const T=I.map(n),D=x.map(n),Y=R.map(n);I=T.concat(I),x=D.concat(x),R=Y.concat(R),T.forEach(P)}else x=x.concat(R),R=(R.length?R:I).map(n)}}return I.concat(x).concat(R)}for(;Q;){let m=ke.array;if(!m.length)return c("No Solutions"),0;ke.clear();const h=new _([],[...L,(f,n)=>f.cumulativeRerolls-n.cumulativeRerolls,(f,n)=>f.applianceCosts-n.applianceCosts]);if($+=t[w]??t.at(-1)??0,w++,w>14&&(S||!a.length)){debugger;break}if(w>1&&m.length===0){debugger;break}m.sort((f,n)=>Ce(f)-Ce(n)),console.log(`fastest so far: ${Be(m[0],$)}`),m.every(f=>f.achieved["Copying Desk"].goalsPurchased)&&(d=d.map(f=>f-1),d=d.filter(f=>f>0));let P=4;switch(w){case 99:case 3:P=3;break;case 999:case 1:case 2:case 4:P=4;break;case 9999:P=5;break;case 99999:P=6;break;case 6:default:P=6;break}let I=.5*60*1e3;const x=Math.min(P-1,1/0);if($>=g){const f=Math.sqrt(($-g)/10*2);console.log(`Have ${$} on day ${w}, need ${g} to buy everything. Allows for ~${f} rerolls across all days`)}w%5||(P=1);let R;(S||w===5||!(w%3))&&(R=a.shift());const M=be.filter(f=>f.Name===R)[0];V.handleNewCardSpawnEffects(M);const Z=V.getAppliances([{spawnInside:!0,blueprintCount:U}],w);V.handleNewCardRerollEffects(M);let W=[];if(Ne.length)for(let f=Ne.length-1;f>=0;f--){let n=Z.length;for(;n--;){const T=Z[n];if(T.Name===Ne[f]){if(console.log(`buying ${T.Name} on day ${w}`),$-m.reduce((Y,z)=>Math.min(Y,z.applianceCosts+10/2*(z.cumulativeRerolls+1)*z.cumulativeRerolls),1/0)<T.PurchaseCost*(S?.5:1)){console.log("not enough money-- skip for now");continue}ge.push(T),Ne.splice(f,1),$-=T.PurchaseCost*(S?.5:1),Z.splice(n,1);break}}W=ge.map(T=>`Buy ${T.Name}`)}let b=new _([{day:w,rerollConfigs:[],achieved:{...C},numFloor:U,fodderAvailable:v,fodderUsed:0,money:$,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,fodderPurchases:[0,0]}],[(f,n)=>V.getPrngAdvancements(f.rerollConfigs,w)-V.getPrngAdvancements(n.rerollConfigs,w),(f,n)=>-V.getPrngAdvancements(f.rerollConfigs,w)+V.getPrngAdvancements(n.rerollConfigs,w),...L,(f,n)=>f.cumulativeRerolls-n.cumulativeRerolls,(f,n)=>f.applianceCosts-n.applianceCosts,(f,n)=>n.numFloor+n.fodderAvailable-f.numFloor+f.fodderAvailable,(f,n)=>f.numFloor-n.numFloor]);Ve(m,b.array[0],ke,!0);let A=1/0;const O=ye.map(f=>f.array.reduce((n,[T,D])=>Math.min(n,D+b.array[0].rerollConfigs.length*(T+1)*10),1/0));e:for(;P--&&(ge.length&&((_e=(Ke=b.array[0])==null?void 0:Ke.rerollConfigs)==null?void 0:_e.length)===1&&(ge.some(n=>n.Name==="Research Desk")&&(We=!0),V.OwnedAppliances.push(...ge),ge=[],W=[]),A=Date.now()+I,b.array[0]!==void 0);){console.log(`Seed ${s} Day ${w} Reroll ${b.array[0].rerollConfigs.length} expanding ${b.array.length} states`),console.log({minSpentMoneyByExtraBlueprints:O});const f=b.array;if(!u.length&&Q<=0){const n=f[0].rerollConfigs.length;if(n*((n+1)/2)*10+g>$){console.log("get me outta here!");break}}b.clear();for(const n of f){if(Date.now()>A){b.array.sort((X,Te)=>-1*(X.applianceCosts-Te.applianceCosts));continue e}if(n.numFloor+n.fodderAvailable===0||n.money<n.rerollConfigs.length*10)continue;let T=0;if(O[0]>n.money)continue;for(let E=1;E<O.length;E++)if(T++,O[E]>n.money){T=E-1;break}let D=x<n.rerollConfigs.length?n.numFloor:n.rerollConfigs.length?n.numFloor+Math.min(n.fodderAvailable,T-n.fodderUsed):U;{let E=n.actionHistory.length;for(;E--&&!n.actionHistory[E].includes("reroll");)if(n.actionHistory[E].includes("Starter Bin")){D=n.numFloor;break}}const Y=x<n.rerollConfigs.length?n.numFloor:n.rerollConfigs.length?Math.max(1,n.numFloor):U;let z;n.rerollConfigs.length===0?z=le:x<n.rerollConfigs.length?z=[n.rerollConfigs.at(-1)]:z=Se,V.getAppliances([...n.rerollConfigs,{spawnInside:!0,blueprintCount:D}],n.day);for(const E of z){const X=N=>{if(!b.add(N)||!h.add(N))return;N.fodderPurchases[0]+N.fodderPurchases[1]||Ve(m,N,ke)},Te=[Y];for(let N=D;N>Y;N--)Te.push(N);for(const N of Te){const J=[...n.rerollConfigs,{...E,blueprintCount:N}],re=[...J.length===1?Z:V.getAppliances(J,n.day)].sort((Pe,ve)=>Pe.PurchaseCost-ve.PurchaseCost),ue=N-n.numFloor;if(ue>n.fodderAvailable)debugger;const pe={...n,fodderPurchases:[n.fodderPurchases[1],0],money:n.money-n.rerollConfigs.length*10,rerollConfigs:J,numFloor:J.length===1?N-ge.length:N,fodderAvailable:n.fodderAvailable-ue,fodderUsed:n.fodderUsed+ue,cumulativeRerolls:n.rerollConfigs.length?n.cumulativeRerolls+1:0,actionHistory:n.rerollConfigs.length?[...n.actionHistory,`${ue?`take ${ue} out, `:""}reroll ${E.spawnInside?"I":E.playerInside?"OI":"OO"}`]:[`day ${n.day} spawn`,`spawn ${E.spawnInside?"I":E.playerInside?"OI":"OO"}`,...W]};if(X(pe),Rs(pe,re,X),Date.now()>A)break}}}}if(V.addCard(M),Q<=0){if(!u.length){K.array.sort((f,n)=>f.deskTime-n.deskTime),c((Q<=0?`full build on ${s} by day ${w}: 
`:"")+K.array.map(f=>Be(f,$)).join(`
`));break}{const f=(((Ye=u[0]["Blueprint Cabinet"])==null?void 0:Ye.number)??0)-(((Je=o["Blueprint Cabinet"])==null?void 0:Je.number)??0);if(f+d.length>2)debugger;for(let n=0;n<f;n++)d.push(15)}for(const f of Object.values(o))f.number&&V.OwnedAppliances.push(te(f.goal));o=u.shift(),i.shift(),L=[];for(const{goal:f,number:n}of Object.values(i[0]))L.push(we(n,f));Q=1/0,ye=[],je(!0),ke.array=K.array,K.clear(),K.objectiveFunctions}}return w;function je(m=!1){Math.random()<.001&&K.array.sort((h,P)=>h.deskTime-P.deskTime),c(`tier ${l.length-u.length-(m?1:0)} build on ${s} by day ${w}${m?"":" (Partial)"}: 
`+K.array.slice(0,100).map(h=>Be(h,$)).join(`
`))}}function bs(s,e){let a=0;for(const l of Object.values(s)){let r=l.number;a+=Math.max(0,r-e[l.goal].goalsPurchased-e[l.goal].substitutesPurchased)}return a}function Be(s,e){const a=s.cumulativeRerolls*(s.cumulativeRerolls+1)/2*10+s.applianceCosts;return`${s.day}: ${Ce(s)} total rerolls: ${s.cumulativeRerolls}, appliance costs: ${s.applianceCosts} (money spent: ${a}/${e}), `+s.actionHistory.join(", ")}const Ie={};function Cs(s){const{starters:e,main:a,doubleOrderChance:l,desserts:r,sides:t,groupSizes:F}=s,c=[e,a,l,r,F].join("|");if(Ie[c])return Ie[c];let o=[0,0,0],d=[0,0,0,0],u=1-.75**t;if(e>0){o[0]=1;let g=1-.75**e;l===.5&&(g*=1.25,u*=1.25),d[0]=F.reduce((C,S)=>C+1+(S-1)*g,0)}const i=F.reduce((g,C)=>g+C);a&&(o[1]=1,d[1]=i),r>0&&(d[2]=i,a?(o[2]=1-.75**r,l===.5&&(o[2]*=1.25)):o[2]=1);let p=1;e>0&&(o[0]*=1+l,p*=1-l,d[0]*=o[0]),a&&(o[1]*=1+p*l,p*=1-l,d[1]*=o[1],d[3]=d[1]*u),r>0&&(o[2]*=1+p*l,p*=1-l,d[2]*=o[2]);const v=[o,d];return Ie[c]=v,v}function Ss(s){const{starters:e,main:a,doubleOrderChance:l,desserts:r,sides:t,groupSizes:F}=s;let c=[0,0,0],o=[0,0,0,0],d=1-.75**e,u=1-.75**r,i=1-.75**t;l===.5&&(d*=1.25,u*=1.25,i*=1.25);const p=S=>{c[0]++,o[0]++;for(let B=0;B<S-1;B++)Math.random()<d&&o[0]++},v=S=>{c[1]++,o[1]+=S;for(let B=0;B<S;B++)Math.random()<i&&o[3]++},g=S=>{c[2]++,o[2]+=S};for(const S of F){let B=!1;e>0&&(p(S),!B&&Math.random()<l&&(B=!0,p(S))),v(S),!B&&Math.random()<l&&(B=!0,v(S)),r>0&&Math.random()<u&&(g(S),!B&&Math.random()<l&&(B=!0,g(S)))}return[c,o]}const ys={"Diner (1)":1,"Small (2)":2,"Medium (2)":2,"Large (3)":3,"Huge (4)":4};class ks{constructor(e,a=[],l=[]){y(this,"seed");y(this,"mapSize");y(this,"frontDoor");y(this,"startingCards");y(this,"cards");y(this,"playerCount");y(this,"turbo");y(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=a,this.cards=l,this.playerCount=ys[this.mapSize],this.turbo=this.startingCards.some(r=>{if(r===void 0){console.log({startingCards:a});debugger}return r.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let r=!1,t=!1,F=0,c=[],o=[],d=0,u=[],i=0,p=[];for(const k of a)switch(k.Name==="All You Can Eat"&&(r=!0),k.Name==="Double Helpings"&&(t=!0),k.DishType){case H.Dessert:d++,k.DishValue&&u.push(k.DishValue);break;case H.Starter:k.DishValue&&c.push(k.DishValue),F++;break;case H.Side:k.DishValue&&p.push(k.DishValue),i++;break;case H.Main:case H.Base:k.Name==="Tacos"?(o.push(2),o.push(3)):k.DishValue&&o.push(k.DishValue)}let v=t?.5:r?.25:0,g=[0,0,0,0];if(g[0]=Me(c),g[1]=Me(o),g[2]=Me(u),g[3]=Me(p),t)for(let k=0;k<3;k++)g[k]&&(g[k]+=3);const[C,S]=Cs({starters:F,main:!!g[1],doubleOrderChance:v,desserts:d,sides:i,groupSizes:l});let B=0;for(let k=0;k<S.length;k++)B+=S[k]*g[k];const L=Le(this.playerCount),q=this.getBookingDeskCount(e),j=this.getBookingDeskMoney(e);return L*(B+q*j)}simulateMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let r=!1,t=!1,F=[[],[],[],[]];for(const C of a)switch(C.Name==="All You Can Eat"&&(r=!0),C.Name==="Double Helpings"&&(t=!0),C.DishType){case H.Dessert:C.DishValue&&F[2].push(C.DishValue);break;case H.Starter:C.DishValue&&F[0].push(C.DishValue);break;case H.Side:C.DishValue&&F[3].push(C.DishValue);break;case H.Main:case H.Base:C.Name==="Tacos"?(F[1].push(2),F[1].push(3)):C.DishValue&&F[1].push(C.DishValue)}let c=t?.5:r?.25:0,o=0;t&&(o+=3);const[d,u]=Ss({starters:F[0].length,main:!!F[1].length,doubleOrderChance:c,desserts:F[2].length,sides:F[3].length,groupSizes:l});let i=0;for(let C=0;C<u.length;C++){let S=u[C];for(;S--;)C<3&&(i+=o),i+=F[C][Math.floor(Math.random()*F[C].length)]}const p=Le(this.playerCount),v=this.getBookingDeskCount(e),g=this.getBookingDeskMoney(e);return p*(i+v*g)}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let a;this.turbo?a=e-1:(a=Math.max(0,Math.floor((e-1)/3)),e>5&&a++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,a)]}return this._cardsByDay[e]}getBookingDeskCount(e,a=1){const l=Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e));if(this.getCardsByDay(e).some(d=>d.Name==="Herd Mentality"))return Math.min(l,3)+1;const r=[],t=this.getCardsByDay(e);let F=1;(this.turbo||t.some(d=>d.Name==="Morning Rush"))&&(r.push(.2),F++),(this.turbo||t.some(d=>d.Name==="Lunch Rush"))&&(r.push(.5),F++),(this.turbo||t.some(d=>d.Name==="Dinner Rush"))&&(r.push(.8),F++);const c=a/this.getDayLength(e),o=.1/l;for(let d=1;d<l;d++){const u=d/l,i=u-o-c,p=u+o+c;let v=!1;for(const g of r)if(i<=g&&p>=g){v=!0;break}v||F++}return F}getNonRushGroupCount(e){const a=this.getExpectedCustomers(e),l=this.getCardsByDay(e).filter(F=>F.Name==="Closing Time?").length*.2,r=this.getExpectedGroupSize(e),t=a*(1+l)/r;return Math.ceil(t)}getCustomerCount(e){return this.getGroupSizes(e).reduce((a,l)=>a+l,0)}getGroupSizes(e){const a=qe(1997821,e,this.seed).random,l=this.getNonRushGroupCount(e),r=this.getCardsByDay(e).some(p=>p.Name==="Herd Mentality");let t=l,F=[],[c,o]=this.getGroupSizeRange(e);{let p=t-1;for(;p--;)a.value}for(;t--;)F.push(a.range(c,o+1)),!r&&t!==l-1&&a.value;let d=this.turbo?3:this.getCardsByDay(e).filter(p=>p.Name.includes(" Rush")).length;const u=Math.ceil(Math.max(1,this.getExpectedCustomers(e)*.15));let i=d*u;for(;i--;)F.push(a.range(c,o+1));return F}getExpectedGroupSize(e){const a=this.getGroupSizeRange(e);return(a[0]+a[1])/2}getGroupSizeRange(e){let a=1,l=2;for(const r of this.getCardsByDay(e))switch(r.Name){case"Individual Dining":l--;break;case"Medium Groups":a++,l+=2;break;case"Large Groups":a+=2,l+=2;break;case"Flexible Dining":a--,l++;break;case"Community":const t=Math.floor((e-1)/3);a+=t,l+=t;break}return[a,l]}getExpectedCustomers(e){const a=this.getReductions(e),l=this.getDayLength(e),r=this.getPlayerModifier(),t=this.getCourseModifier(e),F=this.getDayRate(e),c=this.getCustomersPerHour(e),o=this.getAdvertisingModifier(e);return .85**a*(l/25*F*r)/t*c*o}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(l=>l.Name==="Advertising").length}getDayRate(e){let a=1;switch(e){case 1:a=1.25;break;case 2:a=1.5;break;default:a=1.5+.15*(e-3);break}return e>15&&(a+=(this.turbo?.1:0)*(e-15)**1.5),a}getCourseModifier(e){let a=1;const l=this.getCardsByDay(e);return l.some(r=>r.DishType===H.Dessert||r.Name==="Black Coffee"||r.Name==="Cakes")&&(a+=.25),l.some(r=>r.DishType===H.Starter)&&(a+=.25),a}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let a=1;return this.turbo&&(a=1.5,a*=1+e/10),a}getReductions(e){return this.getCardsByDay(e).reduce((l,r)=>l+r.CustomerMultiplier,0)}getMapSize(){const a=new fe(this.seed,5078598).useSubcontext(0).random.range(0,8);let l;switch(a){case 0:l="Small (2)";break;case 4:l="Medium (2)";break;case 1:case 5:l="Diner (1)";break;case 2:case 6:l="Large (3)";break;case 3:case 7:l="Huge (4)";break;default:throw new Error}return l}getLayoutInfo(){const a=new fe(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,r;switch(a){case 0:r=70,l=2;break;case 4:r=84,l=2;break;case 1:case 5:r=60,l=1;break;case 2:case 6:r=9*13,l=3;break;case 3:case 7:r=12*16,l=4;break;default:throw new Error}return[l,r]}getDoorInfo(){if(this.mapSize!=="Diner (1)")return-1;let e=new He(new fe(this.seed,98234234).useSubcontext(0).random.value),a=23;for(;a--;)e.value;return e.range(0,4)}}function Le(s){switch(s){case 1:return 1.25;case 2:return 1.1;default:return 1}}function Ps(s,e,a,l){let r=[],t=[];const F=s.cards.slice(e);let c=new ks(s.seed,a,F);c.playerCount=l;for(let o=1;o<=15;o++)r.push(c.guessMoney(o)),t.push(c.getBookingDeskCount(o));return r[0]+=c.guessMoney(0),{expectedMoneyByDay:r,expectedBookingDesksByDay:t}}var $e=self;function vs(s){$e.postMessage(s)}const Ds=["Copying Desk","Blueprint Cabinet","Clipboard Stand","Research Desk"],Ms=[{goal:"Copying Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Blueprint Cabinet",number:8,substitutes:[],skipMissing:!0},{goal:"Clipboard Stand",number:1,substitutes:[],skipMissing:!0},{goal:"Research Desk",number:0,substitutes:[],skipMissing:!0},{goal:"Sharp Knife",number:1,substitutes:[],skipMissing:!0},{goal:"Workstation",number:1,substitutes:[],skipMissing:!0},{goal:"Starter Bin",number:999,substitutes:ne.filter(s=>!s.ThemeRequired&&!Ds.includes(s.Name)).map(s=>s.Name),skipMissing:!0}];$e.onmessage=s=>{let{config:e,tiers:a,playerCount:l}=s.data;for(const i of a)for(const p of i){const v=ne.filter(g=>g.Name===p.goal)[0];v.ThemeRequired&&(p.substitutes=ne.filter(g=>g.ThemeRequired===v.ThemeRequired).map(g=>g.Name))}for(;!a.at(-1).length;)a.pop();const r=[...Ms],t=a.flatMap(i=>i.flatMap(p=>[p.goal,...p.substitutes])),F=r.length-1;r[F].substitutes=r[F].substitutes.filter(i=>!t.some(p=>i===p)),a[a.length-1].push(...r);const c=e.cards.filter(i=>fs.some(p=>p.Name===i.Name)).length+1,o=e.cards.slice(0,c);let{expectedMoneyByDay:d,expectedBookingDesksByDay:u}=Ps(e,c,o,l);Ts(e.seed,o,e.cards.slice(c).map(i=>i.Name),a,e.solo,d,u,vs)}})();
