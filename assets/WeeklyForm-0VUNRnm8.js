var ge=Object.defineProperty;var be=(e,a,s)=>a in e?ge(e,a,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[a]=s;var b=(e,a,s)=>(be(e,typeof a!="symbol"?a+"":a,s),s);import{l as f,b as R,y as $,g as z,$ as E,u as d}from"./jsxRuntime.module-hyn2oXrv.js";var D,v,x,j,H=0,ce=[],N=[],G=f.__b,V=f.__r,K=f.diffed,Y=f.__c,Z=f.unmount;function Se(e,a){f.__h&&f.__h(v,e,H||a),H=0;var s=v.__H||(v.__H={__:[],__h:[]});return e>=s.__.length&&s.__.push({__V:N}),s.__[e]}function M(e){return H=1,Ce(_e,e)}function Ce(e,a,s){var l=Se(D++,2);if(l.t=e,!l.__c&&(l.__=[s?s(a):_e(void 0,a),function(i){var o=l.__N?l.__N[0]:l.__[0],t=l.t(o,i);o!==t&&(l.__N=[t,l.__[1]],l.__c.setState({}))}],l.__c=v,!v.u)){var r=function(i,o,t){if(!l.__c.__H)return!0;var c=l.__c.__H.__.filter(function(m){return m.__c});if(c.every(function(m){return!m.__N}))return!F||F.call(this,i,o,t);var T=!1;return c.forEach(function(m){if(m.__N){var p=m.__[0];m.__=m.__N,m.__N=void 0,p!==m.__[0]&&(T=!0)}}),!(!T&&l.__c.props===i)&&(!F||F.call(this,i,o,t))};v.u=!0;var F=v.shouldComponentUpdate,h=v.componentWillUpdate;v.componentWillUpdate=function(i,o,t){if(this.__e){var c=F;F=void 0,r(i,o,t),F=c}h&&h.call(this,i,o,t)},v.shouldComponentUpdate=r}return l.__N||l.__}function ke(){for(var e;e=ce.shift();)if(e.__P&&e.__H)try{e.__H.__h.forEach(O),e.__H.__h.forEach(U),e.__H.__h=[]}catch(a){e.__H.__h=[],f.__e(a,e.__v)}}f.__b=function(e){v=null,G&&G(e)},f.__r=function(e){V&&V(e),D=0;var a=(v=e.__c).__H;a&&(x===v?(a.__h=[],v.__h=[],a.__.forEach(function(s){s.__N&&(s.__=s.__N),s.__V=N,s.__N=s.i=void 0})):(a.__h.forEach(O),a.__h.forEach(U),a.__h=[],D=0)),x=v},f.diffed=function(e){K&&K(e);var a=e.__c;a&&a.__H&&(a.__H.__h.length&&(ce.push(a)!==1&&j===f.requestAnimationFrame||((j=f.requestAnimationFrame)||ye)(ke)),a.__H.__.forEach(function(s){s.i&&(s.__H=s.i),s.__V!==N&&(s.__=s.__V),s.i=void 0,s.__V=N})),x=v=null},f.__c=function(e,a){a.some(function(s){try{s.__h.forEach(O),s.__h=s.__h.filter(function(l){return!l.__||U(l)})}catch(l){a.some(function(r){r.__h&&(r.__h=[])}),a=[],f.__e(l,s.__v)}}),Y&&Y(e,a)},f.unmount=function(e){Z&&Z(e);var a,s=e.__c;s&&s.__H&&(s.__H.__.forEach(function(l){try{O(l)}catch(r){a=r}}),s.__H=void 0,a&&f.__e(a,s.__v))};var J=typeof requestAnimationFrame=="function";function ye(e){var a,s=function(){clearTimeout(l),J&&cancelAnimationFrame(a),setTimeout(e)},l=setTimeout(s,100);J&&(a=requestAnimationFrame(s))}function O(e){var a=v,s=e.__c;typeof s=="function"&&(e.__c=void 0,s()),v=a}function U(e){var a=v;e.__c=e.__(),v=a}function _e(e,a){return typeof a=="function"?a(e):a}function Pe(e,a){for(var s in a)e[s]=a[s];return e}function Q(e,a){for(var s in e)if(s!=="__source"&&!(s in a))return!0;for(var l in a)if(l!=="__source"&&e[l]!==a[l])return!0;return!1}function X(e){this.props=e}(X.prototype=new R).isPureReactComponent=!0,X.prototype.shouldComponentUpdate=function(e,a){return Q(this.props,e)||Q(this.state,a)};var ee=f.__b;f.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),ee&&ee(e)};var Be=f.__e;f.__e=function(e,a,s,l){if(e.then){for(var r,F=a;F=F.__;)if((r=F.__c)&&r.__c)return a.__e==null&&(a.__e=s.__e,a.__k=s.__k),r.__c(e,a)}Be(e,a,s,l)};var ae=f.unmount;function fe(e,a,s){return e&&(e.__c&&e.__c.__H&&(e.__c.__H.__.forEach(function(l){typeof l.__c=="function"&&l.__c()}),e.__c.__H=null),(e=Pe({},e)).__c!=null&&(e.__c.__P===s&&(e.__c.__P=a),e.__c=null),e.__k=e.__k&&e.__k.map(function(l){return fe(l,a,s)})),e}function he(e,a,s){return e&&s&&(e.__v=null,e.__k=e.__k&&e.__k.map(function(l){return he(l,a,s)}),e.__c&&e.__c.__P===a&&(e.__e&&s.appendChild(e.__e),e.__c.__e=!0,e.__c.__P=s)),e}function I(){this.__u=0,this.t=null,this.__b=null}function de(e){var a=e.__.__c;return a&&a.__a&&a.__a(e)}function A(){this.u=null,this.o=null}f.unmount=function(e){var a=e.__c;a&&a.__R&&a.__R(),a&&32&e.__u&&(e.type=null),ae&&ae(e)},(I.prototype=new R).__c=function(e,a){var s=a.__c,l=this;l.t==null&&(l.t=[]),l.t.push(s);var r=de(l.__v),F=!1,h=function(){F||(F=!0,s.__R=null,r?r(i):i())};s.__R=h;var i=function(){if(!--l.__u){if(l.state.__a){var o=l.state.__a;l.__v.__k[0]=he(o,o.__c.__P,o.__c.__O)}var t;for(l.setState({__a:l.__b=null});t=l.t.pop();)t.forceUpdate()}};l.__u++||32&a.__u||l.setState({__a:l.__b=l.__v.__k[0]}),e.then(h,h)},I.prototype.componentWillUnmount=function(){this.t=[]},I.prototype.render=function(e,a){if(this.__b){if(this.__v.__k){var s=document.createElement("div"),l=this.__v.__k[0].__c;this.__v.__k[0]=fe(this.__b,s,l.__O=l.__P)}this.__b=null}var r=a.__a&&$(z,null,e.fallback);return r&&(r.__u&=-33),[$(z,null,a.__a?null:e.children),r]};var se=function(e,a,s){if(++s[1]===s[0]&&e.o.delete(a),e.props.revealOrder&&(e.props.revealOrder[0]!=="t"||!e.o.size))for(s=e.u;s;){for(;s.length>3;)s.pop()();if(s[1]<s[0])break;e.u=s=s[2]}};(A.prototype=new R).__a=function(e){var a=this,s=de(a.__v),l=a.o.get(e);return l[0]++,function(r){var F=function(){a.props.revealOrder?(l.push(r),se(a,e,l)):r()};s?s(F):F()}},A.prototype.render=function(e){this.u=null,this.o=new Map;var a=E(e.children);e.revealOrder&&e.revealOrder[0]==="b"&&a.reverse();for(var s=a.length;s--;)this.o.set(a[s],this.u=[1,0,this.u]);return e.children},A.prototype.componentDidUpdate=A.prototype.componentDidMount=function(){var e=this;this.o.forEach(function(a,s){se(e,s,a)})};var we=typeof Symbol<"u"&&Symbol.for&&Symbol.for("react.element")||60103,Re=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,Me=/^on(Ani|Tra|Tou|BeforeInp|Compo)/,Ae=/[A-Z0-9]/g,Ne=typeof document<"u",Oe=function(e){return(typeof Symbol<"u"&&typeof Symbol()=="symbol"?/fil|che|rad/:/fil|che|ra/).test(e)};R.prototype.isReactComponent={},["componentWillMount","componentWillReceiveProps","componentWillUpdate"].forEach(function(e){Object.defineProperty(R.prototype,e,{configurable:!0,get:function(){return this["UNSAFE_"+e]},set:function(a){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:a})}})});var le=f.event;function xe(){}function Ie(){return this.cancelBubble}function ze(){return this.defaultPrevented}f.event=function(e){return le&&(e=le(e)),e.persist=xe,e.isPropagationStopped=Ie,e.isDefaultPrevented=ze,e.nativeEvent=e};var Ee={enumerable:!1,configurable:!0,get:function(){return this.class}},Fe=f.vnode;f.vnode=function(e){typeof e.type=="string"&&function(a){var s=a.props,l=a.type,r={};for(var F in s){var h=s[F];if(!(F==="value"&&"defaultValue"in s&&h==null||Ne&&F==="children"&&l==="noscript"||F==="class"||F==="className")){var i=F.toLowerCase();F==="defaultValue"&&"value"in s&&s.value==null?F="value":F==="download"&&h===!0?h="":i==="ondoubleclick"?F="ondblclick":i!=="onchange"||l!=="input"&&l!=="textarea"||Oe(s.type)?i==="onfocus"?F="onfocusin":i==="onblur"?F="onfocusout":Me.test(F)?F=i:l.indexOf("-")===-1&&Re.test(F)?F=F.replace(Ae,"-$&").toLowerCase():h===null&&(h=void 0):i=F="oninput",i==="oninput"&&r[F=i]&&(F="oninputCapture"),r[F]=h}}l=="select"&&r.multiple&&Array.isArray(r.value)&&(r.value=E(s.children).forEach(function(o){o.props.selected=r.value.indexOf(o.props.value)!=-1})),l=="select"&&r.defaultValue!=null&&(r.value=E(s.children).forEach(function(o){o.props.selected=r.multiple?r.defaultValue.indexOf(o.props.value)!=-1:r.defaultValue==o.props.value})),s.class&&!s.className?(r.class=s.class,Object.defineProperty(r,"className",Ee)):(s.className&&!s.class||s.class&&s.className)&&(r.class=r.className=s.className),a.props=r}(e),e.$$typeof=we,Fe&&Fe(e)};var re=f.__r;f.__r=function(e){re&&re(e),e.__c};var ne=f.diffed;f.diffed=function(e){ne&&ne(e);var a=e.props,s=e.__e;s!=null&&e.type==="textarea"&&"value"in a&&a.value!==s.value&&(s.value=a.value==null?"":a.value)};const De=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
`,He=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing"],Ue=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean"],P=De.split(`\r
`).map(e=>{const a=e.split(",");let s={};for(let l=0;l<a.length;l++){let r;switch(Ue[l]){case"number":r=Number(a[l]);break;case"boolean":r=a[l]==="True";break;case"number[]":a[l]===""?r=[]:r=a[l].split(":").map(F=>Number(F));break;default:r=a[l]}s[He[l]]=r}return s});console.log({Appliances:P});class We{constructor(a){b(this,"Staple");b(this,"Tags");b(this,"StapleWhenMissing");b(this,"Appliance");b(this,"IsRemoved");b(this,"Filter");b(this,"DecorationRequired");b(this,"SellAsUpgrade");this.Appliance=a,this.Tags=a.ShoppingTags,this.DecorationRequired=a.ThemeRequired,this.SellAsUpgrade=a.IsPurchasableAsUpgrade,this.Filter=a.ShopRequirementFilter,this.StapleWhenMissing=a.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(a){return a&1?this.Staple!==0:a&this.Tags?this.Staple===0:!1}}var C=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(C||{}),y=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(y||{});const te={DefaultShoppingTag:892};var pe=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(pe||{}),W=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(W||{});console.log({Appliances:P});const qe=38;function Le(e,a){let s=e.length;for(;s-- >1;){let l=a.range(0,s+1);[e[s],e[l]]=[e[l],e[s]]}return e}class q{constructor(a,s){b(this,"fixedSeed");b(this,"instance");b(this,"random");typeof a=="string"&&(a=Te(a)),this.fixedSeed=a,this.instance=s,this.random=new $e(a+Math.imul(124192293,s))}useSubcontext(a){return new q(this.fixedSeed,124192293*a+this.instance)}}class $e{constructor(a){b(this,"seed");const s=i=>Math.imul(1812433253,i)+1>>0,l=a>>0,r=s(l),F=s(r),h=s(F);this.seed=[l,r,F,h]}get value(){let a=this.seed.shift(),s=this.seed[2];return a^=a<<11,a^=a>>>8,s^=s>>>19,s=(s^a)>>0,this.seed.push(s),s}range(a,s){return(this.value>>>0)%(s-a)+a}valueFloat(){return(this.value<<9>>>0)/4294967295}}function Te(e){const s=new TextEncoder().encode(e);let l=5381,r=s.length;for(;r>0;){let F=--r;l=(l<<5)+l+s[F]}return l>>0}const je=["azq7nnr5","aztyybbn","azzl75ps","azfrpdtn","azx7du9f","azuk8x3h","azfrioyp","azsjncr5","azx1pdvg","az3dvf9n","azogzs1j","azdrxikt","azor2ecm","azv3vjqc","azm79wsl","az4gzho1","az4rdcny","azc6txsh","aza892mm","az4s7okx","az9jyczp","az8ys73s","azo2i2cw","azrhwuox","azeuphhl","azoizg49","az2xqai6","az2ylrdd","az5xnena","az29g4uu","azjnc9s9","azmq4vw5","azkeqani","azqey8eg"];console.log(je.map(e=>Te(e)).join(","));let oe=0,ue=0,ie=0;const Ge=P.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class Ve{constructor(a,s=0){b(this,"seed");b(this,"mapSize");b(this,"baseUpgradeChance");b(this,"OwnedAppliances");b(this,"Cards");this.seed=a,this.mapSize=1,this.baseUpgradeChance=s,this.OwnedAppliances=[],this.Cards=[]}addCard(a){a!==void 0&&(this.Cards.push(a),this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(s=>P.filter(l=>l.ID===s))))}getPrngAdvancements(a){let s=0;for(const l of a)s+=l.blueprintCount*(Ge-1+1),l.spawnInside||(s+=Ke(l.playerInside,this.mapSize)),s+=qe;return s}buildShopOptions(a,s,l){let r=[];for(const h of P)if(!(!h.IsPurchasable&&!h.IsPurchasableAsUpgrade)){var F=new We(h);if(F.Staple==C.NonStaple||F.Staple==C.WhenMissing){if((F.Tags&y.Basic)>y.None)F.Staple=C.FixedStaple;else if(F.StapleWhenMissing){const t=F.Appliance.Name;t!="Research Desk"&&t!="Blueprint Cabinet"&&t!="Plates"&&console.log(`Unexpected ${F.Appliance.Name} StapleWhenMissing Appliance`),a.includes(F.Appliance)?F.Staple=C.NonStaple:F.Staple=C.WhenMissing}}const o=F.Appliance;if(o.SellOnlyAsDuplicate)a.includes(o)||(F.IsRemoved=!0);else if(o.RequiresForShop.length>0){let t=!1;for(const c of o.RequiresForShop)a.some(T=>T.ID===c)&&(t=!0);F.IsRemoved=!t}else o.SellOnlyAsUnique&&(o.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${o.Name}, ${o.ID}`),F.IsRemoved=!0);F.Filter==pe.RefreshableProvider,F.DecorationRequired!=W.Null&&F.DecorationRequired!=s&&(F.IsRemoved=!0),o.RequiresProcessForShop.length>0&&(o.RequiresProcessForShop.some(t=>l.some(c=>c.RequiredProcesses.includes(t)))||(F.IsRemoved=!0)),r.push(F)}return r}initRandom(a){return new q(this.seed,823828*1231231+a)}getAppliances(a,s){const l=a.length===1,r=this.buildShopOptions(this.OwnedAppliances,W.Null,this.Cards),F=this.initRandom(s).random;let h=this.getPrngAdvancements(a.slice(0,a.length-1));for(;h--;)F.value;let i=a[a.length-1].blueprintCount,o;if(s%5==0){l&&(i=8),o=[];for(let t=0;t<i;t++)o[t]=y.Decoration}else if(a.length>1){o=[];for(let t=0;t<i;t++)o[t]=te.DefaultShoppingTag}else{const t=te.DefaultShoppingTag,c=Math.max(1,i),T=Math.max(0,Math.min(4,Math.max(2,4-Math.floor(s/5)),c)),m=Math.max(0,c-T);i=c,o=[];for(let p=0;p<T;p++)o[p]=y.Basic;for(let p=T;p<T+m;p++)o[p]=t}{const t=[...r],c=[],T=1-(1-Math.floor(s/5)*.1)*(1-this.baseUpgradeChance),m=[];for(let p=0;p<i;p++){const k=o[p],S=F.valueFloat()<T;ie+=T,S?oe++:ue++,Le(t,F);for(let u=0;u<t.length;u++){const n=t[u];if(!n.IsRemoved&&!m.includes(n.Appliance)&&!!n.MatchesRequestTags(k)&&!(!S&&n.Staple==C.NonStaple&&n.SellAsUpgrade)){k!=y.Decoration&&m.push(n.Appliance),c[p]=n.Appliance;break}}c[p]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${p}`)}return console.log({upgradesAllowed:oe,upgradesDisallowed:ue,expectedUpgrades:ie}),c}}}function Ke(e,a){let s=60;switch(a){case 1:s=60;break;case 2:s=70;break;case 3:s=9*13;break;case 4:s=16*12;break;default:console.log(`Unknown Map Size ${a}`),s=60;break}return e?s-2:s-1}const Ye=`-85470894,Black Coffee,-1316622579,-1609758240\r
...
`,me=Ye.split(`\r
`).map(e=>{var o,t;const[a,s,l,r]=e.split(","),F=Number(a),h=((o=l==null?void 0:l.split(":"))==null?void 0:o.map(c=>Number(c)))??[],i=((t=r==null?void 0:r.split(":"))==null?void 0:t.map(c=>Number(c)))??[];return{ID:F,Name:s,RequiredProcesses:h,IngredientProviders:i}});console.log({Unlocks:me});const Fa=({defaultSeed:e,disableSeedInput:a=!1,cardDefaults:s={},maxRerolls:l})=>{const[r,F]=M(e),[h,i]=M(1),[o,t]=M(L),[c,T]=M(s),m=n=>{T(_=>({..._,[n.target.id]:n.target.checked}))};let p=[];for(const[n,_]of Object.entries(c))_&&p.push(n);const k={seed:r,day:h,upgradeChance:r.indexOf("az")>-1?.25:0,blueprintCount:r.indexOf("az")>-1?7:5,ownedAppliances:o,cards:p},B=n=>{i(Number(n.target.value))},S=n=>{F(n.target.value)},u=n=>{const _=n.target;t(g=>({...g,[_.id]:_.checked}))};return d(z,{children:[d("h3",{children:["Seed:"," ",a?r:d("input",{disabled:a,value:r,onChange:S})]}),d("label",{children:"Shop after completing day "}),d("input",{style:"border:none;width:2.5em",type:"number",value:h,onChange:B}),d("div",{children:Object.entries(c).map(([n,_])=>d("span",{style:"margin:0 20px 0 0",children:[d("label",{for:n,children:n}),d("input",{type:"checkbox",id:n,checked:_,onChange:m})]}))}),d("div",{children:ve.map(n=>d("span",{style:"margin:0 25px 0 0",children:[d("label",{for:n,children:["Own ",n,"?"]}),d("input",{type:"checkbox",checked:o[n],id:n,onChange:u})]}))}),d(Qe,{...k,maxRerolls:l??Xe(h)})]})},L={},ve=["Blueprint Cabinet","Plates","Research Desk"];for(const e of ve)L[e]=!1;L["Blueprint Cabinet"]=!0;const Ze=[!0,!1],Je=[!0,!1],Qe=({seed:e,day:a=1,blueprintCount:s,upgradeChance:l,ownedAppliances:r,cards:F,maxRerolls:h})=>{console.log({ownedAppliances:r});const i=new Ve(e,l);for(let u=0;u<=F.length;u++)if(F[u]){const n=me.filter(_=>_.Name===F[u])[0];n&&i.addCard(n)}const o=Object.entries(r).filter(u=>u[1]).map(u=>u[0]).map(u=>P.filter(n=>n.Name===u)[0]);for(const u of o)u&&i.OwnedAppliances.push(u);console.log(i.OwnedAppliances);let t=[];for(const u of Je)for(const n of Ze)if(t.push({spawnInside:u,playerInside:u?void 0:n,blueprintCount:s}),u)break;const c=[];let T=[[],[],[],[]];for(let u=0;u<t.length;u++)for(let n=0;n<t.length;n++){c.push([t[u],t[n]]);const _=[t[u].spawnInside,t[u].playerInside,t[n].spawnInside,t[n].playerInside];for(let g=0;g<_.length;g++)T[g].length&&T[g].at(-1).val===_[g]?T[g].at(-1).run+=1:T[g].push({val:_[g],run:1})}let m=[];const p=s,k=4,B=h;console.log({day:a,CAP:B});for(let u=0;u<B;u++){const n=[];for(const _ of u?c:c.map(g=>[g[0]])){const g=[..._];u&&g.splice(-1,1,{...g.at(-1),blueprintCount:p+k}),n.push(i.getAppliances(g,a).map(w=>w.Name))}if(m.push(n),u)for(let _=0;_<c.length;_++)c[_].push(c[_][c[_].length-1])}const S=(u,n)=>{switch(u){case 0:return n?"Spawn Inside":"Spawn Outside";case 1:return n===void 0?"":n?"Stand Inside at End of Day":"Everyone Outside at End of Day";case 2:return n?"Spawn Inside for Rerolls":"Spawn Outside for Rerolls";case 3:return n===void 0?"":n?"Someone Inside when Rerolling":"Everyone Outside when Rerolling";default:throw new Error("Too Many Headers")}};return d("table",{children:[d("thead",{children:T.map((u,n)=>d("tr",{children:[!n&&d("th",{colSpan:1,rowSpan:4,children:"Reroll #"}),u.map(_=>_.val!==void 0&&d("th",{colSpan:_.run,rowSpan:S(n,_.val).indexOf("Spawn Inside")>-1?2:1,scope:"colgroup",children:S(n,_.val)}))]}))}),m.map((u,n)=>d("tr",{children:[d("th",{children:n||"Spawn"}),n?u.map(_=>d("td",{colspan:1,children:_.map((g,w)=>d("span",{class:w<p?"":"ghost",children:g+(w<_.length-1?", ":"")}))})):d("td",{style:"text-align:center;",colSpan:16,children:u[0].join(", ")})]}))]})};function Xe(e){return[5,8,10,12,13,15,16,18,19,20,21,22,23,24,25][e-1]+1}export{Fa as W};
