var ne=Object.defineProperty;var te=(g,b,P)=>b in g?ne(g,b,{enumerable:!0,configurable:!0,writable:!0,value:P}):g[b]=P;var d=(g,b,P)=>(te(g,typeof b!="symbol"?b+"":b,P),P);(function(){"use strict";var g=(e=>(e[e.Generic=0]="Generic",e[e.Dish=1]="Dish",e[e.PrimaryTheme=3]="PrimaryTheme",e[e.SecondaryTheme=4]="SecondaryTheme",e[e.Special=6]="Special",e))(g||{}),b=(e=>(e[e.Base=0]="Base",e[e.Main=1]="Main",e[e.Extra=2]="Extra",e[e.Side=3]="Side",e[e.Starter=4]="Starter",e[e.Dessert=5]="Dessert",e[e.Null=6]="Null",e))(b||{}),P=`373996608,Ice Cream,1,,,,-1533430406,False,False,5\r
...
`;const U=P.split(`\r
`).filter(e=>e).map(e=>{var I,D;const[s,a,l,i,F,T,u,o,n,h]=e.split(","),c=Number(s),f=Number(l),r=i!=null&&i.length?i.split(":").map(C=>Number(C)):[],t=F.length?F.split(":").map(C=>Number(C)):[],p=T!=null&&T.length?(I=T==null?void 0:T.split(":"))==null?void 0:I.map(C=>Number(C)):[],m=u!=null&&u.length?(D=u==null?void 0:u.split(":"))==null?void 0:D.map(C=>Number(C)):[],S=o==="True",k=n==="True",E=Number(h);return{ID:c,Name:a,UnlockGroup:f,Requires:r,BlockedBy:t,RequiredProcesses:p,IngredientProviders:m,isMain:S,isStarterOrSide:k,DishType:E}});function G(e){return U.filter(s=>!(e.some(a=>a.ID===s.ID)||s.BlockedBy.some(a=>e.some(l=>l.ID===a))||s.Requires.some(a=>!e.some(l=>l.ID===a))||s.isStarterOrSide&&!e.some(a=>a.isMain)||s.DishType===b.Base)).sort((s,a)=>s.ID-a.ID)}g.Special,b.Null;class R{constructor(s,a){d(this,"fixedSeed");d(this,"instance");d(this,"random");typeof s=="string"&&(s=q(s)),this.fixedSeed=s,this.instance=a,this.random=new H(s+Math.imul(124192293,a))}useSubcontext(s){return new R(this.fixedSeed,124192293*s+this.instance)}}class H{constructor(s){d(this,"seed");const a=u=>Math.imul(1812433253,u)+1>>0,l=s>>0,i=a(l),F=a(i),T=a(F);this.seed=[l,i,F,T]}get value(){let s=this.seed.shift(),a=this.seed[2];return s^=s<<11,s^=s>>>8,a^=a>>>19,a=(a^s)>>0,this.seed.push(a),a}range(s,a){return(this.value>>>0)%(a-s)+s}get valueFloat(){return(this.value<<9>>>0)/4294967295}}function q(e){const a=new TextEncoder().encode(e);let l=5381,i=a.length;for(;i>0;){let F=--i;l=(l<<5)+l+a[F]}return l>>0}class W{constructor(){}GetOptions(s,a,l){const i=l.random,F=G(s);let T=F.length+1;for(a!==5&&(T+=F.length+1);T--;)i.value;let u=L(F,i);i.valueFloat<.1&&u.sort((r,t)=>{let p=0;return r.Requires.length&&p--,t.Requires.length&&p++,p});const n=a===5?g.PrimaryTheme:g.Dish,h=a===5?g.PrimaryTheme:g.Generic;let c=null,f=null;for(const r of u)if(!(r.UnlockGroup!==n&&r.UnlockGroup!==h)&&(c===null||c.UnlockGroup!==n&&r.UnlockGroup===n?c=r:(f===null||f.UnlockGroup!==h&&r.UnlockGroup===h)&&(f=r),c&&c.UnlockGroup===n&&f&&f.UnlockGroup===h))break;return[c,f]}}function L(e,s){return e.map(l=>[l,s.valueFloat]).sort((l,i)=>l[1]-i[1]).map(l=>l[0])}class z{constructor(s){d(this,"cards");d(this,"unlockPack");d(this,"seed");this.cards=[],this.unlockPack=new W,this.seed=s}addCard(s){s!==void 0&&this.cards.push(s)}getUnlockOptions(s){const l=K(848292,s,this.seed).useSubcontext(1);return this.unlockPack.GetOptions(this.cards,s,l)}}function K(e,s,a){return new R(a,e*1231231+s)}class V{constructor(s){d(this,"seed");d(this,"mapSize");this.seed=s,this.mapSize=this.getMapSize()}getMapSize(){const a=new R(this.seed,5078598).useSubcontext(0).random.range(0,4);let l;switch(a){case 0:l=2;break;case 1:l=1;break;case 2:l=3;break;case 3:l=4;break;default:throw new Error}return l}}var $=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
-1995745069,False,False,SyncModsViewHolder,False,False,,,0,0,0,False`;const Y=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing"],_=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean"],v=$.split(`\r
`).map(e=>{const s=e.split(",");let a={};for(let l=0;l<s.length;l++){let i;switch(_[l]){case"number":i=Number(s[l]);break;case"boolean":i=s[l]==="True";break;case"number[]":s[l]===""?i=[]:i=s[l].split(":").map(F=>Number(F));break;default:i=s[l]}a[Y[l]]=i}return a});class j{constructor(s){d(this,"Staple");d(this,"Tags");d(this,"StapleWhenMissing");d(this,"Appliance");d(this,"IsRemoved");d(this,"Filter");d(this,"DecorationRequired");d(this,"SellAsUpgrade");this.Appliance=s,this.Tags=s.ShoppingTags,this.DecorationRequired=s.ThemeRequired,this.SellAsUpgrade=s.IsPurchasableAsUpgrade,this.Filter=s.ShopRequirementFilter,this.StapleWhenMissing=s.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(s){return s&1?this.Staple!==0:s&this.Tags?this.Staple===0:!1}}var M=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(M||{}),B=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(B||{});const A={DefaultShoppingTag:892};var N=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(N||{}),w=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(w||{});const J=38;function Q(e,s){let a=e.length;for(;a-- >1;){let l=s.range(0,a+1);[e[a],e[l]]=[e[l],e[a]]}return e}const Z=v.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class X{constructor(s,a=0){d(this,"seed");d(this,"mapSize");d(this,"baseUpgradeChance");d(this,"OwnedAppliances");d(this,"Cards");this.seed=s,this.mapSize=1,this.baseUpgradeChance=a,this.OwnedAppliances=[],this.Cards=[]}addCard(s){s!==void 0&&(this.Cards.push(s),this.OwnedAppliances=this.OwnedAppliances.concat(s.IngredientProviders.flatMap(a=>v.filter(l=>l.ID===a))))}getPrngAdvancements(s){let a=0;for(const l of s)a+=l.blueprintCount*(Z-1+1),l.spawnInside||(a+=ee(l.playerInside,this.mapSize)),a+=J;return a}buildShopOptions(s,a,l){let i=[];for(const T of v)if(!(!T.IsPurchasable&&!T.IsPurchasableAsUpgrade)){var F=new j(T);if(F.Staple==M.NonStaple||F.Staple==M.WhenMissing){if((F.Tags&B.Basic)>B.None)F.Staple=M.FixedStaple;else if(F.StapleWhenMissing){const n=F.Appliance.Name;n!="Research Desk"&&n!="Blueprint Cabinet"&&n!="Plates"&&console.log(`Unexpected ${F.Appliance.Name} StapleWhenMissing Appliance`),s.includes(F.Appliance)?F.Staple=M.NonStaple:F.Staple=M.WhenMissing}}const o=F.Appliance;if(o.SellOnlyAsDuplicate)s.includes(o)||(F.IsRemoved=!0);else if(o.RequiresForShop.length>0){let n=!1;for(const h of o.RequiresForShop)s.some(c=>c.ID===h)&&(n=!0);F.IsRemoved=!n}else o.SellOnlyAsUnique&&(o.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${o.Name}, ${o.ID}`),F.IsRemoved=!0);F.Filter==N.RefreshableProvider,F.DecorationRequired!=w.Null&&F.DecorationRequired!=a&&(F.IsRemoved=!0),o.RequiresProcessForShop.length>0&&(o.RequiresProcessForShop.some(n=>l.some(h=>h.RequiredProcesses.includes(n)))||(F.IsRemoved=!0)),i.push(F)}return i}initRandom(s){return new R(this.seed,823828*1231231+s)}getAppliances(s,a){const l=s.length===1,i=this.buildShopOptions(this.OwnedAppliances,w.Null,this.Cards),F=this.initRandom(a).random;let T=this.getPrngAdvancements(s.slice(0,s.length-1));for(;T--;)F.value;let u=s[s.length-1].blueprintCount,o;if(a%5==0){l&&(u=8),o=[];for(let n=0;n<u;n++)o[n]=B.Decoration}else if(s.length>1){o=[];for(let n=0;n<u;n++)o[n]=A.DefaultShoppingTag}else{const n=A.DefaultShoppingTag,h=Math.max(1,u),c=Math.max(0,Math.min(4,Math.max(2,4-Math.floor(a/5)),h)),f=Math.max(0,h-c);u=h,o=[];for(let r=0;r<c;r++)o[r]=B.Basic;for(let r=c;r<c+f;r++)o[r]=n}{const n=[...i],h=[],c=1-(1-Math.floor(a/5)*.1)*(1-this.baseUpgradeChance),f=[];for(let r=0;r<u;r++){const t=o[r],m=F.valueFloat<c;Q(n,F);for(let S=0;S<n.length;S++){const k=n[S];if(!k.IsRemoved&&!f.includes(k.Appliance)&&!!k.MatchesRequestTags(t)&&!(!m&&k.Staple==M.NonStaple&&k.SellAsUpgrade)){t!=B.Decoration&&f.push(k.Appliance),h[r]=k.Appliance;break}}h[r]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${r}`)}return h}}}function ee(e,s){let a=60;switch(s){case 1:a=60;break;case 2:a=70;break;case 3:a=9*13;break;case 4:a=16*12;break;default:console.log(`Unknown Map Size ${s}`),a=60;break}return e?a-2:a-1}var se=self;let y=!1;se.onmessage=function(e){const s=e;console.log("Worker: Message received from main script"),s.data.type==="start"?(y=!0,ae(s.data.data)):(console.log("breaking search"),y=!1)};async function ae({goalCards:e,goalAppliances:s=[],mapSizes:a,maxSeeds:l=10,partial:i=!1}){const F=new MessageChannel;let T;F.port2.onmessage=c=>{T()};let u="az2mpjp3";const o=e[0].cards;let n=[-1/0,[]],h=l;for(;y&&h;){const c=new Promise(t=>{T=t});for(F.port1.postMessage(null),await c,u="az";u.length<8;)u+=x[Math.floor(Math.random()*x.length)];const f=new V(u).mapSize;if(!a.includes(f))continue;const r=Fe(u,o,e,s,i);if(r[0]>=n[0]){if(!Number.isFinite(r[0]))continue;n=r,h--;const t=JSON.stringify({seed:u,metric:[r[0],r[1]]});console.log(t),le({seed:u,cards:r[1],blueprints:[]})}}}function le(e){postMessage({type:"result",data:e})}function Fe(e,s,a,l,i=!1){const F=new X(e,s.some(t=>t.Name==="Turbo")?.25:0);for(const t of s)F.addCard(t);const T=F.getAppliances([{spawnInside:!0,blueprintCount:7}],1).map(t=>t.Name),u=[F.getAppliances([{spawnInside:!0,blueprintCount:7},{spawnInside:!0,blueprintCount:5}],1).map(t=>t.Name),F.getAppliances([{spawnInside:!1,playerInside:!0,blueprintCount:7},{spawnInside:!0,blueprintCount:5}],1).map(t=>t.Name),F.getAppliances([{spawnInside:!1,playerInside:!1,blueprintCount:7},{spawnInside:!0,blueprintCount:5}],1).map(t=>t.Name)];let o=0,n=[];for(const t of l){let p=!1;if(T.includes(t)&&(o++,p=!0),!p||t!=="Rolling Pin"&&t!=="Tray Stand")for(let m=0;m<u.length;m++)u[m].includes(t)&&(n[m]||(n[m]=0),n[m]++)}if(![...T,...u.flat()].includes("Bar Table")||!(o>1||o+Math.max(...n)>2))return[-1/0,[]];const c=new z(e);for(const t of s)c.addCard(t);let f=0,r=1;for(;r<15;r++){const t=c.getUnlockOptions(r),p=O(t[0],a[r]),m=O(t[1],a[r]);let S=-1;if(p>-1&&m>-1)p<m?S=0:S=1;else if(p===-1&&m===-1){if(!i)return[-1/0,[]];S=Math.floor(Math.random()*2),f++}else p>=0?S=0:S=1;if(!t[S]){debugger;throw console.log({options:t}),new Error}c.addCard(t[S])}return[r-f,c.cards.map(t=>t.Name)]}const x="abcdefghijklmnopqrstuvwxyz123456789";function re(e,s){for(let a=0;a<e.length;a++)if(e[a].ID===s.ID)return a;return-1}function O(e,s){return s.include?re(s.cards,e):s.cards.some(a=>a.ID===e.ID)?-1:0}})();
