var Q=Object.defineProperty;var Z=(i,c,f)=>c in i?Q(i,c,{enumerable:!0,configurable:!0,writable:!0,value:f}):i[c]=f;var m=(i,c,f)=>(Z(i,typeof c!="symbol"?c+"":c,f),f);(function(){"use strict";var i=(e=>(e[e.Generic=0]="Generic",e[e.Dish=1]="Dish",e[e.PrimaryTheme=3]="PrimaryTheme",e[e.SecondaryTheme=4]="SecondaryTheme",e[e.Special=6]="Special",e))(i||{}),c=(e=>(e[e.Base=0]="Base",e[e.Main=1]="Main",e[e.Extra=2]="Extra",e[e.Side=3]="Side",e[e.Starter=4]="Starter",e[e.Dessert=5]="Dessert",e[e.Null=6]="Null",e))(c||{}),f=`373996608,Ice Cream,1,,,,-1533430406,False,False,5\r
...
`).filter(e=>e).map(e=>{var v,w;const[a,s,l,F,n,o,t,u,p,h]=e.split(","),T=Number(a),d=Number(l),S=F!=null&&F.length?F.split(":").map(g=>Number(g)):[],r=n.length?n.split(":").map(g=>Number(g)):[],k=o!=null&&o.length?(v=o==null?void 0:o.split(":"))==null?void 0:v.map(g=>Number(g)):[],b=t!=null&&t.length?(w=t==null?void 0:t.split(":"))==null?void 0:w.map(g=>Number(g)):[],_=u==="True",j=p==="True",J=Number(h);return{ID:T,Name:s,UnlockGroup:d,Requires:S,BlockedBy:r,RequiredProcesses:k,IngredientProviders:b,isMain:_,isStarterOrSide:j,DishType:J}});function B(e,a=!0){const s=a&&e.some(l=>l.Name==="Community");return C.filter(l=>!(e.some(F=>F.ID===l.ID)||l.BlockedBy.some(F=>e.some(n=>n.ID===F))||l.Requires.some(F=>!e.some(n=>n.ID===F))||l.isStarterOrSide&&!e.some(F=>F.isMain)||!s&&l.DishType===c.Base)).sort((l,F)=>l.ID-F.ID)}i.Special,c.Null,i.Special,c.Null,i.Special,c.Null,C.filter(e=>e.Name==="Community")[0],i.Special,c.Null,i.Special,c.Null,["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>C.filter(a=>a.Name===e)[0]);class y{constructor(a,s){m(this,"fixedSeed");m(this,"instance");m(this,"random");typeof a=="string"&&(a=I(a)),this.fixedSeed=a,this.instance=s,this.random=new N(a+Math.imul(124192293,s))}useSubcontext(a){return new y(this.fixedSeed,124192293*a+this.instance)}}class N{constructor(a){m(this,"seed");const s=t=>Math.imul(1812433253,t)+1>>0,l=a>>0,F=s(l),n=s(F),o=s(n);this.seed=[l,F,n,o]}get value(){let a=this.seed.shift(),s=this.seed[2];return a^=a<<11,a^=a>>>8,s^=s>>>19,s=(s^a)>>0,this.seed.push(s),s}range(a,s){return(this.value>>>0)%(s-a)+a}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(a){return a[this.range(0,a.length)]}}function I(e){const s=new TextEncoder().encode(e);let l=5381,F=s.length;for(;F>0;){let n=--F;l=(l<<5)+l+s[n]}return l>>0}class G{constructor(){m(this,"encourageGroups",[i.Special])}GetOptions(a,s,l){const F=l.random;let n=B(a),o=B(a,!1).length+1;for(a.some(r=>r.Name==="Turbo")?s!==5&&(o+=n.length+1):a.some(r=>r.Name==="Community")?s===5&&(o+=n.length+2):console.error("This Setting is not implemented yet");o--;)F.value;let t=x(n,F);const u=F.valueFloat<(a.some(r=>r.Name==="Turbo")?.1:.5),p=!a.some(r=>r.Name==="Community")||s===5;u&&t.sort((r,k)=>{let b=0;return(p&&r.Requires.length||this.encourageGroups.includes(r.UnlockGroup))&&b--,(p&&k.Requires.length||this.encourageGroups.includes(k.UnlockGroup))&&b++,b});const h=s===5?i.PrimaryTheme:i.Dish,T=s===5?i.PrimaryTheme:a.some(r=>r.Name==="Community")?i.Dish:i.Generic;let d=null,S=null;for(const r of t)if(!(r.UnlockGroup!==h&&r.UnlockGroup!==T)&&(d===null||d.UnlockGroup!==h&&r.UnlockGroup===h?d=r:(S===null||S.UnlockGroup!==T&&r.UnlockGroup===T)&&(S=r),d&&d.UnlockGroup===h&&S&&S.UnlockGroup===T))break;return[d,S]}}function x(e,a){return e.map(l=>[l,a.valueFloat]).sort((l,F)=>l[1]-F[1]).map(l=>l[0])}class E{constructor(a){m(this,"cards");m(this,"unlockPack");m(this,"seed");this.cards=[],this.unlockPack=new G,this.seed=a}addCard(a){a!==void 0&&this.cards.push(a)}getUnlockOptions(a){const l=A(848292,a,this.seed).useSubcontext(1);return this.unlockPack.GetOptions(this.cards,a,l)}}function A(e,a,s){return new y(s,e*1231231+a)}class O{constructor(a){m(this,"seed");m(this,"mapSize");this.seed=a,this.mapSize=this.getMapSize()}getMapSize(){const s=new y(this.seed,5078598).useSubcontext(0).random.range(0,4);let l;switch(s){case 0:l=2;break;case 1:l=1;break;case 2:l=3;break;case 3:l=4;break;default:throw new Error}return l}}var H=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
-26827118,False,False,Upgrade Kit,False,False,,,0,0,0,False`;const L=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing"],U=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean"];H.split(`\r
`).map(e=>{const a=e.split(",");let s={};for(let l=0;l<a.length;l++){let F;switch(U[l]){case"number":F=Number(a[l]);break;case"boolean":F=a[l]==="True";break;case"number[]":a[l]===""?F=[]:F=a[l].split(":").map(n=>Number(n));break;default:F=a[l]}s[L[l]]=F}return s}).filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;var q=self;let P=!1,M=new Date().valueOf();q.onmessage=function(e){console.log("Worker: Message received from main script"),e.data.type==="start"?(P=!0,z(e.data.data)):(console.log("breaking search"),P=!1)};async function z({goalCards:e,goalAppliances:a=[],mapSizes:s,maxSeeds:l=10,partial:F=!1}){let n=0;const o=new MessageChannel;let t;o.port2.onmessage=d=>{t()};let u="az2mpjp3";const p=e[0].cards;let h=[-1/0,[]],T=l;for(;P&&T;){K(n),n++;const d=new Promise(k=>{t=k});for(o.port1.postMessage(null),await d,u="az";u.length<8;)u+=D[Math.floor(Math.random()*D.length)];const S=new O(u).mapSize;if(!s.includes(S))continue;const r=V(u,p,e,a,F);if(r[0]>=h[0]){if(!Number.isFinite(r[0]))continue;h=r,T--,W({seed:u,cards:r[1],blueprints:[]})}}}function W(e){postMessage({type:"result",data:e})}function K(e){if(Date.now()<M)return;M=Date.now()+15,postMessage({type:"progress",data:e})}C.filter(e=>e.Name==="Ice Cream")[0];function V(e,a,s,l,F=!1){const n=new E(e);for(const u of a)n.addCard(u);let o=0,t=1;for(;t<15;t++){const u=n.getUnlockOptions(t),p=R(u[0],s[t]),h=R(u[1],s[t]);let T=-1;if(p>-1&&h>-1)p<h?T=0:h<p?T=1:T=Math.floor(Math.random()*2);else if(p===-1&&h===-1){if(!F||t<2)return[-1/0,[]];T=Math.floor(Math.random()*2),o++}else p>=0?T=0:T=1;if(!u[T]){debugger;throw console.log({options:u}),new Error}n.addCard(u[T])}return[t-o,n.cards.map(u=>u.Name)]}const D="abcdefghijklmnopqrstuvwxyz123456789";function Y(e,a){for(let s=0;s<e.length;s++)if(e[s].ID===a.ID)return s;return-1}function R(e,a){return a.include?Y(a.cards,e):a.cards.some(s=>s.ID===e.ID)?-1:0}})();
