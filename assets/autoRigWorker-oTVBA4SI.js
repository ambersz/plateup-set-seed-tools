...
`).filter(s=>s).map(s=>{var te,X;const[e,a,l,F,r,t,p,u,i,f,k,g]=s.split(","),R=Number(e),C=Number(l),q=F!=null&&F.length?F.split(":").map(L=>Number(L)):[],z=r.length?r.split(":").map(L=>Number(L)):[],K=t!=null&&t.length?(te=t==null?void 0:t.split(":"))==null?void 0:te.map(L=>Number(L)):[],I=p!=null&&p.length?(X=p==null?void 0:p.split(":"))==null?void 0:X.map(L=>Number(L)):[],A=u==="True",E=i==="True",N=Number(f),_=Number(k),ge=Number(g);return{ID:R,Name:a,UnlockGroup:C,Requires:q,BlockedBy:z,RequiredProcesses:K,IngredientProviders:I,isMain:A,isStarterOrSide:E,DishType:N,CustomerMultiplier:_,DishValue:ge}}),ve=[...[{ID:447437163,Name:"Country",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},pe.filter(s=>s.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},{ID:1958825350,Name:"Turbo",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0}]].sort((s,e)=>s.Name<e.Name?-1:1);["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(s=>pe.filter(e=>e.Name===s)[0]),Ve.trim().split(`\r
`).filter(s=>s).map(s=>{var E,N;const[e,a,l,F,r,t,p,u,i,f]=s.split(","),k=Number(e),g=Number(l),R=F!=null&&F.length?(E=F==null?void 0:F.split(":"))==null?void 0:E.map(_=>Number(_)):[],C=r!=null&&r.length?(N=r==null?void 0:r.split(":"))==null?void 0:N.map(_=>Number(_)):[],q=t==="True",z=p==="True",K=Number(u),I=Number(i),A=Number(f);return{ID:k,Name:a,UnlockGroup:g,Requires:[],BlockedBy:[],RequiredProcesses:R,IngredientProviders:C,isMain:q,isStarterOrSide:z,DishType:K,CustomerMultiplier:I,DishValue:A}}).sort((s,e)=>s.Name<e.Name?-1:1);const Ke=[7,8,8,8,8,10,10,8,9,9,9,10,9,10,10],_e=[122,143,159,169,169,215,215,218,240,252,252,288,263,300,300],de={};function me(s){return de[s]===void 0&&(de[s]=oe.filter(e=>e.Name===s)[0]),de[s]===void 0&&console.error(`Could not find ${s} appliance`),de[s]}const Ye=[(s,e)=>s[0]-e[0],(s,e)=>s[1]-e[1]];function Te(s){let e=0;(s==null?void 0:s.deskTime)!==void 0&&(e+=s.deskTime);for(const a of Object.values(s.achieved))e+=s.cumulativeRerolls*2,e+=a.goalsPurchased+a.substitutesPurchased;return e}function be(s,e){return(a,l)=>{const F=a.achieved[e],r=l.achieved[e],t=Math.min(F.goalsPurchased,s);let u=Math.min(r.goalsPurchased,s)-t;return u===0?F.goalsPurchased>=s||F.goalsPurchased+F.substitutesPurchased>=s&&r.goalsPurchased+r.substitutesPurchased>=s?F.substitutesPurchased-r.substitutesPurchased:r.substitutesPurchased-F.substitutesPurchased:u}}const Je={"Copying Desk":4,"Metal Table":4};function Qe(s,e,a,l,F=!0,r=_e,t=()=>{}){var De,Ne,we,Ie;let p={};const u=[],i=new Array(l.length).fill(0).map(()=>({})),f={};let k=0,g=0;const R={},C=e.some(d=>d.Name==="Turbo"),q=[];let z=[],K=0;const I={};for(const d of l){for(const o of d){const{goal:S,number:M,substitutes:D,skipMissing:P=!1}=o;for(const c of D)f[c]=S;I[S]?P||(I[S].number+=M):(I[S]={...o},P&&(I[S].number=0));for(let c=0;c<=K;c++){if(i[c]===void 0)debugger;i[c][S]?i[c][S].number+=M:i[c][S]={...o}}for(let c=K+1;c<i.length;c++){if(i[c]===void 0)debugger;i[c][S]||(i[c][S]={...o,number:0})}P||(g+=me(S).PurchaseCost*M*(C?.5:1))}try{u.push(JSON.parse(JSON.stringify(I)))}catch{console.log(i),console.log(i[0]);debugger}K++}const A=i[0];p=u.shift();for(const d of Object.values(A)){const{goal:o,number:S}=d;R[o]={...d,substitutesPurchased:0,goalsPurchased:0},d.goal!=="Starter Bin"&&(q.push(be(S,o)),z.push(be(S,o)))}const E=new H([],[...q,(d,o)=>Te(d)-Te(o),(d,o)=>d.actionHistory.length-o.actionHistory.length,(d,o)=>d.cumulativeRerolls-o.cumulativeRerolls,(d,o)=>(d.day+1)%5?d.upgradesInProgress-o.upgradesInProgress:0]),N=C?7:5,_=[{spawnInside:!0,blueprintCount:N},{spawnInside:!1,playerInside:!1,blueprintCount:N}];F||_.push({spawnInside:!1,playerInside:!0,blueprintCount:N});const ge=[{spawnInside:!0,blueprintCount:N},{spawnInside:!1,playerInside:!0,blueprintCount:N},{spawnInside:!1,playerInside:!1,blueprintCount:N}];function te(d,o,S){const M={...d};for(const D of Object.values(o)){const P=D.goal;M[P]={...M[P]},M[P].goalsPurchased+=D.goalsPurchased,S&&(M[P].substitutesPurchased+=D.substitutesPurchased)}return M}let X=[];function L(d,o,S,M=!1){var P;const D=o.fodderUsed;for(const c of d){if(Object.values(o.achieved).some(j=>j.substitutesPurchased)&&!Me&&!((P=c.achieved["Research Desk"])!=null&&P.goalsPurchased))continue;let ee=1+(c.achieved["Copying Desk"].goalsPurchased||c.achieved["Copying Desk"].substitutesPurchased?1:0);const se=1+c.achieved["Blueprint Cabinet"].goalsPurchased;let b=se;if(b*=ee,b-=c.upgradesInProgress,b<0||b<D)continue;let ie=c.cumulativeRerolls+o.cumulativeRerolls,h=ie*(ie+1)/2*10+c.applianceCosts;const y=te(c.achieved,o.achieved,!1),n=te(c.achieved,o.achieved,!0),$=Ze(p,y);if(U<=0&&$>0||h>G)continue;let x=0,W=0,ae=0;{let j=G-h;for(const m of Object.values(o.achieved)){j-=m.goalsPurchased*me(m.goal).PurchaseCost*(C?.5:1);let Y=!1;(j<0||m.substitutesPurchased)&&(Y=!0,j<0&&(x+=m.goalsPurchased),x+=m.substitutesPurchased,ae+=m.substitutesPurchased*(Je[m.goal]??1)),m.goal==="Metal Table"&&m.goalsPurchased+m.substitutesPurchased&&(n["Copying Desk"].goalsPurchased||c.achieved["Copying Desk"].substitutesPurchased)&&(Y||W++,W++,ae++)}if(x>n["Blueprint Cabinet"].goalsPurchased+1)continue}h+=o.applianceCosts;const v=c.deskTime+Math.max(0,D-se)*5*(c.achieved["Clipboard Stand"].goalsPurchased?.5:1)+(ae*5+Ke[o.day])*(n["Clipboard Stand"].goalsPurchased?.5:1),w={...o,rerollConfigs:[...c.rerollConfigs,o.rerollConfigs],achieved:n,money:G-h,actionHistory:[...c.actionHistory,...o.actionHistory],upgradesInProgress:x,cumulativeRerolls:c.cumulativeRerolls+o.cumulativeRerolls,applianceCosts:c.applianceCosts+o.applianceCosts,deskTime:v};if(!(x>n["Blueprint Cabinet"].goalsPurchased+1)){if(W&&(W===1||x+1<=n["Blueprint Cabinet"].goalsPurchased+1)&&(w.upgradesInProgress+=W,n["Metal Table"].goalsPurchased++,w.actionHistory.push("Copy Metal Table"),w.applianceCosts+=30),w.money>=0){if($<U&&(U=$,console.log(`best so far missing ${$} pieces `+Ce(w))),$<=0&&!w.upgradesInProgress){E.add(w)&&Be();continue}else if(U<=0)continue}if(b>k&&(k=b),M){const j=c.cumulativeRerolls;for(let m=0;m<=b;m++)X[m]===void 0&&(X[m]=new H([],Ye)),X[m].add([j,h]);continue}S.add(w)}}return U}const ue=new H([{achieved:{...R},actionHistory:[],applianceCosts:0,cumulativeRerolls:0,rerollConfigs:[],upgradesInProgress:0,day:0,numFloor:0,money:0,fodderAvailable:0,deskTime:0}],[...q,(d,o)=>d.applianceCosts-o.applianceCosts,(d,o)=>d.cumulativeRerolls-o.cumulativeRerolls]);let U=1/0,B=0,G=C?30:0;const O=new Ue(s),fe=["Plates","Research Desk"];let Me=!1,re=[];{const d=["Booking Desk","Blueprint Cabinet"];oe.filter(o=>d.includes(o.Name)).forEach(o=>O.OwnedAppliances.push(o))}for(const d of e)O.addCard(d);function ls(d,o){let S=[{...d}];for(const M of o){let D=M.Name,P=d.achieved[M.Name],c=!1;if(!P){if(P=d.achieved[f[M.Name]],!P)continue;c=!0,D=f[M.Name]}if(!(P.goalsPurchased>=i[0][D].number)&&!(c&&P.goalsPurchased+P.substitutesPurchased>=i[0][D].number)){const ee=S.map(se=>{const b={...se};return b.achieved={...b.achieved},b.numFloor--,b.achieved[P.goal]={...P,goalsPurchased:P.goalsPurchased+(c?0:1),substitutesPurchased:P.substitutesPurchased+(c?1:0)},b.applianceCosts+=me(D).PurchaseCost*(C?.5:1),b.actionHistory=[...b.actionHistory,`buy ${M.Name}`+(c?` for ${P.goal}`:"")],P.goal==="Starter Bin"&&(b.fodderPurchases=[...b.fodderPurchases],b.fodderPurchases[1]++),b});S=S.concat(ee)}}return S}for(;U;){const d=ue.array;ue.clear();const o=new H([],[...z,(h,y)=>h.cumulativeRerolls-y.cumulativeRerolls,(h,y)=>h.applianceCosts-y.applianceCosts]);if(G+=r[B],B++,B>14)break;if(B>1&&d.length===0){debugger;break}let S=1/0,M=10*1e3;const D=Math.min(S-1,1/0);if(G>=g){const h=Math.sqrt((G-g)/10*2);console.log(`Have ${G} on day ${B}, need ${g} to buy everything. Allows for ~${h} rerolls across all days`)}B%5||(S=1);const P=a.shift(),c=pe.filter(h=>h.Name===P)[0];O.handleNewCardSpawnEffects(c);const ee=O.getAppliances([{spawnInside:!0,blueprintCount:N}],B);let se=[];if(fe.length)for(let h=fe.length-1;h>=0;h--){let y=ee.length;for(;y--;){const n=ee[y];if(n.Name===fe[h]){if(console.log(`buying ${n.Name} on day ${B}`),G<n.PurchaseCost*(C?.5:1)){console.log("not enough money-- skip for now");continue}re.push(n),fe.splice(h,1),G-=n.PurchaseCost*(C?.5:1),ee.splice(y,1);break}}se=re.map(n=>`Buy ${n.Name}`)}let b=new H([{day:B,rerollConfigs:[],achieved:{...R},numFloor:N,fodderAvailable:k,fodderUsed:0,money:G,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,fodderPurchases:[0,0]}],[(h,y)=>O.getPrngAdvancements(h.rerollConfigs,B)-O.getPrngAdvancements(y.rerollConfigs,B),(h,y)=>-O.getPrngAdvancements(h.rerollConfigs,B)+O.getPrngAdvancements(y.rerollConfigs,B),...z,(h,y)=>h.cumulativeRerolls-y.cumulativeRerolls,(h,y)=>h.applianceCosts-y.applianceCosts,(h,y)=>y.numFloor+y.fodderAvailable-h.numFloor+h.fodderAvailable,(h,y)=>h.numFloor-y.numFloor]);L(d,b.array[0],ue,!0);let ie=1/0;e:for(;S--&&(re.length&&((Ne=(De=b.array[0])==null?void 0:De.rerollConfigs)==null?void 0:Ne.length)===1&&(re.some(n=>n.Name==="Research Desk")&&(Me=!0),O.OwnedAppliances.push(...re),re=[],se=[]),ie=Date.now()+M*.9**(((Ie=(we=b.array[0])==null?void 0:we.rerollConfigs)==null?void 0:Ie.length)??0),b.array[0]!==void 0);){const h=X.map(n=>n.array.reduce(($,[x,W])=>Math.min($,W+b.array[0].rerollConfigs.length*(x+1)*10),1/0));console.log(`Seed ${s} Day ${B} Reroll ${b.array[0].rerollConfigs.length} expanding ${b.array.length} states`),console.log({minSpentMoneyByExtraBlueprints:h});const y=b.array;if(!u.length&&U<=0){const n=y[0].rerollConfigs.length;if(n*((n+1)/2)*10+g>G){console.log("get me outta here!");break}}b.clear();for(const n of y){if(Date.now()>ie){b.array.sort((v,w)=>v.numFloor-w.numFloor||v.fodderAvailable-w.fodderAvailable||w.applianceCosts-v.applianceCosts||Math.random()-.5);continue e}if(n.numFloor+n.fodderAvailable===0||n.money<n.rerollConfigs.length*10)continue;let $=0;if(h[0]>n.money)continue;for(let v=1;v<h.length;v++)if($++,h[v]>n.money){$=v-1;break}let x=D<n.rerollConfigs.length?n.numFloor:n.rerollConfigs.length?n.numFloor+Math.min(n.fodderAvailable,$-n.fodderUsed):N;{let v=n.actionHistory.length;for(;v--&&!n.actionHistory[v].includes("reroll");)if(n.actionHistory[v].includes("Starter Bin")){x=n.numFloor;break}}const W=D<n.rerollConfigs.length?n.numFloor:n.rerollConfigs.length?Math.max(1,n.numFloor):N;let ae;n.rerollConfigs.length===0?ae=ge:D<n.rerollConfigs.length?ae=[n.rerollConfigs.at(-1)]:ae=_,O.getAppliances([...n.rerollConfigs,{spawnInside:!0,blueprintCount:x}],n.day);for(const v of ae){const w=m=>{if(!b.add(m)||!o.add(m))return;m.fodderPurchases[0]+m.fodderPurchases[1]||L(d,m,ue)},j=[W];for(let m=x;m>W;m--)j.push(m);for(const m of j){const Y=[...n.rerollConfigs,{...v,blueprintCount:m}],Fs=Y.length===1?ee:O.getAppliances(Y,n.day),ce=m-n.numFloor;if(ce>n.fodderAvailable)debugger;const rs=ls({...n,fodderPurchases:[n.fodderPurchases[1],0],money:n.money-n.rerollConfigs.length*10,rerollConfigs:Y,numFloor:Y.length===1?m-re.length:m,fodderAvailable:n.fodderAvailable-ce,fodderUsed:n.fodderUsed+ce,cumulativeRerolls:n.rerollConfigs.length?n.cumulativeRerolls+1:0,actionHistory:(n.rerollConfigs.length?[...n.actionHistory,`${ce?`take ${ce} out, `:""}reroll ${v.spawnInside?"I":v.playerInside?"OI":"OO"}`]:[`day ${n.day} spawn`,`spawn ${v.spawnInside?"I":v.playerInside?"OI":"OO"}`]).concat(Y.length===1?se:[])},Fs);for(const ns of rs)w(ns);if(Date.now()>ie)break}}}}if(O.addCard(c),U<=0){if(!u.length){t((U<=0?`full build on ${s} by day ${B}: 
