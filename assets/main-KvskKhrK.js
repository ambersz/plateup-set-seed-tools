 ...
 *
 * @license MIT
 */function fe(){return fe=Object.assign?Object.assign.bind():function(e){for(var a=1;a<arguments.length;a++){var l=arguments[a];for(var s in l)Object.prototype.hasOwnProperty.call(l,s)&&(e[s]=l[s])}return e},fe.apply(this,arguments)}var V;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(V||(V={}));const Sa="popstate";function ts(e){e===void 0&&(e={});function a(s,r){let{pathname:t,search:n,hash:o}=s.location;return $e("",{pathname:t,search:n,hash:o},r.state&&r.state.usr||null,r.state&&r.state.key||"default")}function l(s,r){return typeof r=="string"?r:Pe(r)}return Fs(a,l,null,e)}function R(e,a){if(e===!1||e===null||typeof e>"u")throw new Error(a)}function ml(e,a){if(!e){typeof console<"u"&&console.warn(a);try{throw new Error(a)}catch{}}}function ns(){return Math.random().toString(36).substr(2,8)}function ba(e,a){return{usr:e.state,key:e.key,idx:a}}function $e(e,a,l,s){return l===void 0&&(l=null),fe({pathname:typeof e=="string"?e:e.pathname,search:"",hash:""},typeof a=="string"?Fe(a):a,{state:l,key:a&&a.key||s||ns()})}function Pe(e){let{pathname:a="/",search:l="",hash:s=""}=e;return l&&l!=="?"&&(a+=l.charAt(0)==="?"?l:"?"+l),s&&s!=="#"&&(a+=s.charAt(0)==="#"?s:"#"+s),a}function Fe(e){let a={};if(e){let l=e.indexOf("#");l>=0&&(a.hash=e.substr(l),e=e.substr(0,l));let s=e.indexOf("?");s>=0&&(a.search=e.substr(s),e=e.substr(0,s)),e&&(a.pathname=e)}return a}function Fs(e,a,l,s){s===void 0&&(s={});let{window:r=document.defaultView,v5Compat:t=!1}=s,n=r.history,o=V.Pop,i=null,u=c();u==null&&(u=0,n.replaceState(fe({},n.state,{idx:u}),""));function c(){return(n.state||{idx:null}).idx}function F(){o=V.Pop;let d=c(),v=d==null?null:d-u;u=d,i&&i({action:o,location:T.location,delta:v})}function h(d,v){o=V.Push;let g=$e(T.location,d,v);l&&l(g,d),u=c()+1;let y=ba(g,u),E=T.createHref(g);try{n.pushState(y,"",E)}catch(N){if(N instanceof DOMException&&N.name==="DataCloneError")throw N;r.location.assign(E)}t&&i&&i({action:o,location:T.location,delta:1})}function _(d,v){o=V.Replace;let g=$e(T.location,d,v);l&&l(g,d),u=c();let y=ba(g,u),E=T.createHref(g);n.replaceState(y,"",E),t&&i&&i({action:o,location:T.location,delta:0})}function m(d){let v=r.location.origin!=="null"?r.location.origin:r.location.href,g=typeof d=="string"?d:Pe(d);return g=g.replace(/ $/,"%20"),R(v,"No window.location.(origin|href) available to create URL for href: "+g),new URL(g,v)}let T={get action(){return o},get location(){return e(r,n)},listen(d){if(i)throw new Error("A history only accepts one active listener");return r.addEventListener(Sa,F),i=d,()=>{r.removeEventListener(Sa,F),i=null}},createHref(d){return a(r,d)},createURL:m,encodeLocation(d){let v=m(d);return{pathname:v.pathname,search:v.search,hash:v.hash}},push:h,replace:_,go(d){return n.go(d)}};return T}var Ca;(function(e){e.data="data",e.deferred="deferred",e.redirect="redirect",e.error="error"})(Ca||(Ca={}));function os(e,a,l){l===void 0&&(l="/");let s=typeof a=="string"?Fe(a):a,r=Xe(s.pathname||"/",l);if(r==null)return null;let t=vl(e);is(t);let n=null;for(let o=0;n==null&&o<t.length;++o){let i=ys(r);n=vs(t[o],i)}return n}function vl(e,a,l,s){a===void 0&&(a=[]),l===void 0&&(l=[]),s===void 0&&(s="");let r=(t,n,o)=>{let i={relativePath:o===void 0?t.path||"":o,caseSensitive:t.caseSensitive===!0,childrenIndex:n,route:t};i.relativePath.startsWith("/")&&(R(i.relativePath.startsWith(s),'Absolute route path "'+i.relativePath+'" nested under path '+('"'+s+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),i.relativePath=i.relativePath.slice(s.length));let u=q([s,i.relativePath]),c=l.concat(i);t.children&&t.children.length>0&&(R(t.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+u+'".')),vl(t.children,a,c,u)),!(t.path==null&&!t.index)&&a.push({path:u,score:ps(u,t.index),routesMeta:c})};return e.forEach((t,n)=>{var o;if(t.path===""||!((o=t.path)!=null&&o.includes("?")))r(t,n);else for(let i of gl(t.path))r(t,n,i)}),a}function gl(e){let a=e.split("/");if(a.length===0)return[];let[l,...s]=a,r=l.endsWith("?"),t=l.replace(/\?$/,"");if(s.length===0)return r?[t,""]:[t];let n=gl(s.join("/")),o=[];return o.push(...n.map(i=>i===""?t:[t,i].join("/"))),r&&o.push(...n),o.map(i=>e.startsWith("/")&&i===""?"/":i)}function is(e){e.sort((a,l)=>a.score!==l.score?l.score-a.score:ms(a.routesMeta.map(s=>s.childrenIndex),l.routesMeta.map(s=>s.childrenIndex)))}const us=/^:[\w-]+$/,cs=3,fs=2,_s=1,hs=10,ds=-2,Pa=e=>e==="*";function ps(e,a){let l=e.split("/"),s=l.length;return l.some(Pa)&&(s+=ds),a&&(s+=fs),l.filter(r=>!Pa(r)).reduce((r,t)=>r+(us.test(t)?cs:t===""?_s:hs),s)}function ms(e,a){return e.length===a.length&&e.slice(0,-1).every((s,r)=>s===a[r])?e[e.length-1]-a[a.length-1]:0}function vs(e,a){let{routesMeta:l}=e,s={},r="/",t=[];for(let n=0;n<l.length;++n){let o=l[n],i=n===l.length-1,u=r==="/"?a:a.slice(r.length)||"/",c=gs({path:o.relativePath,caseSensitive:o.caseSensitive,end:i},u);if(!c)return null;Object.assign(s,c.params);let F=o.route;t.push({params:s,pathname:q([r,c.pathname]),pathnameBase:Ps(q([r,c.pathnameBase])),route:F}),c.pathnameBase!=="/"&&(r=q([r,c.pathnameBase]))}return t}function gs(e,a){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[l,s]=Ts(e.path,e.caseSensitive,e.end),r=a.match(l);if(!r)return null;let t=r[0],n=t.replace(/(.)\/+$/,"$1"),o=r.slice(1);return{params:s.reduce((u,c,F)=>{let{paramName:h,isOptional:_}=c;if(h==="*"){let T=o[F]||"";n=t.slice(0,t.length-T.length).replace(/(.)\/+$/,"$1")}const m=o[F];return _&&!m?u[h]=void 0:u[h]=(m||"").replace(/%2F/g,"/"),u},{}),pathname:t,pathnameBase:n,pattern:e}}function Ts(e,a,l){a===void 0&&(a=!1),l===void 0&&(l=!0),ml(e==="*"||!e.endsWith("*")||e.endsWith("/*"),'Route path "'+e+'" will be treated as if it were '+('"'+e.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+e.replace(/\*$/,"/*")+'".'));let s=[],r="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(n,o,i)=>(s.push({paramName:o,isOptional:i!=null}),i?"/?([^\\/]+)?":"/([^\\/]+)"));return e.endsWith("*")?(s.push({paramName:"*"}),r+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):l?r+="\\/*$":e!==""&&e!=="/"&&(r+="(?:(?=\\/|$))"),[new RegExp(r,a?void 0:"i"),s]}function ys(e){try{return e.split("/").map(a=>decodeURIComponent(a).replace(/\//g,"%2F")).join("/")}catch(a){return ml(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+a+").")),e}}function Xe(e,a){if(a==="/")return e;if(!e.toLowerCase().startsWith(a.toLowerCase()))return null;let l=a.endsWith("/")?a.length-1:a.length,s=e.charAt(l);return s&&s!=="/"?null:e.slice(l)||"/"}function Ss(e,a){a===void 0&&(a="/");let{pathname:l,search:s="",hash:r=""}=typeof e=="string"?Fe(e):e;return{pathname:l?l.startsWith("/")?l:bs(l,a):a,search:ks(s),hash:Rs(r)}}function bs(e,a){let l=a.replace(/\/+$/,"").split("/");return e.split("/").forEach(r=>{r===".."?l.length>1&&l.pop():r!=="."&&l.push(r)}),l.length>1?l.join("/"):"/"}function Oe(e,a,l,s){return"Cannot include a '"+e+"' character in a manually specified "+("`to."+a+"` field ["+JSON.stringify(s)+"].  Please separate it out to the ")+("`to."+l+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Cs(e){return e.filter((a,l)=>l===0||a.route.path&&a.route.path.length>0)}function Tl(e,a){let l=Cs(e);return a?l.map((s,r)=>r===e.length-1?s.pathname:s.pathnameBase):l.map(s=>s.pathnameBase)}function yl(e,a,l,s){s===void 0&&(s=!1);let r;typeof e=="string"?r=Fe(e):(r=fe({},e),R(!r.pathname||!r.pathname.includes("?"),Oe("?","pathname","search",r)),R(!r.pathname||!r.pathname.includes("#"),Oe("#","pathname","hash",r)),R(!r.search||!r.search.includes("#"),Oe("#","search","hash",r)));let t=e===""||r.pathname==="",n=t?"/":r.pathname,o;if(n==null)o=l;else{let F=a.length-1;if(!s&&n.startsWith("..")){let h=n.split("/");for(;h[0]==="..";)h.shift(),F-=1;r.pathname=h.join("/")}o=F>=0?a[F]:"/"}let i=Ss(r,o),u=n&&n!=="/"&&n.endsWith("/"),c=(t||n===".")&&l.endsWith("/");return!i.pathname.endsWith("/")&&(u||c)&&(i.pathname+="/"),i}const q=e=>e.join("/").replace(/\/\/+/g,"/"),Ps=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),ks=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,Rs=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e;function Es(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}const Sl=["post","put","patch","delete"];new Set(Sl);const ws=["get",...Sl];new Set(ws);/**
 ...
 *
 * @license MIT
 */function _e(){return _e=Object.assign?Object.assign.bind():function(e){for(var a=1;a<arguments.length;a++){var l=arguments[a];for(var s in l)Object.prototype.hasOwnProperty.call(l,s)&&(e[s]=l[s])}return e},_e.apply(this,arguments)}const ea=W(null),Ns=W(null),ee=W(null),Ne=W(null),z=W({outlet:null,matches:[],isDataRoute:!1}),bl=W(null);function Bs(e,a){let{relative:l}=a===void 0?{}:a;pe()||R(!1);let{basename:s,navigator:r}=P(ee),{hash:t,pathname:n,search:o}=kl(e,{relative:l}),i=n;return s!=="/"&&(i=n==="/"?s:q([s,n])),r.createHref({pathname:i,search:o,hash:t})}function pe(){return P(Ne)!=null}function me(){return pe()||R(!1),P(Ne).location}function Cl(e){P(ee).static||Q(e)}function Pl(){let{isDataRoute:e}=P(z);return e?zs():xs()}function xs(){pe()||R(!1);let e=P(ea),{basename:a,future:l,navigator:s}=P(ee),{matches:r}=P(z),{pathname:t}=me(),n=JSON.stringify(Tl(r,l.v7_relativeSplatPath)),o=Y(!1);return Cl(()=>{o.current=!0}),X(function(u,c){if(c===void 0&&(c={}),!o.current)return;if(typeof u=="number"){s.go(u);return}let F=yl(u,JSON.parse(n),t,c.relative==="path");e==null&&a!=="/"&&(F.pathname=F.pathname==="/"?a:q([a,F.pathname])),(c.replace?s.replace:s.push)(F,c.state,c)},[a,s,n,t,e])}const Ds=W(null);function Os(e){let a=P(z).outlet;return a&&b(Ds.Provider,{value:e},a)}function kl(e,a){let{relative:l}=a===void 0?{}:a,{future:s}=P(ee),{matches:r}=P(z),{pathname:t}=me(),n=JSON.stringify(Tl(r,s.v7_relativeSplatPath));return j(()=>yl(e,JSON.parse(n),t,l==="path"),[e,n,t,l])}function Is(e,a){return Ms(e,a)}function Ms(e,a,l,s){pe()||R(!1);let{navigator:r}=P(ee),{matches:t}=P(z),n=t[t.length-1],o=n?n.params:{};n&&n.pathname;let i=n?n.pathnameBase:"/";n&&n.route;let u=me(),c;if(a){var F;let d=typeof a=="string"?Fe(a):a;i==="/"||(F=d.pathname)!=null&&F.startsWith(i)||R(!1),c=d}else c=u;let h=c.pathname||"/",_=h;if(i!=="/"){let d=i.replace(/^\//,"").split("/");_="/"+h.replace(/^\//,"").split("/").slice(d.length).join("/")}let m=os(e,{pathname:_}),T=Ws(m&&m.map(d=>Object.assign({},d,{params:Object.assign({},o,d.params),pathname:q([i,r.encodeLocation?r.encodeLocation(d.pathname).pathname:d.pathname]),pathnameBase:d.pathnameBase==="/"?i:q([i,r.encodeLocation?r.encodeLocation(d.pathnameBase).pathname:d.pathnameBase])})),t,l,s);return a&&T?b(Ne.Provider,{value:{location:_e({pathname:"/",search:"",hash:"",state:null,key:"default"},c),navigationType:V.Pop}},T):T}function As(){let e=js(),a=Es(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),l=e instanceof Error?e.stack:null;return b(w,null,b("h2",null,"Unexpected Application Error!"),b("h3",{style:{fontStyle:"italic"}},a),l?b("pre",{style:{padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"}},l):null,null)}const Ls=b(As,null);class Us extends D{constructor(a){super(a),this.state={location:a.location,revalidation:a.revalidation,error:a.error}}static getDerivedStateFromError(a){return{error:a}}static getDerivedStateFromProps(a,l){return l.location!==a.location||l.revalidation!=="idle"&&a.revalidation==="idle"?{error:a.error,location:a.location,revalidation:a.revalidation}:{error:a.error!==void 0?a.error:l.error,location:l.location,revalidation:a.revalidation||l.revalidation}}componentDidCatch(a,l){console.error("React Router caught the following error during render",a,l)}render(){return this.state.error!==void 0?b(z.Provider,{value:this.props.routeContext},b(bl.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function $s(e){let{routeContext:a,match:l,children:s}=e,r=P(ea);return r&&r.static&&r.staticContext&&(l.route.errorElement||l.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=l.route.id),b(z.Provider,{value:a},s)}function Ws(e,a,l,s){var r;if(a===void 0&&(a=[]),l===void 0&&(l=null),s===void 0&&(s=null),e==null){var t;if((t=l)!=null&&t.errors)e=l.matches;else return null}let n=e,o=(r=l)==null?void 0:r.errors;if(o!=null){let c=n.findIndex(F=>F.route.id&&(o==null?void 0:o[F.route.id]));c>=0||R(!1),n=n.slice(0,Math.min(n.length,c+1))}let i=!1,u=-1;if(l&&s&&s.v7_partialHydration)for(let c=0;c<n.length;c++){let F=n[c];if((F.route.HydrateFallback||F.route.hydrateFallbackElement)&&(u=c),F.route.id){let{loaderData:h,errors:_}=l,m=F.route.loader&&h[F.route.id]===void 0&&(!_||_[F.route.id]===void 0);if(F.route.lazy||m){i=!0,u>=0?n=n.slice(0,u+1):n=[n[0]];break}}}return n.reduceRight((c,F,h)=>{let _,m=!1,T=null,d=null;l&&(_=o&&F.route.id?o[F.route.id]:void 0,T=F.route.errorElement||Ls,i&&(u<0&&h===0?(Gs("route-fallback",!1),m=!0,d=null):u===h&&(m=!0,d=F.route.hydrateFallbackElement||null)));let v=a.concat(n.slice(0,h+1)),g=()=>{let y;return _?y=T:m?y=d:F.route.Component?y=b(F.route.Component,null):F.route.element?y=F.route.element:y=c,b($s,{match:F,routeContext:{outlet:c,matches:v,isDataRoute:l!=null},children:y})};return l&&(F.route.ErrorBoundary||F.route.errorElement||h===0)?b(Us,{location:l.location,revalidation:l.revalidation,component:T,error:_,children:g(),routeContext:{outlet:null,matches:v,isDataRoute:!0}}):g()},null)}var Rl=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(Rl||{}),ke=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(ke||{});function Hs(e){let a=P(ea);return a||R(!1),a}function Vs(e){let a=P(Ns);return a||R(!1),a}function qs(e){let a=P(z);return a||R(!1),a}function El(e){let a=qs(),l=a.matches[a.matches.length-1];return l.route.id||R(!1),l.route.id}function js(){var e;let a=P(bl),l=Vs(ke.UseRouteError),s=El(ke.UseRouteError);return a!==void 0?a:(e=l.errors)==null?void 0:e[s]}function zs(){let{router:e}=Hs(Rl.UseNavigateStable),a=El(ke.UseNavigateStable),l=Y(!1);return Cl(()=>{l.current=!0}),X(function(r,t){t===void 0&&(t={}),l.current&&(typeof r=="number"?e.navigate(r):e.navigate(r,_e({fromRouteId:a},t)))},[e,a])}const ka={};function Gs(e,a,l){!a&&!ka[e]&&(ka[e]=!0)}function aa(e){return Os(e.context)}function k(e){R(!1)}function Ks(e){let{basename:a="/",children:l=null,location:s,navigationType:r=V.Pop,navigator:t,static:n=!1,future:o}=e;pe()&&R(!1);let i=a.replace(/^\/*/,"/"),u=j(()=>({basename:i,navigator:t,static:n,future:_e({v7_relativeSplatPath:!1},o)}),[i,o,t,n]);typeof s=="string"&&(s=Fe(s));let{pathname:c="/",search:F="",hash:h="",state:_=null,key:m="default"}=s,T=j(()=>{let d=Xe(c,i);return d==null?null:{location:{pathname:d,search:F,hash:h,state:_,key:m},navigationType:r}},[i,c,F,h,_,m,r]);return T==null?null:b(ee.Provider,{value:u},b(Ne.Provider,{children:l,value:T}))}function Js(e){let{children:a,location:l}=e;return Is(We(a),l)}new Promise(()=>{});function We(e,a){a===void 0&&(a=[]);let l=[];return Ye.forEach(e,(s,r)=>{if(!ne(s))return;let t=[...a,r];if(s.type===w){l.push.apply(l,We(s.props.children,t));return}s.type!==k&&R(!1),!s.props.index||!s.props.children||R(!1);let n={id:s.props.id||t.join("-"),caseSensitive:s.props.caseSensitive,element:s.props.element,Component:s.props.Component,index:s.props.index,path:s.props.path,loader:s.props.loader,action:s.props.action,errorElement:s.props.errorElement,ErrorBoundary:s.props.ErrorBoundary,hasErrorBoundary:s.props.ErrorBoundary!=null||s.props.errorElement!=null,shouldRevalidate:s.props.shouldRevalidate,handle:s.props.handle,lazy:s.props.lazy};s.props.children&&(n.children=We(s.props.children,t)),l.push(n)}),l}/**
 ...
 *
 * @license MIT
 */function He(){return He=Object.assign?Object.assign.bind():function(e){for(var a=1;a<arguments.length;a++){var l=arguments[a];for(var s in l)Object.prototype.hasOwnProperty.call(l,s)&&(e[s]=l[s])}return e},He.apply(this,arguments)}function Ys(e,a){if(e==null)return{};var l={},s=Object.keys(e),r,t;for(t=0;t<s.length;t++)r=s[t],!(a.indexOf(r)>=0)&&(l[r]=e[r]);return l}function Zs(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function Qs(e,a){return e.button===0&&(!a||a==="_self")&&!Zs(e)}function Ve(e){return e===void 0&&(e=""),new URLSearchParams(typeof e=="string"||Array.isArray(e)||e instanceof URLSearchParams?e:Object.keys(e).reduce((a,l)=>{let s=e[l];return a.concat(Array.isArray(s)?s.map(r=>[l,r]):[[l,s]])},[]))}function Xs(e,a){let l=Ve(e);return a&&a.forEach((s,r)=>{l.has(r)||a.getAll(r).forEach(t=>{l.append(r,t)})}),l}const er=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],ar="6";try{window.__reactRouterVersion=ar}catch{}const lr="startTransition",Ra=rs[lr];function sr(e){let{basename:a,children:l,future:s,window:r}=e,t=Y();t.current==null&&(t.current=ts({window:r,v5Compat:!0}));let n=t.current,[o,i]=de({action:n.action,location:n.location}),{v7_startTransition:u}=s||{},c=X(F=>{u&&Ra?Ra(()=>i(F)):i(F)},[i,u]);return Q(()=>n.listen(c),[n,c]),b(Ks,{basename:a,children:l,location:o.location,navigationType:o.action,navigator:n,future:s})}const rr=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",tr=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,M=Je(function(a,l){let{onClick:s,relative:r,reloadDocument:t,replace:n,state:o,target:i,to:u,preventScrollReset:c,unstable_viewTransition:F}=a,h=Ys(a,er),{basename:_}=P(ee),m,T=!1;if(typeof u=="string"&&tr.test(u)&&(m=u,rr))try{let y=new URL(window.location.href),E=u.startsWith("//")?new URL(y.protocol+u):new URL(u),N=Xe(E.pathname,_);E.origin===y.origin&&N!=null?u=N+E.search+E.hash:T=!0}catch{}let d=Bs(u,{relative:r}),v=nr(u,{replace:n,state:o,target:i,preventScrollReset:c,relative:r,unstable_viewTransition:F});function g(y){s&&s(y),y.defaultPrevented||v(y)}return b("a",He({},h,{href:m||d,onClick:T||t?s:g,ref:l,target:i}))});var Ea;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(Ea||(Ea={}));var wa;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(wa||(wa={}));function nr(e,a){let{target:l,replace:s,state:r,preventScrollReset:t,relative:n,unstable_viewTransition:o}=a===void 0?{}:a,i=Pl(),u=me(),c=kl(e,{relative:n});return X(F=>{if(Qs(F,l)){F.preventDefault();let h=s!==void 0?s:Pe(u)===Pe(c);i(e,{replace:h,state:r,preventScrollReset:t,relative:n,unstable_viewTransition:o})}},[u,i,c,s,r,l,e,t,n,o])}function zr(e){let a=Y(Ve(e)),l=Y(!1),s=me(),r=j(()=>Xs(s.search,l.current?null:a.current),[s.search]),t=Pl(),n=X((o,i)=>{const u=Ve(typeof o=="function"?o(r):o);l.current=!0,t("?"+u,i)},[t,r]);return[r,n]}var Fr=0;function f(e,a,l,s,r,t){var n,o,i={};for(o in a)o=="ref"?n=a[o]:i[o]=a[o];var u={type:e,props:i,key:l,ref:n,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,constructor:void 0,__v:--Fr,__i:-1,__u:0,__source:r,__self:t};if(typeof e=="function"&&(n=e.defaultProps))for(o in n)i[o]===void 0&&(i[o]=n[o]);return p.vnode&&p.vnode(u),u}const or=()=>f(w,{children:[f("h2",{children:"Set Seed Tools:"}),f("ul",{children:[f("li",{children:f(M,{to:"branching-rerolls.html",children:"Blueprint Rerolls"})}),f("li",{children:f(M,{to:"turbo-seed-searcher.html",children:"Turbo Seed Searcher"})}),f("li",{children:f(M,{to:"normal-seed-searcher.html",children:"Normal/Autumn Seed Searcher"})}),f("li",{children:[f(M,{to:"versus-seeds.html",children:"Normal/Autumn Versus Seed Generator"})," ","(Limit card choice butterfly effect)"]}),f("li",{children:"Incomplete/very buggy:"}),f("ul",{children:[f("li",{children:f(M,{to:"card-paths.html",children:"Card Paths"})}),f("li",{children:f(M,{to:"weekly.html",children:"Weekly Speedrun"})}),f("li",{children:f(M,{to:"weekly-export.html",children:"Weekly Speedrun Data Export"})})]})]}),f("h2",{children:"Notes/Weird Mechanics?"}),f("ul",{children:[f("li",{children:f(M,{to:"coffee.html",children:"Coffee Eating Times"})}),f("li",{children:f(M,{to:"ice-cream.html",children:"Ice Cream"})}),f("li",{children:f(M,{to:"TODO.html",children:"TODO"})}),!1]})]}),ir="1.1.9 (501C)",ur=()=>f("div",{children:["Game data from version ",ir]}),cr=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False,False,60\r
...
-528942924,False,False,Layout Generator Button,False,False,,,0,0,0,False,False,60\r
...
`,pr=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0\r
1356267749,Salad,1,2087693779,1193867305:-712909563:380220741,True,False,0\r
550743424,Pizza,1,2087693779:-1706154991:-523839730,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0\r
367917843,Dumplings,1,1972879238:-523839730:2087693779,925796718:-484165118:-452101383:380220741,True,False,0\r
-1778969928,Burgers,1,1972879238,759552160:380220741:385684499,True,False,0\r
...
`,Be=dr.trim().split(`\r
`).filter(e=>e).map(e=>{var E,N;const[a,l,s,r,t,n,o,i,u,c]=e.split(","),F=Number(a),h=Number(s),_=r!=null&&r.length?r.split(":").map(I=>Number(I)):[],m=t.length?t.split(":").map(I=>Number(I)):[],T=n!=null&&n.length?(E=n==null?void 0:n.split(":"))==null?void 0:E.map(I=>Number(I)):[],d=o!=null&&o.length?(N=o==null?void 0:o.split(":"))==null?void 0:N.map(I=>Number(I)):[],v=i==="True",g=u==="True",y=Number(c);return{ID:F,Name:l,UnlockGroup:h,Requires:_,BlockedBy:m,RequiredProcesses:T,IngredientProviders:d,isMain:v,isStarterOrSide:g,DishType:y}});function Gr(e,a=!0){const l=a&&e.some(s=>s.Name==="Community");return Be.filter(s=>{if(e.some(r=>r.ID===s.ID)||s.BlockedBy.some(r=>e.some(t=>t.ID===r))||s.Requires.some(r=>!e.some(t=>t.ID===r)))return!1;if(s.isStarterOrSide)if(e.some(r=>r.isMain)){if(e.length&&e[0].DishType===H.Dessert)debugger}else return!1;return!(!l&&s.DishType===H.Base)}).sort((s,r)=>s.ID-r.ID)}const mr=[{ID:447437163,Name:"Country",UnlockGroup:J.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:H.Null},{ID:2002876295,Name:"City",UnlockGroup:J.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:H.Null},{ID:-1864906012,Name:"Alpine",UnlockGroup:J.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:H.Null},Be.filter(e=>e.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:J.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:H.Null},{ID:1958825350,Name:"Turbo",UnlockGroup:J.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:H.Null}],vr=[...mr].sort((e,a)=>e.Name<a.Name?-1:1),Kr=["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>Be.filter(a=>a.Name===e)[0]),Jr=pr.trim().split(`\r
`).filter(e=>e).map(e=>{var d,v;const[a,l,s,r,t,n,o,i]=e.split(","),u=Number(a),c=Number(s),F=r!=null&&r.length?(d=r==null?void 0:r.split(":"))==null?void 0:d.map(g=>Number(g)):[],h=t!=null&&t.length?(v=t==null?void 0:t.split(":"))==null?void 0:v.map(g=>Number(g)):[],_=n==="True",m=o==="True",T=Number(i);return{ID:u,Name:l,UnlockGroup:c,Requires:[],BlockedBy:[],RequiredProcesses:F,IngredientProviders:h,isMain:_,isStarterOrSide:m,DishType:T}}).sort((e,a)=>e.Name<a.Name?-1:1),gr="38",Tr=Number(gr);function yr(e,a){let l=e.length;for(;l-- >1;){let s=a.range(0,l+1);[e[l],e[s]]=[e[s],e[l]]}return e}const Yr="bdghjmqrtvwxy346789";class Ee{constructor(a,l){C(this,"fixedSeed");C(this,"instance");C(this,"random");typeof a=="string"&&(a=br(a)),this.fixedSeed=a,this.instance=l,this.random=new Sr(a+Math.imul(124192293,l))}useSubcontext(a){return new Ee(this.fixedSeed,124192293*a+this.instance)}}class Sr{constructor(a){C(this,"seed");const l=o=>Math.imul(1812433253,o)+1>>0,s=a>>0,r=l(s),t=l(r),n=l(t);this.seed=[s,r,t,n]}get value(){let a=this.seed.shift(),l=this.seed[2];return a^=a<<11,a^=a>>>8,l^=l>>>19,l=(l^a)>>0,this.seed.push(l),l}range(a,l){return(this.value>>>0)%(l-a)+a}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(a){return a[this.range(0,a.length)]}}function br(e){const l=new TextEncoder().encode(e);let s=5381,r=l.length;for(;r>0;){let t=--r;s=(s<<5)+s+l[t]}return s>>0}const Cr=Re.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class Pr{constructor(a,l=0){C(this,"seed");C(this,"mapSize");C(this,"numTiles");C(this,"baseUpgradeChance");C(this,"OwnedAppliances");C(this,"Cards");C(this,"Theme");C(this,"cache",new Map);C(this,"cacheDay");this.seed=a,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=l,this.OwnedAppliances=[],this.Cards=[],this.Theme=ue.Null,this.cacheDay=-1}getLayoutInfo(){const l=new Ee(this.seed,5078598).useSubcontext(0).random.range(0,8);let s,r;switch(l){case 0:r=70,s=2;break;case 4:r=84,s=2;break;case 1:case 5:r=60,s=1;break;case 2:case 6:r=9*13,s=3;break;case 3:case 7:r=12*16,s=4;break;default:throw new Error}return[s,r]}handleNewCardSpawnEffects(a){a!==void 0&&(a.Name==="Turbo"&&(this.baseUpgradeChance=.25),a.UnlockGroup===J.PrimaryTheme&&(this.Theme=ue[a.Name]))}handleNewCardRerollEffects(a){a!==void 0&&(this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(l=>Re.filter(s=>s.ID===l))))}addCard(a){a!==void 0&&(this.handleNewCardSpawnEffects(a),this.handleNewCardRerollEffects(a),this.Cards.push(a))}getPrngAdvancements(a,l){let s=0;for(let r=0;r<a.length;r++){const t=a[r];let n=t.blueprintCount;l%5===0&&(n+=3,r===0&&(n+=2)),s+=n*(Cr-1+1),t.spawnInside||(s+=kr(t.playerInside,this.numTiles)),s+=Tr}return s}buildShopOptions(a,l,s){let r=[];for(const n of Re)if(!(!n.IsPurchasable&&!n.IsPurchasableAsUpgrade)){var t=new hr(n);if(t.Staple==A.NonStaple||t.Staple==A.WhenMissing){if((t.Tags&G.Basic)>G.None)t.Staple=A.FixedStaple;else if(t.StapleWhenMissing){const u=t.Appliance.Name;u!="Research Desk"&&u!="Blueprint Cabinet"&&u!="Plates"&&console.log(`Unexpected ${t.Appliance.Name} StapleWhenMissing Appliance`),a.some(c=>c.ID===t.Appliance.ID)?t.Staple=A.NonStaple:t.Staple=A.WhenMissing}}const i=t.Appliance;if(i.SellOnlyAsDuplicate)a.some(u=>u.ID===i.ID)||(t.IsRemoved=!0);else if(i.RequiresForShop.length>0){let u=!1;for(const c of i.RequiresForShop)a.some(F=>F.ID===c)&&(u=!0);t.IsRemoved=!u}else i.SellOnlyAsUnique&&(i.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${i.Name}, ${i.ID}`),a.some(u=>u.ID===i.ID)&&(t.IsRemoved=!0));(t.Appliance.Name==="Sink"||t.Appliance.Name==="Plates")&&s.every(u=>!u.isMain)&&(t.IsRemoved=!0),t.Filter==wl.RefreshableProvider&&(a.some(u=>u.AllowRefreshes)||(t.IsRemoved=!0)),t.DecorationRequired!=ue.Null&&t.DecorationRequired!=l&&(t.IsRemoved=!0),i.RequiresProcessForShop.length>0&&(i.RequiresProcessForShop.some(u=>s.some(c=>c.RequiredProcesses.includes(u)))||(t.IsRemoved=!0)),r.push(t)}return r}initRandom(a){return new Ee(this.seed,823828*1231231+a)}getAppliances(a,l){l!==this.cacheDay&&(this.cacheDay=l,this.cache.clear());const s=a.length===1,r=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards);let t=a[a.length-1].blueprintCount,n;if(l%5==0){s?t=10:t+=3,n=[];for(let c=0;c<t;c++)n[c]=G.Decoration;if(s)for(const c of[1,2])n[n.length-c]=G.SpecialEvent}else if(a.length>1){n=[];for(let c=0;c<t;c++)n[c]=Na.DefaultShoppingTag}else{const c=Na.DefaultShoppingTag,F=Math.max(1,t),h=Math.max(0,Math.min(r.filter(m=>m.Staple!==A.NonStaple&&!m.IsRemoved).length,Math.max(2,4-Math.floor(l/5)),F)),_=Math.max(0,F-h);t=F,n=[];for(let m=0;m<h;m++)n[m]=G.Basic;for(let m=h;m<h+_;m++)n[m]=c}const o=this.initRandom(l).random;let i=this.getPrngAdvancements(a.slice(0,a.length-1),l);if(this.cache.has(i)&&this.cache.get(i).length>=t)return this.cache.get(i).slice(0,t);const u=i;for(;i--;)o.value;{const c=[...r],F=[],h=this.getUpgradeChance(l),_=[];for(let m=0;m<t;m++){const T=n[m],v=o.valueFloat<h;yr(c,o);for(let g=0;g<c.length;g++){const y=c[g];if(!y.IsRemoved&&!_.includes(y.Appliance)&&!!y.MatchesRequestTags(T)&&!(!v&&y.Staple==A.NonStaple&&y.SellAsUpgrade)){T!=G.Decoration&&_.push(y.Appliance),F[m]=y.Appliance;break}}F[m]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${m}`)}return this.cache.set(u,F),F}}getUpgradeChance(a){return 1-(1-Math.floor(a/5)*.1)*(1-this.baseUpgradeChance)}}function kr(e,a){return e?a-2:a-1}const Rr=["Research Desk","Blueprint Cabinet","Booking Desk"],Er=()=>{let e=new Pr("");e.OwnedAppliances=[...e.OwnedAppliances,...Re.filter(i=>Rr.includes(i.Name))],e.addCard(vr.filter(i=>i.Name==="Turbo")[0]),e.addCard(Be.filter(i=>i.Name==="Stir Fry")[0]);let a=e.buildShopOptions(e.OwnedAppliances,ue.Null,e.Cards);a=a.filter(i=>!i.IsRemoved);const l=a.length;a=a.filter(i=>i.Staple===A.NonStaple);const s=a.length;a=a.filter(i=>!i.SellAsUpgrade);const r=a.length;console.log({total:l,nonstaples:s,nonupgrades:r});const t=1/s,n=1/r,o=.25*t+.75*n;return console.log(Math.log(.2)/Math.log(1-o)),f(w,{children:JSON.stringify({total:l,nonstaples:s,nonupgrades:r,upgradesAllowed:t,upgradesNotAllowed:n,average:o,rerollFive:1-(1-o)**5})})},wr=B(()=>O(()=>import("./seedSearcher-znl1iYx0.js"),__vite__mapDeps([0,1,2,3]))),Nr=B(()=>O(()=>import("./versusSeeds-_h7wxCQl.js"),__vite__mapDeps([4,1]))),Br=B(()=>O(()=>import("./seedSearcherNormal-zuMj_PLA.js"),__vite__mapDeps([5,1,2,3]))),xr=B(()=>O(()=>import("./branchingRerolls-7xGv_P93.js"),__vite__mapDeps([6,7,1,2]))),Dr=B(()=>O(()=>import("./cardPaths-Aw8AzF0u.js"),__vite__mapDeps([8,9,10,1,2]))),Or=B(()=>O(()=>import("./weeklyExport-nQzg7s38.js"),__vite__mapDeps([11,12,10,9]))),Ir=B(()=>O(()=>import("./weekly--xJVYa6N.js"),__vite__mapDeps([13,7,12,10]))),Mr=B(()=>O(()=>import("./coffeeEatingTime-R4_lSKd8.js"),__vite__mapDeps([]))),Ar=B(()=>O(()=>import("./scratch-6Jg4rvWv.js"),__vite__mapDeps([14,2]))),Lr=B(()=>O(()=>import("./BreakfastAuto-GfOOkXT8.js"),__vite__mapDeps([]))),Ba=B(()=>O(()=>import("./todo-QB5NJJvK.js"),__vite__mapDeps([]))),Ur=B(()=>O(()=>import("./IceCreamActions-LcWc4CmI.js"),__vite__mapDeps([]))),$r=()=>f(w,{children:"..."}),Wr=()=>f(w,{children:[f("div",{children:f(M,{to:"/plateup-set-seed-tools/",children:"<-- All Tools"})}),f(aa,{})]}),Hr=()=>f(w,{children:[f(aa,{}),f(ur,{})]}),Vr=()=>f(le,{fallback:f($r,{}),children:f(aa,{})});function qr(){return f(Js,{children:f(k,{element:f(Vr,{}),children:f(k,{path:"/plateup-set-seed-tools/",children:[f(k,{index:!0,element:f(or,{})}),f(k,{path:"scratch",element:f(Ar,{})}),f(k,{element:f(Wr,{}),children:[f(k,{path:"TODO.html",element:f(Ba,{})}),f(k,{path:"test.html",element:f(Ba,{})}),f(k,{element:f(Hr,{}),children:[f(k,{path:"researchProbabilities.html",element:f(Er,{})}),f(k,{path:"breakfast-auto.html",element:f(Lr,{})}),f(k,{path:"turbo-seed-searcher.html",element:f(wr,{})}),f(k,{path:"versus-seeds.html",element:f(Nr,{})}),f(k,{path:"normal-seed-searcher.html",element:f(Br,{})}),f(k,{path:"branching-rerolls.html",element:f(xr,{})}),f(k,{path:"card-paths.html",element:f(Dr,{})}),f(k,{path:"weekly-export.html",element:f(Or,{})}),f(k,{path:"weekly.html",element:f(Ir,{})}),f(k,{path:"coffee.html",element:f(Mr,{})}),f(k,{path:"ice-cream.html",element:f(Ur,{})})]})]})]})})})}re(f(sr,{children:f(qr,{})}),document.getElementById("app"));export{Re as A,H as D,Ee as F,Yr as I,M as L,vr as R,Jr as S,X as T,Be as U,Y as _,Sr as a,j as b,zr as c,Pr as d,J as e,mr as f,w as g,de as h,Kr as i,Gr as j,Ge as p,ze as s,f as u,ss as w,Q as y};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/seedSearcher-znl1iYx0.js","assets/UnlockSelect-A_eX4YZK.js","assets/usePersistentState-9Vp-5KRa.js","assets/SeedSearchResult-WigBOGEe.js","assets/versusSeeds-_h7wxCQl.js","assets/seedSearcherNormal-zuMj_PLA.js","assets/branchingRerolls-7xGv_P93.js","assets/GhostBlueprints-AW6fuQWR.js","assets/cardPaths-Aw8AzF0u.js","assets/CardPaths-j0ry0c2H.js","assets/cards-lxY4e5UE.js","assets/weeklyExport-nQzg7s38.js","assets/weekly-ImNn-NNL.js","assets/weekly--xJVYa6N.js","assets/scratch-6Jg4rvWv.js"]
  }
