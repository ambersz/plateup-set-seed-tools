var ee=Object.defineProperty;var se=(u,c,p)=>c in u?ee(u,c,{enumerable:!0,configurable:!0,writable:!0,value:p}):u[c]=p;var g=(u,c,p)=>(se(u,typeof c!="symbol"?c+"":c,p),p);(function(){"use strict";var u=(a=>(a[a.Generic=0]="Generic",a[a.Dish=1]="Dish",a[a.PrimaryTheme=3]="PrimaryTheme",a[a.SecondaryTheme=4]="SecondaryTheme",a[a.Franchise=5]="Franchise",a[a.Special=6]="Special",a))(u||{}),c=(a=>(a[a.Base=0]="Base",a[a.Main=1]="Main",a[a.Extra=2]="Extra",a[a.Side=3]="Side",a[a.Starter=4]="Starter",a[a.Dessert=5]="Dessert",a[a.Null=6]="Null",a))(c||{}),p=`373996608,Ice Cream,1,,,,-1533430406,False,False,5,1,2\r
...
`,H=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0,0,5\r
1356267749,Salad,1,2087693779,1193867305:-712909563:380220741,True,False,0,-1,5\r
550743424,Pizza,1,2087693779:-1706154991:-523839730,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0,0,5\r
367917843,Dumplings,1,1972879238:-523839730:2087693779,925796718:-484165118:-452101383:380220741,True,False,0,2,8\r
-1778969928,Burgers,1,1972879238,759552160:380220741:385684499,True,False,0,-2,3\r
...
`).filter(a=>a).map(a=>{var q,A;const[e,s,r,t,n,l,i,F,o,h,d,m]=a.split(","),B=Number(e),P=Number(r),R=t!=null&&t.length?t.split(":").map(k=>Number(k)):[],v=n.length?n.split(":").map(k=>Number(k)):[],G=l!=null&&l.length?(q=l==null?void 0:l.split(":"))==null?void 0:q.map(k=>Number(k)):[],x=i!=null&&i.length?(A=i==null?void 0:i.split(":"))==null?void 0:A.map(k=>Number(k)):[],w=F==="True",y=o==="True",D=Number(h),T=Number(d),X=Number(m);return{ID:B,Name:s,UnlockGroup:P,Requires:R,BlockedBy:v,RequiredProcesses:G,IngredientProviders:x,isMain:w,isStarterOrSide:y,DishType:D,CustomerMultiplier:T,DishValue:X}});function f(a,e=!0){const s=e&&a.some(r=>r.Name==="Community");return b.filter(r=>{if(a.some(t=>t.ID===r.ID)||r.BlockedBy.some(t=>a.some(n=>n.ID===t))||r.Requires.some(t=>!a.some(n=>n.ID===t)))return!1;if(r.isStarterOrSide)if(a.some(t=>t.isMain)){if(a.length&&a[0].DishType===c.Dessert)debugger}else return!1;return!(!s&&r.DishType===c.Base)}).sort((r,t)=>r.ID-t.ID)}[...[{ID:447437163,Name:"Country",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null,CustomerMultiplier:0,DishValue:0},b.filter(a=>a.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null,CustomerMultiplier:0,DishValue:0},{ID:1958825350,Name:"Turbo",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null,CustomerMultiplier:0,DishValue:0}]].sort((a,e)=>a.Name<e.Name?-1:1),["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(a=>b.filter(e=>e.Name===a)[0]),H.trim().split(`\r
`).filter(a=>a).map(a=>{var y,D;const[e,s,r,t,n,l,i,F,o,h]=a.split(","),d=Number(e),m=Number(r),B=t!=null&&t.length?(y=t==null?void 0:t.split(":"))==null?void 0:y.map(T=>Number(T)):[],P=n!=null&&n.length?(D=n==null?void 0:n.split(":"))==null?void 0:D.map(T=>Number(T)):[],R=l==="True",v=i==="True",G=Number(F),x=Number(o),w=Number(h);return{ID:d,Name:s,UnlockGroup:m,Requires:[],BlockedBy:[],RequiredProcesses:B,IngredientProviders:P,isMain:R,isStarterOrSide:v,DishType:G,CustomerMultiplier:x,DishValue:w}}).sort((a,e)=>a.Name<e.Name?-1:1);class S{constructor(e,s){g(this,"fixedSeed");g(this,"instance");g(this,"random");typeof e=="string"&&(e=O(e)),this.fixedSeed=e,this.instance=s,this.random=new z(e+Math.imul(124192293,s))}useSubcontext(e){return new S(this.fixedSeed,124192293*e+this.instance)}}class z{constructor(e){g(this,"seed");const s=i=>Math.imul(1812433253,i)+1>>0,r=e>>0,t=s(r),n=s(t),l=s(n);this.seed=[r,t,n,l]}get value(){let e=this.seed.shift(),s=this.seed[2];return e^=e<<11,e^=e>>>8,s^=s>>>19,s=(s^e)>>0,this.seed.push(s),s}range(e,s){return(this.value>>>0)%(s-e)+e}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(e){return e[this.range(0,e.length)]}}function O(a){const s=new TextEncoder().encode(a);let r=5381,t=s.length;for(;t>0;){let n=--t;r=(r<<5)+r+s[n]}return r>>0}function E(a,e,s){return new S(s,a*1231231+e)}class M{constructor(){g(this,"encourageGroups",[u.Special])}GetOptions(e,s,r){const t=r.random;let n=0;for(s!==15&&(n=this.getPad(e,s));n--;)t.value;let l=this.sortCandidates(e,s,r.random);const[i,F]=this.getUnlockGroups(s);let o=null,h=null;for(const d of l)if(!(d.UnlockGroup!==i&&d.UnlockGroup!==F)&&(o===null||o.UnlockGroup!==i&&d.UnlockGroup===i?o=d:(h===null||h.UnlockGroup!==F&&d.UnlockGroup===F)&&(h=d),o&&o.UnlockGroup===i&&h&&h.UnlockGroup===F))break;return[o,h]}getPad(e,s){if(s===15)return 0;let r=f(e).length+1;return s===5&&(r*=2),r}sortCandidates(e,s,r){let t=f(e),n=N(t,r);return r.valueFloat<.5&&n.sort((i,F)=>{let o=0;return C(i)&&o--,C(F)&&o++,o}),n}getUnlockGroups(e){return e===15?[u.Franchise,u.Franchise]:e===5?[u.PrimaryTheme,u.PrimaryTheme]:[u.Dish,u.Generic]}}class V extends M{getPad(e,s){let r=f(e,!1).length+1;return s!==5&&(r*=2),r}sortCandidates(e,s,r){let t=f(e),n=N(t,r);return r.valueFloat<.1&&n.sort((F,o)=>{let h=0;return F.Requires.length&&h--,o.Requires.length&&h++,h}),n}}class L extends M{constructor(){super(...arguments);g(this,"ThanksgivingCards",["Turkey","Nut Roast"])}getPad(s,r){if(r===15)return 0;let t=f(s,!1).length+1;if(r===5){let n=f(s);t+=n.length+2}return t}sortCandidates(s,r,t){let n=r===5||r===15?f(s,!1):f(s),l=N(n,t);return t.valueFloat<.5&&l.sort((o,h)=>{let d=0;return C(o,!1)&&d--,C(h,!1)&&d++,d}),r!==5&&r!==15&&t.valueFloat<.25&&l.sort((h,d)=>{let m=0;return this.ThanksgivingCards.includes(h.Name)&&m++,this.ThanksgivingCards.includes(d.Name)&&m--,m}),l}getUnlockGroups(s){return s===15?[u.Franchise,u.Franchise]:s===5?[u.PrimaryTheme,u.PrimaryTheme]:[u.Dish,u.Dish]}}function N(a,e){return a.map(r=>[r,e.valueFloat]).sort((r,t)=>r[1]-t[1]).map(r=>r[0])}class _{constructor(e){g(this,"cards");g(this,"unlockPack");g(this,"seed");this.cards=[],this.unlockPack=new M,this.seed=e}addCard(e){if(e!==void 0){switch(e.Name){case"Community":this.unlockPack=new L;break;case"Turbo":this.unlockPack=new V;break}this.cards.push(e)}}getUnlockOptions(e){const r=E(848292,e,this.seed).useSubcontext(1);return this.unlockPack.GetOptions(this.cards,e,r)}getCustomers(e,s=1){return[]}getGroupSizeRange(e){if(this.cards.some(n=>n.Name==="Community")){const n=Math.floor((e-1)/3);return[n+1,n+2]}let r=1,t=2;return this.cards.some(n=>n.Name==="Individual Dining")?[1,1]:(this.cards.some(n=>n.Name==="Medium Groups")&&(r++,t+=2),this.cards.some(n=>n.Name==="Large Groups")&&(r+=2,t+=4),this.cards.some(n=>n.Name==="Flexible Groups")&&(r--,t++),[r,t])}}function C(a,e=!0){return a.UnlockGroup===u.Special||a.DishType===c.Main||a.DishType===c.Extra?!0:e?!!a.Requires.length:!1}const I="bdghjmqrtvwxy346789";function j(){let a="";for(;a.length<8;)a+=I[Math.floor(Math.random()*I.length)];return a}class Q{constructor(e,s=[],r=[]){g(this,"seed");g(this,"mapSize");g(this,"frontDoor");g(this,"startingCards");g(this,"cards");g(this,"playerCount");g(this,"turbo");g(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=s,this.cards=r,this.playerCount=this.mapSize,this.turbo=this.startingCards.some(t=>{if(t===void 0){console.log({startingCards:s});debugger}return t.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const s=this.getCustomerCount(e);let r=this.startingCards.reduce((t,n)=>t+n.DishValue,0);if(this.getCardsByDay(e).some(t=>t.Name==="Double Helpings")&&(r+=3),Number.isNaN(s))debugger;if(Number.isNaN(r))debugger;return W(this.playerCount)*(s*r+this.getBookingDeskCount(e)*this.getBookingDeskMoney(e))}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let s;this.turbo?s=e-1:(s=Math.max(0,Math.floor((e-1)/3)),e>5&&s++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,s)],console.log(`Day ${e} has ${this._cardsByDay[e].map(r=>r.Name).join(", ")}`)}return this._cardsByDay[e]}getBookingDeskCount(e){return Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e))+(this.turbo?3:this.getCardsByDay(e).filter(s=>s.Name.includes(" Rush")).length)}getGroupCount(e){const s=this.getExpectedCustomers(e),r=this.getCardsByDay(e).filter(l=>l.Name==="Closing Time").length*.2,t=this.getExpectedGroupSize(e),n=s*(1+r)/t;return console.log({custs:s,closingTimeAdjust:r,avgGroupSize:t,goalGroups:n}),Math.ceil(n)}getCustomerCount(e){return this.getGroupSizes(e).reduce((s,r)=>s+r,0)}getGroupSizes(e){const s=E(1997821,e,this.seed).random,r=this.getGroupCount(e),t=this.getCardsByDay(e).some(m=>m.Name==="Herd Mentality");let n=r,l=[],[i,F]=this.getGroupSizeRange(e);console.log({min:i,max:F,gc:r,herd:t});{let m=n-1;for(;m--;)s.value}for(;n--;)l.push(s.range(i,F+1)),!t&&n!==r-1&&s.value;let o=this.turbo?3:this.getCardsByDay(e).filter(m=>m.Name.includes(" Rush")).length;const h=Math.ceil(Math.max(1,this.getExpectedCustomers(e)*.15));let d=o*h;for(console.log({totalRushGroups:d});d--;)l.push(s.range(i,F+1));return console.log({groups:l}),l}getExpectedGroupSize(e){const s=this.getGroupSizeRange(e);return(s[0]+s[1])/2}getGroupSizeRange(e){let s=1,r=2;for(const t of this.getCardsByDay(e))switch(t.Name){case"Individual Dining":r--;break;case"Medium Groups":s++,r+=2;break;case"Large Groups":s+=2,r+=2;break;case"Flexible Dining":s--,r++;break;case"Community":const n=Math.floor((e-1)/3);s+=n,r+=n;break}return[s,r]}getExpectedCustomers(e){const s=this.getReductions(e),r=this.getDayLength(e),t=this.getPlayerModifier(),n=this.getCourseModifier(e),l=this.getDayRate(e),i=this.getCustomersPerHour(e),F=this.getAdvertisingModifier(e),o=.85**s*(r/25*l*t)/n*i*F;return console.log({reductions:s,dayLength:r,playerModifier:t,courseModifier:n,dayRate:l,kitchenParamCustomers:i,advertising:F,res:o}),o}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(r=>r.Name==="Advertising").length}getDayRate(e){let s=1;switch(e){case 1:s=1.25;break;case 2:s=1.5;break;default:s=1.5+.15*(e-3);break}return e>15&&(s+=(this.turbo?.1:0)*(e-15)**1.5),s}getCourseModifier(e){let s=1;const r=this.getCardsByDay(e);return r.some(t=>t.DishType===c.Dessert)&&(s+=.25),r.some(t=>t.DishType===c.Starter)&&(s+=.25),s}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let s=1;return this.turbo&&(s=1.5,s*=1+e/10),s}getReductions(e){return this.getCardsByDay(e).reduce((r,t)=>r+t.CustomerMultiplier,0)}getMapSize(){const s=new S(this.seed,5078598).useSubcontext(0).random.range(0,4);let r;switch(s){case 0:r=2;break;case 1:r=1;break;case 2:r=3;break;case 3:r=4;break;default:throw new Error}return r}getDoorInfo(){if(this.mapSize!==1)return-1;let e=new z(new S(this.seed,98234234).useSubcontext(0).random.value),s=23;for(;s--;)e.value;return e.range(0,4)}}function W(a){switch(a){case 1:return 1.25;case 2:return 1.1;default:return 1}}const U=[3,5,6,9,12],Y=self;Y.onmessage=a=>{let e;switch(a.data.type){case"strict":e=Z;break;case"flex":e=K;break;default:throw new Error}const{allowedTables:s,startingDishes:r,mapSettings:t}=a.data.data,n=[...r],l=new _("");for(const i of t)l.addCard(i);for(;n.length;){const i=j(),F=new Q(i).getMapSize();if(!s.includes(F))continue;l.seed=i;const o=Math.floor(Math.random()*n.length);l.cards=[...t,n[o]],e(l)&&($({seed:i,mapSize:F,startingDish:n[o].Name}),n.splice(o,1))}};function $(a){J({type:"result",data:a})}function J(a){postMessage(a)}function Z(a){let e=[a.cards];for(let s=0;s<5;s++){const r=new Set;let t=[];for(const n of e){a.cards=n;debugger;const l=a.getUnlockOptions(U[s]);if(r.add(l[0].Name),r.add(l[1].Name),r.size>2)return!1;t.push([...n,l[0]]),t.push([...n,l[1]])}e=t}return!0}function K(a){let e=[a.cards];const s=new Set;for(let r=0;r<5;r++){let t=[];for(const n of e){a.cards=n;const l=a.getUnlockOptions(U[r]);if(s.add(l[0].Name),s.add(l[1].Name),s.size>10)return!1;t.push([...n,l[0]]),t.push([...n,l[1]])}e=t}return!0}})();
