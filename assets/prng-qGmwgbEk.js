var v=Object.defineProperty;var E=(e,s,a)=>s in e?v(e,s,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[s]=a;var m=(e,s,a)=>(E(e,typeof s!="symbol"?s+"":s,a),a);var o=(e=>(e[e.Generic=0]="Generic",e[e.Dish=1]="Dish",e[e.PrimaryTheme=3]="PrimaryTheme",e[e.SecondaryTheme=4]="SecondaryTheme",e[e.Franchise=5]="Franchise",e[e.Special=6]="Special",e))(o||{}),i=(e=>(e[e.Base=0]="Base",e[e.Main=1]="Main",e[e.Extra=2]="Extra",e[e.Side=3]="Side",e[e.Starter=4]="Starter",e[e.Dessert=5]="Dessert",e[e.Null=6]="Null",e))(i||{});const q=`373996608,Ice Cream,1,,,,-1533430406,False,False,5,1,2\r
...
-1653221873,Stir Fry,1,2087693779:1972879238,-452101383:-1573812073:380220741:-1201769154:314862254,True,False,0,1,10\r
`,N=q.trim().split(`\r
`).filter(e=>e).map(e=>{var R,I;const[s,a,l,r,n,F,t,h,d,p,g,f]=e.split(","),k=Number(s),y=Number(l),C=r!=null&&r.length?r.split(":").map(u=>Number(u)):[],D=n.length?n.split(":").map(u=>Number(u)):[],B=F!=null&&F.length?(R=F==null?void 0:F.split(":"))==null?void 0:R.map(u=>Number(u)):[],b=t!=null&&t.length?(I=t==null?void 0:t.split(":"))==null?void 0:I.map(u=>Number(u)):[],M=h==="True",S=d==="True",T=Number(p),c=Number(g),x=Number(f);return{ID:k,Name:a,UnlockGroup:y,Requires:C,BlockedBy:D,RequiredProcesses:B,IngredientProviders:b,isMain:M,isStarterOrSide:S,DishType:T,CustomerMultiplier:c,DishValue:x}});function z(e,s=!0){const a=s&&e.some(l=>l.Name==="Community");return N.filter(l=>{if(e.some(r=>r.ID===l.ID)||l.BlockedBy.some(r=>e.some(n=>n.ID===r))||l.Requires.some(r=>!e.some(n=>n.ID===r)))return!1;if(l.isStarterOrSide)if(e.some(r=>r.isMain)){if(e.length&&e[0].DishType===i.Dessert)debugger}else return!1;return!(!a&&l.DishType===i.Base)}).sort((l,r)=>l.ID-r.ID)}const V=[{ID:447437163,Name:"Country",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0},N.filter(e=>e.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0},{ID:1958825350,Name:"Turbo",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0}],G=[...V].sort((e,s)=>e.Name<s.Name?-1:1),L=["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>N.filter(s=>s.Name===e)[0]),W=O.trim().split(`\r
`).filter(e=>e).map(e=>{var S,T;const[s,a,l,r,n,F,t,h,d,p]=e.split(","),g=Number(s),f=Number(l),k=r!=null&&r.length?(S=r==null?void 0:r.split(":"))==null?void 0:S.map(c=>Number(c)):[],y=n!=null&&n.length?(T=n==null?void 0:n.split(":"))==null?void 0:T.map(c=>Number(c)):[],C=F==="True",D=t==="True",B=Number(h),b=Number(d),M=Number(p);return{ID:g,Name:a,UnlockGroup:f,Requires:[],BlockedBy:[],RequiredProcesses:k,IngredientProviders:y,isMain:C,isStarterOrSide:D,DishType:B,CustomerMultiplier:b,DishValue:M}}).sort((e,s)=>e.Name<s.Name?-1:1);class P{constructor(s,a){m(this,"fixedSeed");m(this,"instance");m(this,"random");typeof s=="string"&&(s=w(s)),this.fixedSeed=s,this.instance=a,this.random=new H(s+Math.imul(124192293,a))}useSubcontext(s){return new P(this.fixedSeed,124192293*s+this.instance)}}class H{constructor(s){m(this,"seed");const a=t=>Math.imul(1812433253,t)+1>>0,l=s>>0,r=a(l),n=a(r),F=a(n);this.seed=[l,r,n,F]}get value(){let s=this.seed.shift(),a=this.seed[2];return s^=s<<11,s^=s>>>8,a^=a>>>19,a=(a^s)>>0,this.seed.push(a),a}range(s,a){return(this.value>>>0)%(a-s)+s}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(s){return s[this.range(0,s.length)]}}function w(e){const a=new TextEncoder().encode(e);let l=5381,r=a.length;for(;r--;)l=(l<<5)+l+a[r];return l>>0}function J(e,s,a){return new P(a,e*1231231+s)}export{i as D,P as F,G as R,W as S,N as U,V as a,L as b,H as c,J as d,o as e,z as g};
