var v=Object.defineProperty;var A=(e,a,s)=>a in e?v(e,a,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[a]=s;var t=(e,a,s)=>(A(e,typeof a!="symbol"?a+"":a,s),s);import{u as B,g as D}from"./jsxRuntime.module-wfZfYPmn.js";const w=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
-1995745069,False,False,SyncModsViewHolder,False,False,,,0,0,0,False`,x=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing"],I=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean"],g=w.split(`\r
`).map(e=>{const a=e.split(",");let s={};for(let l=0;l<a.length;l++){let u;switch(I[l]){case"number":u=Number(a[l]);break;case"boolean":u=a[l]==="True";break;case"number[]":a[l]===""?u=[]:u=a[l].split(":").map(F=>Number(F));break;default:u=a[l]}s[x[l]]=u}return s});class N{constructor(a){t(this,"Staple");t(this,"Tags");t(this,"StapleWhenMissing");t(this,"Appliance");t(this,"IsRemoved");t(this,"Filter");t(this,"DecorationRequired");t(this,"SellAsUpgrade");this.Appliance=a,this.Tags=a.ShoppingTags,this.DecorationRequired=a.ThemeRequired,this.SellAsUpgrade=a.IsPurchasableAsUpgrade,this.Filter=a.ShopRequirementFilter,this.StapleWhenMissing=a.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(a){return a&1?this.Staple!==0:a&this.Tags?this.Staple===0:!1}}var f=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(f||{}),m=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(m||{});const k={DefaultShoppingTag:892};var R=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(R||{}),p=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(p||{});const O=38;function E(e,a){let s=e.length;for(;s-- >1;){let l=a.range(0,s+1);[e[s],e[l]]=[e[l],e[s]]}return e}class C{constructor(a,s){t(this,"fixedSeed");t(this,"instance");t(this,"random");typeof a=="string"&&(a=W(a)),this.fixedSeed=a,this.instance=s,this.random=new q(a+Math.imul(124192293,s))}useSubcontext(a){return new C(this.fixedSeed,124192293*a+this.instance)}}class q{constructor(a){t(this,"seed");const s=T=>Math.imul(1812433253,T)+1>>0,l=a>>0,u=s(l),F=s(u),h=s(F);this.seed=[l,u,F,h]}get value(){let a=this.seed.shift(),s=this.seed[2];return a^=a<<11,a^=a>>>8,s^=s>>>19,s=(s^a)>>0,this.seed.push(s),s}range(a,s){return(this.value>>>0)%(s-a)+a}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(a){return a[this.range(0,a.length)]}}function W(e){const s=new TextEncoder().encode(e);let l=5381,u=s.length;for(;u>0;){let F=--u;l=(l<<5)+l+s[F]}return l>>0}const U=g.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class _{constructor(a,s=0){t(this,"seed");t(this,"mapSize");t(this,"baseUpgradeChance");t(this,"OwnedAppliances");t(this,"Cards");this.seed=a,this.mapSize=1,this.baseUpgradeChance=s,this.OwnedAppliances=[],this.Cards=[]}addCard(a){a!==void 0&&(this.Cards.push(a),this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(s=>g.filter(l=>l.ID===s))))}getPrngAdvancements(a){let s=0;for(const l of a)s+=l.blueprintCount*(U-1+1),l.spawnInside||(s+=H(l.playerInside,this.mapSize)),s+=O;return s}buildShopOptions(a,s,l){let u=[];for(const h of g)if(!(!h.IsPurchasable&&!h.IsPurchasableAsUpgrade)){var F=new N(h);if(F.Staple==f.NonStaple||F.Staple==f.WhenMissing){if((F.Tags&m.Basic)>m.None)F.Staple=f.FixedStaple;else if(F.StapleWhenMissing){const r=F.Appliance.Name;r!="Research Desk"&&r!="Blueprint Cabinet"&&r!="Plates"&&console.log(`Unexpected ${F.Appliance.Name} StapleWhenMissing Appliance`),a.includes(F.Appliance)?F.Staple=f.NonStaple:F.Staple=f.WhenMissing}}const n=F.Appliance;if(n.SellOnlyAsDuplicate)a.includes(n)||(F.IsRemoved=!0);else if(n.RequiresForShop.length>0){let r=!1;for(const o of n.RequiresForShop)a.some(c=>c.ID===o)&&(r=!0);F.IsRemoved=!r}else n.SellOnlyAsUnique&&(n.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${n.Name}, ${n.ID}`),F.IsRemoved=!0);F.Filter==R.RefreshableProvider,F.DecorationRequired!=p.Null&&F.DecorationRequired!=s&&(F.IsRemoved=!0),n.RequiresProcessForShop.length>0&&(n.RequiresProcessForShop.some(r=>l.some(o=>o.RequiredProcesses.includes(r)))||(F.IsRemoved=!0)),u.push(F)}return u}initRandom(a){return new C(this.seed,823828*1231231+a)}getAppliances(a,s){const l=a.length===1,u=this.buildShopOptions(this.OwnedAppliances,p.Null,this.Cards),F=this.initRandom(s).random;let h=this.getPrngAdvancements(a.slice(0,a.length-1));for(;h--;)F.value;let T=a[a.length-1].blueprintCount,n;if(s%5==0){l&&(T=8),n=[];for(let r=0;r<T;r++)n[r]=m.Decoration}else if(a.length>1){n=[];for(let r=0;r<T;r++)n[r]=k.DefaultShoppingTag}else{const r=k.DefaultShoppingTag,o=Math.max(1,T),c=Math.max(0,Math.min(4,Math.max(2,4-Math.floor(s/5)),o)),b=Math.max(0,o-c);T=o,n=[];for(let i=0;i<c;i++)n[i]=m.Basic;for(let i=c;i<c+b;i++)n[i]=r}{const r=[...u],o=[],c=1-(1-Math.floor(s/5)*.1)*(1-this.baseUpgradeChance),b=[];for(let i=0;i<T;i++){const P=n[i],M=F.valueFloat<c;E(r,F);for(let S=0;S<r.length;S++){const d=r[S];if(!d.IsRemoved&&!b.includes(d.Appliance)&&!!d.MatchesRequestTags(P)&&!(!M&&d.Staple==f.NonStaple&&d.SellAsUpgrade)){P!=m.Decoration&&b.push(d.Appliance),o[i]=d.Appliance;break}}o[i]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${i}`)}return o}}}function H(e,a){let s=60;switch(a){case 1:s=60;break;case 2:s=70;break;case 3:s=9*13;break;case 4:s=16*12;break;default:console.log(`Unknown Map Size ${a}`),s=60;break}return e?s-2:s-1}function j({ghostCount:e=2,bps:a}){return B(D,{children:a.map((s,l)=>B("span",{class:l+e<a.length?"":"ghost",children:s+(l<a.length-1?", ":"")}))})}export{g as A,C as F,j as G,q as R,_ as S};
