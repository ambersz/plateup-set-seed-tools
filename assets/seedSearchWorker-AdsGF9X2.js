...
-373772933,Simple Cloth Table,5,,,,,False,False,6`,O=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0\r
1356267749,Salad,1,2087693779,1193867305:-712909563:380220741,True,False,0\r
550743424,Pizza,1,2087693779:-1706154991:-523839730,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0\r
367917843,Dumplings,1,1972879238:-523839730:2087693779,925796718:-484165118:-452101383:380220741,True,False,0\r
-1778969928,Burgers,1,1972879238,759552160:380220741:385684499,True,False,0\r
...
`;const B=y.split(`\r
`).filter(e=>e).map(e=>{var x,E;const[a,l,s,F,r,i,u,n,T,h]=e.split(","),o=Number(a),p=Number(s),S=F!=null&&F.length?F.split(":").map(C=>Number(C)):[],f=r.length?r.split(":").map(C=>Number(C)):[],d=i!=null&&i.length?(x=i==null?void 0:i.split(":"))==null?void 0:x.map(C=>Number(C)):[],m=u!=null&&u.length?(E=u==null?void 0:u.split(":"))==null?void 0:E.map(C=>Number(C)):[],k=n==="True",P=T==="True",ae=Number(h);return{ID:o,Name:l,UnlockGroup:p,Requires:S,BlockedBy:f,RequiredProcesses:d,IngredientProviders:m,isMain:k,isStarterOrSide:P,DishType:ae}});function b(e,a=!0){const l=a&&e.some(s=>s.Name==="Community");return B.filter(s=>{if(e.some(F=>F.ID===s.ID)||s.BlockedBy.some(F=>e.some(r=>r.ID===F))||s.Requires.some(F=>!e.some(r=>r.ID===F)))return!1;if(s.isStarterOrSide)if(e.some(F=>F.isMain)){if(e.length&&e[0].DishType===c.Dessert)debugger}else return!1;return!(!l&&s.DishType===c.Base)}).sort((s,F)=>s.ID-F.ID)}[...[{ID:447437163,Name:"Country",UnlockGroup:t.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null},{ID:2002876295,Name:"City",UnlockGroup:t.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null},{ID:-1864906012,Name:"Alpine",UnlockGroup:t.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null},B.filter(e=>e.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:t.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null},{ID:1958825350,Name:"Turbo",UnlockGroup:t.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:c.Null}]].sort((e,a)=>e.Name<a.Name?-1:1),["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>B.filter(a=>a.Name===e)[0]),O.split(`\r
`).filter(e=>e).map(e=>{var m,k;const[a,l,s,F,r,i,u,n]=e.split(","),T=Number(a),h=Number(s),o=F!=null&&F.length?(m=F==null?void 0:F.split(":"))==null?void 0:m.map(P=>Number(P)):[],p=r!=null&&r.length?(k=r==null?void 0:r.split(":"))==null?void 0:k.map(P=>Number(P)):[],S=i==="True",f=u==="True",d=Number(n);return{ID:T,Name:l,UnlockGroup:h,Requires:[],BlockedBy:[],RequiredProcesses:o,IngredientProviders:p,isMain:S,isStarterOrSide:f,DishType:d}}).sort((e,a)=>e.Name<a.Name?-1:1);class D{constructor(a,l){g(this,"fixedSeed");g(this,"instance");g(this,"random");typeof a=="string"&&(a=H(a)),this.fixedSeed=a,this.instance=l,this.random=new A(a+Math.imul(124192293,l))}useSubcontext(a){return new D(this.fixedSeed,124192293*a+this.instance)}}class A{constructor(a){g(this,"seed");const l=u=>Math.imul(1812433253,u)+1>>0,s=a>>0,F=l(s),r=l(F),i=l(r);this.seed=[s,F,r,i]}get value(){let a=this.seed.shift(),l=this.seed[2];return a^=a<<11,a^=a>>>8,l^=l>>>19,l=(l^a)>>0,this.seed.push(l),l}range(a,l){return(this.value>>>0)%(l-a)+a}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(a){return a[this.range(0,a.length)]}}function H(e){const l=new TextEncoder().encode(e);let s=5381,F=l.length;for(;F>0;){let r=--F;s=(s<<5)+s+l[r]}return s>>0}class N{constructor(){g(this,"encourageGroups",[t.Special])}GetOptions(a,l,s){const F=s.random;let r=0;for(l!==15&&(r=this.getPad(a,l));r--;)F.value;let i=this.sortCandidates(a,l,s.random);const[u,n]=this.getUnlockGroups(l);let T=null,h=null;for(const o of i)if(!(o.UnlockGroup!==u&&o.UnlockGroup!==n)&&(T===null||T.UnlockGroup!==u&&o.UnlockGroup===u?T=o:(h===null||h.UnlockGroup!==n&&o.UnlockGroup===n)&&(h=o),T&&T.UnlockGroup===u&&h&&h.UnlockGroup===n))break;return[T,h]}getPad(a,l){if(l===15)return 0;let s=b(a).length+1;return l===5&&(s*=2),s}sortCandidates(a,l,s){let F=b(a),r=R(F,s);return s.valueFloat<.5&&r.sort((u,n)=>{let T=0;return M(u)&&T--,M(n)&&T++,T}),r}getUnlockGroups(a){return a===15?[t.Franchise,t.Franchise]:a===5?[t.PrimaryTheme,t.PrimaryTheme]:[t.Dish,t.Generic]}}class U extends N{getPad(a,l){let s=b(a,!1).length+1;return l!==5&&(s*=2),s}sortCandidates(a,l,s){let F=b(a),r=R(F,s);return s.valueFloat<.1&&r.sort((n,T)=>{let h=0;return n.Requires.length&&h--,T.Requires.length&&h++,h}),r}}class L extends N{constructor(){super(...arguments);g(this,"ThanksgivingCards",["Turkey","Nut Roast"])}getPad(l,s){if(s===15)return 0;let F=b(l,!1).length+1;if(s===5){let r=b(l);F+=r.length+2}return F}sortCandidates(l,s,F){let r=s===5||s===15?b(l,!1):b(l),i=R(r,F);return F.valueFloat<.5&&i.sort((T,h)=>{let o=0;return M(T,!1)&&o--,M(h,!1)&&o++,o}),s!==5&&s!==15&&F.valueFloat<.25&&i.sort((h,o)=>{let p=0;return this.ThanksgivingCards.includes(h.Name)&&p++,this.ThanksgivingCards.includes(o.Name)&&p--,p}),i}getUnlockGroups(l){return l===15?[t.Franchise,t.Franchise]:l===5?[t.PrimaryTheme,t.PrimaryTheme]:[t.Dish,t.Dish]}}function R(e,a){return e.map(s=>[s,a.valueFloat]).sort((s,F)=>s[1]-F[1]).map(s=>s[0])}class z{constructor(a){g(this,"cards");g(this,"unlockPack");g(this,"seed");this.cards=[],this.unlockPack=new N,this.seed=a}addCard(a){if(a!==void 0){switch(a.Name){case"Community":this.unlockPack=new L;break;case"Turbo":this.unlockPack=new U;break}this.cards.push(a)}}getUnlockOptions(a){const s=q(848292,a,this.seed).useSubcontext(1);return this.unlockPack.GetOptions(this.cards,a,s)}getCustomers(a,l=1){return[]}getGroupSizeRange(a){if(this.cards.some(r=>r.Name==="Community")){const r=Math.floor((a-1)/3);return[r+1,r+2]}let s=1,F=2;return this.cards.some(r=>r.Name==="Individual Dining")?[1,1]:(this.cards.some(r=>r.Name==="Medium Groups")&&(s++,F+=2),this.cards.some(r=>r.Name==="Large Groups")&&(s+=2,F+=4),this.cards.some(r=>r.Name==="Flexible Groups")&&(s--,F++),[s,F])}}function q(e,a,l){return new D(l,e*1231231+a)}function M(e,a=!0){return e.UnlockGroup===t.Special||e.DishType===c.Main||e.DishType===c.Extra?!0:a?!!e.Requires.length:!1}class W{constructor(a){g(this,"seed");g(this,"mapSize");this.seed=a,this.mapSize=this.getMapSize()}getMapSize(){const l=new D(this.seed,5078598).useSubcontext(0).random.range(0,4);let s;switch(l){case 0:s=2;break;case 1:s=1;break;case 2:s=3;break;case 3:s=4;break;default:throw new Error}return s}}var _=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
