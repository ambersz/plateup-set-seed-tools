...
`,E=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0\r
1356267749,Salad,1,2087693779,1193867305:-712909563:380220741,True,False,0\r
550743424,Pizza,1,2087693779:-1706154991:-523839730,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0\r
367917843,Dumplings,1,1972879238:-523839730:2087693779,925796718:-484165118:-452101383:380220741,True,False,0\r
-1778969928,Burgers,1,1972879238,759552160:380220741:385684499,True,False,0\r
...
`).filter(e=>e).map(e=>{var G,I;const[s,a,r,n,l,t,o,d,F,c]=e.split(","),h=Number(s),g=Number(r),B=n!=null&&n.length?n.split(":").map(S=>Number(S)):[],M=l.length?l.split(":").map(S=>Number(S)):[],v=t!=null&&t.length?(G=t==null?void 0:t.split(":"))==null?void 0:G.map(S=>Number(S)):[],C=o!=null&&o.length?(I=o==null?void 0:o.split(":"))==null?void 0:I.map(S=>Number(S)):[],P=d==="True",T=F==="True",j=Number(c);return{ID:h,Name:a,UnlockGroup:g,Requires:B,BlockedBy:M,RequiredProcesses:v,IngredientProviders:C,isMain:P,isStarterOrSide:T,DishType:j}});function m(e,s=!0){const a=s&&e.some(r=>r.Name==="Community");return b.filter(r=>{if(e.some(n=>n.ID===r.ID)||r.BlockedBy.some(n=>e.some(l=>l.ID===n))||r.Requires.some(n=>!e.some(l=>l.ID===n)))return!1;if(r.isStarterOrSide)if(e.some(n=>n.isMain)){if(e.length&&e[0].DishType===u.Dessert)debugger}else return!1;return!(!a&&r.DishType===u.Base)}).sort((r,n)=>r.ID-n.ID)}[...[{ID:447437163,Name:"Country",UnlockGroup:i.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:u.Null},{ID:2002876295,Name:"City",UnlockGroup:i.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:u.Null},{ID:-1864906012,Name:"Alpine",UnlockGroup:i.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:u.Null},b.filter(e=>e.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:i.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:u.Null},{ID:1958825350,Name:"Turbo",UnlockGroup:i.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:u.Null}]].sort((e,s)=>e.Name<s.Name?-1:1),["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>b.filter(s=>s.Name===e)[0]),E.trim().split(`\r
`).filter(e=>e).map(e=>{var C,P;const[s,a,r,n,l,t,o,d]=e.split(","),F=Number(s),c=Number(r),h=n!=null&&n.length?(C=n==null?void 0:n.split(":"))==null?void 0:C.map(T=>Number(T)):[],g=l!=null&&l.length?(P=l==null?void 0:l.split(":"))==null?void 0:P.map(T=>Number(T)):[],B=t==="True",M=o==="True",v=Number(d);return{ID:F,Name:a,UnlockGroup:c,Requires:[],BlockedBy:[],RequiredProcesses:h,IngredientProviders:g,isMain:B,isStarterOrSide:M,DishType:v}}).sort((e,s)=>e.Name<s.Name?-1:1);class k{constructor(s,a){f(this,"fixedSeed");f(this,"instance");f(this,"random");typeof s=="string"&&(s=z(s)),this.fixedSeed=s,this.instance=a,this.random=new R(s+Math.imul(124192293,a))}useSubcontext(s){return new k(this.fixedSeed,124192293*s+this.instance)}}class R{constructor(s){f(this,"seed");const a=o=>Math.imul(1812433253,o)+1>>0,r=s>>0,n=a(r),l=a(n),t=a(l);this.seed=[r,n,l,t]}get value(){let s=this.seed.shift(),a=this.seed[2];return s^=s<<11,s^=s>>>8,a^=a>>>19,a=(a^s)>>0,this.seed.push(a),a}range(s,a){return(this.value>>>0)%(a-s)+s}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(s){return s[this.range(0,s.length)]}}function z(e){const a=new TextEncoder().encode(e);let r=5381,n=a.length;for(;n>0;){let l=--n;r=(r<<5)+r+a[l]}return r>>0}class D{constructor(){f(this,"encourageGroups",[i.Special])}GetOptions(s,a,r){const n=r.random;let l=0;for(a!==15&&(l=this.getPad(s,a));l--;)n.value;let t=this.sortCandidates(s,a,r.random);const[o,d]=this.getUnlockGroups(a);let F=null,c=null;for(const h of t)if(!(h.UnlockGroup!==o&&h.UnlockGroup!==d)&&(F===null||F.UnlockGroup!==o&&h.UnlockGroup===o?F=h:(c===null||c.UnlockGroup!==d&&h.UnlockGroup===d)&&(c=h),F&&F.UnlockGroup===o&&c&&c.UnlockGroup===d))break;return[F,c]}getPad(s,a){if(a===15)return 0;let r=m(s).length+1;return a===5&&(r*=2),r}sortCandidates(s,a,r){let n=m(s),l=N(n,r);return r.valueFloat<.5&&l.sort((o,d)=>{let F=0;return y(o)&&F--,y(d)&&F++,F}),l}getUnlockGroups(s){return s===15?[i.Franchise,i.Franchise]:s===5?[i.PrimaryTheme,i.PrimaryTheme]:[i.Dish,i.Generic]}}class U extends D{getPad(s,a){let r=m(s,!1).length+1;return a!==5&&(r*=2),r}sortCandidates(s,a,r){let n=m(s),l=N(n,r);return r.valueFloat<.1&&l.sort((d,F)=>{let c=0;return d.Requires.length&&c--,F.Requires.length&&c++,c}),l}}class q extends D{constructor(){super(...arguments);f(this,"ThanksgivingCards",["Turkey","Nut Roast"])}getPad(a,r){if(r===15)return 0;let n=m(a,!1).length+1;if(r===5){let l=m(a);n+=l.length+2}return n}sortCandidates(a,r,n){let l=r===5||r===15?m(a,!1):m(a),t=N(l,n);return n.valueFloat<.5&&t.sort((F,c)=>{let h=0;return y(F,!1)&&h--,y(c,!1)&&h++,h}),r!==5&&r!==15&&n.valueFloat<.25&&t.sort((c,h)=>{let g=0;return this.ThanksgivingCards.includes(c.Name)&&g++,this.ThanksgivingCards.includes(h.Name)&&g--,g}),t}getUnlockGroups(a){return a===15?[i.Franchise,i.Franchise]:a===5?[i.PrimaryTheme,i.PrimaryTheme]:[i.Dish,i.Dish]}}function N(e,s){return e.map(r=>[r,s.valueFloat]).sort((r,n)=>r[1]-n[1]).map(r=>r[0])}class O{constructor(s){f(this,"cards");f(this,"unlockPack");f(this,"seed");this.cards=[],this.unlockPack=new D,this.seed=s}addCard(s){if(s!==void 0){switch(s.Name){case"Community":this.unlockPack=new q;break;case"Turbo":this.unlockPack=new U;break}this.cards.push(s)}}getUnlockOptions(s){const r=A(848292,s,this.seed).useSubcontext(1);return this.unlockPack.GetOptions(this.cards,s,r)}getCustomers(s,a=1){return[]}getGroupSizeRange(s){if(this.cards.some(l=>l.Name==="Community")){const l=Math.floor((s-1)/3);return[l+1,l+2]}let r=1,n=2;return this.cards.some(l=>l.Name==="Individual Dining")?[1,1]:(this.cards.some(l=>l.Name==="Medium Groups")&&(r++,n+=2),this.cards.some(l=>l.Name==="Large Groups")&&(r+=2,n+=4),this.cards.some(l=>l.Name==="Flexible Groups")&&(r--,n++),[r,n])}}function A(e,s,a){return new k(a,e*1231231+s)}function y(e,s=!0){return e.UnlockGroup===i.Special||e.DishType===u.Main||e.DishType===u.Extra?!0:s?!!e.Requires.length:!1}const w="bdghjmqrtvwxy346789";function H(){let e="";for(;e.length<8;)e+=w[Math.floor(Math.random()*w.length)];return e}class L{constructor(s){f(this,"seed");f(this,"mapSize");f(this,"frontDoor");this.seed=s,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo()}getMapSize(){const a=new k(this.seed,5078598).useSubcontext(0).random.range(0,4);let r;switch(a){case 0:r=2;break;case 1:r=1;break;case 2:r=3;break;case 3:r=4;break;default:throw new Error}return r}getDoorInfo(){if(this.mapSize!==1)return-1;let s=new R(new k(this.seed,98234234).useSubcontext(0).random.value),a=23;for(;a--;)s.value;return s.range(0,4)}}const x=[3,5,6,9,12],V=self;V.onmessage=e=>{let s;switch(e.data.type){case"strict":s=W;break;case"flex":s=Y;break;default:throw new Error}const{allowedTables:a,startingDishes:r,mapSettings:n}=e.data.data,l=[...r],t=new O("");for(const o of n)t.addCard(o);for(;l.length;){const o=H(),d=new L(o).getMapSize();if(!a.includes(d))continue;t.seed=o;const F=Math.floor(Math.random()*l.length);t.cards=[...n,l[F]],s(t)&&(_({seed:o,mapSize:d,startingDish:l[F].Name}),l.splice(F,1))}};function _(e){Q({type:"result",data:e})}function Q(e){postMessage(e)}function W(e){let s=[e.cards];for(let a=0;a<5;a++){const r=new Set;let n=[];for(const l of s){e.cards=l;debugger;const t=e.getUnlockOptions(x[a]);if(r.add(t[0].Name),r.add(t[1].Name),r.size>2)return!1;n.push([...l,t[0]]),n.push([...l,t[1]])}s=n}return!0}function Y(e){let s=[e.cards];const a=new Set;for(let r=0;r<5;r++){let n=[];for(const l of s){e.cards=l;const t=e.getUnlockOptions(x[r]);if(a.add(t[0].Name),a.add(t[1].Name),a.size>10)return!1;n.push([...l,t[0]]),n.push([...l,t[1]])}s=n}return!0}})();
