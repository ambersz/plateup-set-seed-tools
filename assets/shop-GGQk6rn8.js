var v=Object.defineProperty;var M=(e,a,r)=>a in e?v(e,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[a]=r;var i=(e,a,r)=>(M(e,typeof a!="symbol"?a+"":a,r),r);import{F as P}from"./prng-1rWzft78.js";import{a as A}from"./unlocks-fGSP_DLg.js";const I=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
-26827118,False,False,Upgrade Kit,False,False,,,0,0,0,False`,D=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing"],N=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean"],g=I.split(`\r
`).map(e=>{const a=e.split(",");let r={};for(let l=0;l<a.length;l++){let n;switch(N[l]){case"number":n=Number(a[l]);break;case"boolean":n=a[l]==="True";break;case"number[]":a[l]===""?n=[]:n=a[l].split(":").map(s=>Number(s));break;default:n=a[l]}r[D[l]]=n}return r});class w{constructor(a){i(this,"Staple");i(this,"Tags");i(this,"StapleWhenMissing");i(this,"Appliance");i(this,"IsRemoved");i(this,"Filter");i(this,"DecorationRequired");i(this,"SellAsUpgrade");this.Appliance=a,this.Tags=a.ShoppingTags,this.DecorationRequired=a.ThemeRequired,this.SellAsUpgrade=a.IsPurchasableAsUpgrade,this.Filter=a.ShopRequirementFilter,this.StapleWhenMissing=a.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(a){return a&1?this.Staple!==0:a&this.Tags?this.Staple===0:!1}}var d=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(d||{}),m=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(m||{});const R={DefaultShoppingTag:892};var k=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(k||{}),S=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(S||{});const E="38",x=Number(E);function O(e,a){let r=e.length;for(;r-- >1;){let l=a.range(0,r+1);[e[r],e[l]]=[e[l],e[r]]}return e}const Y="bdghjmqrtvwxy346789",q=g.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class V{constructor(a,r=0){i(this,"seed");i(this,"mapSize");i(this,"numTiles");i(this,"baseUpgradeChance");i(this,"OwnedAppliances");i(this,"Cards");i(this,"Theme");this.seed=a,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=r,this.OwnedAppliances=[],this.Cards=[],this.Theme=S.Null}getLayoutInfo(){const r=new P(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,n;switch(r){case 0:n=70,l=2;break;case 4:n=84,l=2;break;case 1:case 5:n=60,l=1;break;case 2:case 6:n=9*13,l=3;break;case 3:case 7:n=12*16,l=4;break;default:throw new Error}return[l,n]}handleNewCardSpawnEffects(a){a!==void 0&&a.UnlockGroup===A.PrimaryTheme&&(this.Theme=S[a.Name])}handleNewCardRerollEffects(a){a!==void 0&&(this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(r=>g.filter(l=>l.ID===r))))}addCard(a){a!==void 0&&(this.handleNewCardSpawnEffects(a),this.handleNewCardRerollEffects(a),this.Cards.push(a))}getPrngAdvancements(a,r){let l=0;for(let n=0;n<a.length;n++){const s=a[n];let T=s.blueprintCount;r%5===0&&(T+=3,n===0&&(T+=2)),l+=T*(q-1+1),s.spawnInside||(l+=U(s.playerInside,this.numTiles)),l+=x}return l}buildShopOptions(a,r,l){let n=[];for(const T of g)if(!(!T.IsPurchasable&&!T.IsPurchasableAsUpgrade)){var s=new w(T);if(s.Staple==d.NonStaple||s.Staple==d.WhenMissing){if((s.Tags&m.Basic)>m.None)s.Staple=d.FixedStaple;else if(s.StapleWhenMissing){const F=s.Appliance.Name;F!="Research Desk"&&F!="Blueprint Cabinet"&&F!="Plates"&&console.log(`Unexpected ${s.Appliance.Name} StapleWhenMissing Appliance`),a.some(o=>o.ID===s.Appliance.ID)?s.Staple=d.NonStaple:s.Staple=d.WhenMissing}}const u=s.Appliance;if(u.SellOnlyAsDuplicate)a.some(F=>F.ID===u.ID)||(s.IsRemoved=!0);else if(u.RequiresForShop.length>0){let F=!1;for(const o of u.RequiresForShop)a.some(h=>h.ID===o)&&(F=!0);s.IsRemoved=!F}else u.SellOnlyAsUnique&&(u.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${u.Name}, ${u.ID}`),a.some(F=>F.ID===u.ID)&&(s.IsRemoved=!0));(s.Appliance.Name==="Sink"||s.Appliance.Name==="Plates")&&l.every(F=>!F.isMain)&&(s.IsRemoved=!0),s.Filter==k.RefreshableProvider&&(s.IsRemoved=!1),s.DecorationRequired!=S.Null&&s.DecorationRequired!=r&&(s.IsRemoved=!0),u.RequiresProcessForShop.length>0&&(u.RequiresProcessForShop.some(F=>l.some(o=>o.RequiredProcesses.includes(F)))||(s.IsRemoved=!0)),n.push(s)}return n}initRandom(a){return new P(this.seed,823828*1231231+a)}getAppliances(a,r){const l=a.length===1,n=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards),s=this.initRandom(r).random;let T=this.getPrngAdvancements(a.slice(0,a.length-1),r);for(;T--;)s.value;let c=a[a.length-1].blueprintCount,u;if(r%5==0){l?c=10:c+=3,u=[];for(let F=0;F<c;F++)u[F]=m.Decoration;if(l)for(const F of[1,2])u[u.length-F]=m.SpecialEvent}else if(a.length>1){u=[];for(let F=0;F<c;F++)u[F]=R.DefaultShoppingTag}else{const F=R.DefaultShoppingTag,o=Math.max(1,c),h=Math.max(0,Math.min(n.filter(t=>t.Staple!==d.NonStaple&&!t.IsRemoved).length,Math.max(2,4-Math.floor(r/5)),o)),b=Math.max(0,o-h);c=o,u=[];for(let t=0;t<h;t++)u[t]=m.Basic;for(let t=h;t<h+b;t++)u[t]=F}{const F=[...n],o=[],h=1-(1-Math.floor(r/5)*.1)*(1-this.baseUpgradeChance),b=[];for(let t=0;t<c;t++){const C=u[t],B=s.valueFloat<h;O(F,s);for(let p=0;p<F.length;p++){const f=F[p];if(!f.IsRemoved&&!b.includes(f.Appliance)&&!!f.MatchesRequestTags(C)&&!(!B&&f.Staple==d.NonStaple&&f.SellAsUpgrade)){C!=m.Decoration&&b.push(f.Appliance),o[t]=f.Appliance;break}}o[t]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${t}`)}return o}}}function U(e,a){return e?a-2:a-1}export{g as A,Y as I,V as S};
