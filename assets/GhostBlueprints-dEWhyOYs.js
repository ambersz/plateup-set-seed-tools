var A=Object.defineProperty;var v=(e,a,F)=>a in e?A(e,a,{enumerable:!0,configurable:!0,writable:!0,value:F}):e[a]=F;var t=(e,a,F)=>(v(e,typeof a!="symbol"?a+"":a,F),F);import{F as P}from"./prng-1rWzft78.js";import{a as I}from"./unlocks-8mfgXCLy.js";import{u as B,g as D}from"./jsxRuntime.module-cxiL4QXa.js";const N=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
-26827118,False,False,Upgrade Kit,False,False,,,0,0,0,False`,w=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing"],x=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean"],g=N.split(`\r
`).map(e=>{const a=e.split(",");let F={};for(let s=0;s<a.length;s++){let n;switch(x[s]){case"number":n=Number(a[s]);break;case"boolean":n=a[s]==="True";break;case"number[]":a[s]===""?n=[]:n=a[s].split(":").map(l=>Number(l));break;default:n=a[s]}F[w[s]]=n}return F});class O{constructor(a){t(this,"Staple");t(this,"Tags");t(this,"StapleWhenMissing");t(this,"Appliance");t(this,"IsRemoved");t(this,"Filter");t(this,"DecorationRequired");t(this,"SellAsUpgrade");this.Appliance=a,this.Tags=a.ShoppingTags,this.DecorationRequired=a.ThemeRequired,this.SellAsUpgrade=a.IsPurchasableAsUpgrade,this.Filter=a.ShopRequirementFilter,this.StapleWhenMissing=a.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(a){return a&1?this.Staple!==0:a&this.Tags?this.Staple===0:!1}}var m=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(m||{}),f=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(f||{});const k={DefaultShoppingTag:892};var R=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(R||{}),S=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(S||{});const E="38",q=Number(E);function U(e,a){let F=e.length;for(;F-- >1;){let s=a.range(0,F+1);[e[F],e[s]]=[e[s],e[F]]}return e}const J="bdghjmqrtvwxy346789",W=g.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class Q{constructor(a,F=0){t(this,"seed");t(this,"mapSize");t(this,"numTiles");t(this,"baseUpgradeChance");t(this,"OwnedAppliances");t(this,"Cards");t(this,"Theme");this.seed=a,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=F,this.OwnedAppliances=[],this.Cards=[],this.Theme=S.Null}getLayoutInfo(){const F=new P(this.seed,5078598).useSubcontext(0).random.range(0,8);let s,n;switch(F){case 0:n=70,s=2;break;case 4:n=84,s=2;break;case 1:case 5:n=60,s=1;break;case 2:case 6:n=9*13,s=3;break;case 3:case 7:n=12*16,s=4;break;default:throw new Error}return[s,n]}addCard(a){a!==void 0&&(this.Cards.push(a),this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(F=>g.filter(s=>s.ID===F))),a.UnlockGroup===I.PrimaryTheme&&(this.Theme=S[a.Name]))}getPrngAdvancements(a,F){let s=0;for(let n=0;n<a.length;n++){const l=a[n];let T=l.blueprintCount;F%5===0&&(T+=3),s+=T*(W-1+1),l.spawnInside||(s+=L(l.playerInside,this.numTiles)),s+=q}return s}buildShopOptions(a,F,s){let n=[];for(const T of g)if(!(!T.IsPurchasable&&!T.IsPurchasableAsUpgrade)){var l=new O(T);if(l.Staple==m.NonStaple||l.Staple==m.WhenMissing){if((l.Tags&f.Basic)>f.None)l.Staple=m.FixedStaple;else if(l.StapleWhenMissing){const r=l.Appliance.Name;r!="Research Desk"&&r!="Blueprint Cabinet"&&r!="Plates"&&console.log(`Unexpected ${l.Appliance.Name} StapleWhenMissing Appliance`),a.includes(l.Appliance)?l.Staple=m.NonStaple:l.Staple=m.WhenMissing}}const u=l.Appliance;if(u.SellOnlyAsDuplicate)a.includes(u)||(l.IsRemoved=!0);else if(u.RequiresForShop.length>0){let r=!1;for(const o of u.RequiresForShop)a.some(h=>h.ID===o)&&(r=!0);l.IsRemoved=!r}else u.SellOnlyAsUnique&&(u.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${u.Name}, ${u.ID}`),l.IsRemoved=!0);(l.Appliance.Name==="Sink"||l.Appliance.Name==="Plates")&&s.every(r=>!r.isMain)&&(l.IsRemoved=!0),l.Filter==R.RefreshableProvider&&(l.IsRemoved=!0),l.DecorationRequired!=S.Null&&l.DecorationRequired!=F&&(l.IsRemoved=!0),u.RequiresProcessForShop.length>0&&(u.RequiresProcessForShop.some(r=>s.some(o=>o.RequiredProcesses.includes(r)))||(l.IsRemoved=!0)),n.push(l)}return n}initRandom(a){return new P(this.seed,823828*1231231+a)}getAppliances(a,F){const s=a.length===1,n=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards),l=this.initRandom(F).random;let T=this.getPrngAdvancements(a.slice(0,a.length-1),F);for(;T--;)l.value;let c=a[a.length-1].blueprintCount,u;if(F%5==0){s?c=8:c+=3,u=[];for(let r=0;r<c;r++)u[r]=f.Decoration}else if(a.length>1){u=[];for(let r=0;r<c;r++)u[r]=k.DefaultShoppingTag}else{const r=k.DefaultShoppingTag,o=Math.max(1,c),h=Math.max(0,Math.min(4,Math.max(2,4-Math.floor(F/5)),o)),b=Math.max(0,o-h);c=o,u=[];for(let i=0;i<h;i++)u[i]=f.Basic;for(let i=h;i<h+b;i++)u[i]=r}{const r=[...n],o=[],h=1-(1-Math.floor(F/5)*.1)*(1-this.baseUpgradeChance),b=[];for(let i=0;i<c;i++){const C=u[i],M=l.valueFloat<h;U(r,l);for(let p=0;p<r.length;p++){const d=r[p];if(!d.IsRemoved&&!b.includes(d.Appliance)&&!!d.MatchesRequestTags(C)&&!(!M&&d.Staple==m.NonStaple&&d.SellAsUpgrade)){C!=f.Decoration&&b.push(d.Appliance),o[i]=d.Appliance;break}}o[i]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${i}`)}return o}}}function L(e,a){return e?a-2:a-1}function X({ghostCount:e=2,bps:a}){return B(D,{children:a.map((F,s)=>B("span",{class:s+e<a.length?"":"ghost",children:F+(s<a.length-1?", ":"")}))})}export{g as A,X as G,J as I,Q as S};
