var A=Object.defineProperty;var v=(e,a,s)=>a in e?A(e,a,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[a]=s;var t=(e,a,s)=>(v(e,typeof a!="symbol"?a+"":a,s),s);import{F as P}from"./prng-1rWzft78.js";import{u as B,g as D}from"./jsxRuntime.module-wfZfYPmn.js";const I=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
`).map(e=>{const a=e.split(",");let s={};for(let l=0;l<a.length;l++){let u;switch(N[l]){case"number":u=Number(a[l]);break;case"boolean":u=a[l]==="True";break;case"number[]":a[l]===""?u=[]:u=a[l].split(":").map(F=>Number(F));break;default:u=a[l]}s[w[l]]=u}return s});class x{constructor(a){t(this,"Staple");t(this,"Tags");t(this,"StapleWhenMissing");t(this,"Appliance");t(this,"IsRemoved");t(this,"Filter");t(this,"DecorationRequired");t(this,"SellAsUpgrade");this.Appliance=a,this.Tags=a.ShoppingTags,this.DecorationRequired=a.ThemeRequired,this.SellAsUpgrade=a.IsPurchasableAsUpgrade,this.Filter=a.ShopRequirementFilter,this.StapleWhenMissing=a.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(a){return a&1?this.Staple!==0:a&this.Tags?this.Staple===0:!1}}var d=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(d||{}),f=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(f||{});const k={DefaultShoppingTag:892};var R=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(R||{}),p=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(p||{});const O="38",E=Number(O);function q(e,a){let s=e.length;for(;s-- >1;){let l=a.range(0,s+1);[e[s],e[l]]=[e[l],e[s]]}return e}const V="bdghjmqrtvwxy346789",W=g.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class j{constructor(a,s=0){t(this,"seed");t(this,"mapSize");t(this,"numTiles");t(this,"baseUpgradeChance");t(this,"OwnedAppliances");t(this,"Cards");this.seed=a,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=s,this.OwnedAppliances=[],this.Cards=[]}getLayoutInfo(){const s=new P(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,u;switch(s){case 0:u=70,l=2;break;case 4:u=84,l=2;break;case 1:case 5:u=60,l=1;break;case 2:case 6:u=9*13,l=3;break;case 3:case 7:u=12*16,l=4;break;default:throw new Error}return[l,u]}addCard(a){a!==void 0&&(this.Cards.push(a),this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(s=>g.filter(l=>l.ID===s))))}getPrngAdvancements(a){let s=0;for(const l of a)s+=l.blueprintCount*(W-1+1),l.spawnInside||(s+=L(l.playerInside,this.numTiles)),s+=E;return s}buildShopOptions(a,s,l){let u=[];for(const m of g)if(!(!m.IsPurchasable&&!m.IsPurchasableAsUpgrade)){var F=new x(m);if(F.Staple==d.NonStaple||F.Staple==d.WhenMissing){if((F.Tags&f.Basic)>f.None)F.Staple=d.FixedStaple;else if(F.StapleWhenMissing){const r=F.Appliance.Name;r!="Research Desk"&&r!="Blueprint Cabinet"&&r!="Plates"&&console.log(`Unexpected ${F.Appliance.Name} StapleWhenMissing Appliance`),a.includes(F.Appliance)?F.Staple=d.NonStaple:F.Staple=d.WhenMissing}}const n=F.Appliance;if(n.SellOnlyAsDuplicate)a.includes(n)||(F.IsRemoved=!0);else if(n.RequiresForShop.length>0){let r=!1;for(const o of n.RequiresForShop)a.some(T=>T.ID===o)&&(r=!0);F.IsRemoved=!r}else n.SellOnlyAsUnique&&(n.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${n.Name}, ${n.ID}`),F.IsRemoved=!0);F.Filter==R.RefreshableProvider&&(F.IsRemoved=!0),F.DecorationRequired!=p.Null&&F.DecorationRequired!=s&&(F.IsRemoved=!0),n.RequiresProcessForShop.length>0&&(n.RequiresProcessForShop.some(r=>l.some(o=>o.RequiredProcesses.includes(r)))||(F.IsRemoved=!0)),u.push(F)}return u}initRandom(a){return new P(this.seed,823828*1231231+a)}getAppliances(a,s){const l=a.length===1,u=this.buildShopOptions(this.OwnedAppliances,p.Null,this.Cards),F=this.initRandom(s).random;let m=this.getPrngAdvancements(a.slice(0,a.length-1));for(;m--;)F.value;let c=a[a.length-1].blueprintCount,n;if(s%5==0){l&&(c=8),n=[];for(let r=0;r<c;r++)n[r]=f.Decoration}else if(a.length>1){n=[];for(let r=0;r<c;r++)n[r]=k.DefaultShoppingTag}else{const r=k.DefaultShoppingTag,o=Math.max(1,c),T=Math.max(0,Math.min(4,Math.max(2,4-Math.floor(s/5)),o)),b=Math.max(0,o-T);c=o,n=[];for(let i=0;i<T;i++)n[i]=f.Basic;for(let i=T;i<T+b;i++)n[i]=r}{const r=[...u],o=[],T=1-(1-Math.floor(s/5)*.1)*(1-this.baseUpgradeChance),b=[];for(let i=0;i<c;i++){const C=n[i],M=F.valueFloat<T;q(r,F);for(let S=0;S<r.length;S++){const h=r[S];if(!h.IsRemoved&&!b.includes(h.Appliance)&&!!h.MatchesRequestTags(C)&&!(!M&&h.Staple==d.NonStaple&&h.SellAsUpgrade)){C!=f.Decoration&&b.push(h.Appliance),o[i]=h.Appliance;break}}o[i]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${i}`)}return o}}}function L(e,a){return e?a-2:a-1}function J({ghostCount:e=2,bps:a}){return B(D,{children:a.map((s,l)=>B("span",{class:l+e<a.length?"":"ghost",children:s+(l<a.length-1?", ":"")}))})}export{g as A,J as G,V as I,j as S};
