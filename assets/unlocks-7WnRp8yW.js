...
`,B=b.split(`\r
`).filter(e=>e).map(e=>{var C,D;const[l,u,s,a,r,n,F,m,p,d]=e.split(","),k=Number(l),g=Number(s),h=a!=null&&a.length?a.split(":").map(t=>Number(t)):[],f=r.length?r.split(":").map(t=>Number(t)):[],y=n!=null&&n.length?(C=n==null?void 0:n.split(":"))==null?void 0:C.map(t=>Number(t)):[],c=F!=null&&F.length?(D=F==null?void 0:F.split(":"))==null?void 0:D.map(t=>Number(t)):[],S=m==="True",T=p==="True",P=Number(d);return{ID:k,Name:u,UnlockGroup:g,Requires:h,BlockedBy:f,RequiredProcesses:y,IngredientProviders:c,isMain:S,isStarterOrSide:T,DishType:P}});function M(e,l=!0){const u=l&&e.some(s=>s.Name==="Community");return B.filter(s=>{if(e.some(a=>a.ID===s.ID)||s.BlockedBy.some(a=>e.some(r=>r.ID===a))||s.Requires.some(a=>!e.some(r=>r.ID===a)))return!1;if(s.isStarterOrSide)if(e.some(a=>a.isMain)){if(e.length&&e[0].DishType===i.Dessert)debugger}else return!1;return!(!u&&s.DishType===i.Base)}).sort((s,a)=>s.ID-a.ID)}const R=[{ID:447437163,Name:"Country",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null},{ID:2002876295,Name:"City",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null},{ID:-1864906012,Name:"Alpine",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null},B.filter(e=>e.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null},{ID:1958825350,Name:"Turbo",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null}].sort((e,l)=>e.Name<l.Name?-1:1),I=["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>B.filter(l=>l.Name===e)[0]),v=N.split(`\r
`).filter(e=>e).map(e=>{var c,S;const[l,u,s,a,r,n,F,m]=e.split(","),p=Number(l),d=Number(s),k=a!=null&&a.length?(c=a==null?void 0:a.split(":"))==null?void 0:c.map(T=>Number(T)):[],g=r!=null&&r.length?(S=r==null?void 0:r.split(":"))==null?void 0:S.map(T=>Number(T)):[],h=n==="True",f=F==="True",y=Number(m);return{ID:p,Name:u,UnlockGroup:d,Requires:[],BlockedBy:[],RequiredProcesses:k,IngredientProviders:g,isMain:h,isStarterOrSide:f,DishType:y}}).sort((e,l)=>e.Name<l.Name?-1:1);export{i as D,R,v as S,B as U,o as a,I as b,M as g};
