var o=(e=>(e[e.Generic=0]="Generic",e[e.Dish=1]="Dish",e[e.PrimaryTheme=3]="PrimaryTheme",e[e.SecondaryTheme=4]="SecondaryTheme",e[e.Franchise=5]="Franchise",e[e.Special=6]="Special",e))(o||{}),i=(e=>(e[e.Base=0]="Base",e[e.Main=1]="Main",e[e.Extra=2]="Extra",e[e.Side=3]="Side",e[e.Starter=4]="Starter",e[e.Dessert=5]="Dessert",e[e.Null=6]="Null",e))(i||{});const b=`373996608,Ice Cream,1,,,,-1533430406,False,False,5\r
...
-373772933,Simple Cloth Table,5,,,,,False,False,6`,N=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0\r
1356267749,Salad,1,2087693779,1193867305:-712909563:380220741,True,False,0\r
550743424,Pizza,1,2087693779:-1706154991:-523839730,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0\r
367917843,Dumplings,1,1972879238:-523839730:2087693779,925796718:-484165118:-452101383:380220741,True,False,0\r
-1778969928,Burgers,1,1972879238,759552160:380220741:385684499,True,False,0\r
...
`,B=b.split(`\r
`).filter(e=>e).map(e=>{var C,D;const[l,u,s,a,r,n,F,m,p,d]=e.split(","),k=Number(l),g=Number(s),h=a!=null&&a.length?a.split(":").map(t=>Number(t)):[],f=r.length?r.split(":").map(t=>Number(t)):[],y=n!=null&&n.length?(C=n==null?void 0:n.split(":"))==null?void 0:C.map(t=>Number(t)):[],T=F!=null&&F.length?(D=F==null?void 0:F.split(":"))==null?void 0:D.map(t=>Number(t)):[],S=m==="True",c=p==="True",P=Number(d);return{ID:k,Name:u,UnlockGroup:g,Requires:h,BlockedBy:f,RequiredProcesses:y,IngredientProviders:T,isMain:S,isStarterOrSide:c,DishType:P}});function R(e,l=!0){const u=l&&e.some(s=>s.Name==="Community");return B.filter(s=>{if(e.some(a=>a.ID===s.ID)||s.BlockedBy.some(a=>e.some(r=>r.ID===a))||s.Requires.some(a=>!e.some(r=>r.ID===a)))return!1;if(s.isStarterOrSide)if(e.some(a=>a.isMain)){if(e.length&&e[0].DishType===i.Dessert)debugger}else return!1;return!(!u&&s.DishType===i.Base)}).sort((s,a)=>s.ID-a.ID)}const M=[{ID:447437163,Name:"Country",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null},{ID:2002876295,Name:"City",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null},{ID:-1864906012,Name:"Alpine",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null},B.filter(e=>e.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null},{ID:1958825350,Name:"Turbo",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null}],I=[...M].sort((e,l)=>e.Name<l.Name?-1:1),v=["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>B.filter(l=>l.Name===e)[0]),E=N.split(`\r
`).filter(e=>e).map(e=>{var T,S;const[l,u,s,a,r,n,F,m]=e.split(","),p=Number(l),d=Number(s),k=a!=null&&a.length?(T=a==null?void 0:a.split(":"))==null?void 0:T.map(c=>Number(c)):[],g=r!=null&&r.length?(S=r==null?void 0:r.split(":"))==null?void 0:S.map(c=>Number(c)):[],h=n==="True",f=F==="True",y=Number(m);return{ID:p,Name:u,UnlockGroup:d,Requires:[],BlockedBy:[],RequiredProcesses:k,IngredientProviders:g,isMain:h,isStarterOrSide:f,DishType:y}}).sort((e,l)=>e.Name<l.Name?-1:1);export{i as D,I as R,E as S,B as U,o as a,M as b,v as c,R as g};
