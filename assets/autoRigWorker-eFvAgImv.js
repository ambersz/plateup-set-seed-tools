var ls=Object.defineProperty;var Fs=(G,V,J)=>V in G?ls(G,V,{enumerable:!0,configurable:!0,writable:!0,value:J}):G[V]=J;var T=(G,V,J)=>(Fs(G,typeof V!="symbol"?V+"":V,J),J);(function(){"use strict";class G{constructor(e,a){T(this,"array");T(this,"objectiveFunctions");this.array=V(e,a),this.objectiveFunctions=a}clear(){this.array=[]}add(e){let a=this.array.length;for(;a--;){let{better:l,worse:F}=J(e,this.array[a],this.objectiveFunctions);if(F)return!1;l&&this.array.splice(a,1)}return this.array.push(e),!0}}function V(s,e){if(!s.length)return s;const a=[...s];let l=[];l.push(a.pop());e:for(;a.length;){const F=a.pop();let r=l.length;for(;r--;){let{better:t,worse:p}=J(F,l[r],e);if(p)continue e;t&&l.splice(r,1)}l.push(F)}return l}function J(s,e,a){let l=!0,F=!0,r=0;for(;(l||F)&&r<a.length;){const t=a[r](s,e);t<0?F=!1:t>0&&(l=!1),r++}return{better:l,worse:F}}var De=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False,False,60\r
...
`;const Ne=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing","AllowRefreshes","PurchaseCost"],we=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean","boolean","number"],te=De.trim().split(`\r
`).map(s=>{const e=s.split(",");let a={};for(let l=0;l<e.length;l++){let F;switch(we[l]){case"number":F=Number(e[l]);break;case"boolean":F=e[l]==="True";break;case"number[]":e[l]===""?F=[]:F=e[l].split(":").map(r=>Number(r));break;default:F=e[l]}a[Ne[l]]=F}return a});class Ie{constructor(e){T(this,"Staple");T(this,"Tags");T(this,"StapleWhenMissing");T(this,"Appliance");T(this,"IsRemoved");T(this,"Filter");T(this,"DecorationRequired");T(this,"SellAsUpgrade");this.Appliance=e,this.Tags=e.ShoppingTags,this.DecorationRequired=e.ThemeRequired,this.SellAsUpgrade=e.IsPurchasableAsUpgrade,this.Filter=e.ShopRequirementFilter,this.StapleWhenMissing=e.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(e){return e&1?this.Staple!==0:e&this.Tags?this.Staple===0:!1}}var Q=(s=>(s[s.NonStaple=0]="NonStaple",s[s.FixedStaple=1]="FixedStaple",s[s.BonusStaple=2]="BonusStaple",s[s.WhenMissing=3]="WhenMissing",s))(Q||{}),le=(s=>(s[s.None=0]="None",s[s.Basic=1]="Basic",s[s.Decoration=2]="Decoration",s[s.Technology=4]="Technology",s[s.FrontOfHouse=8]="FrontOfHouse",s[s.Plumbing=16]="Plumbing",s[s.Cooking=32]="Cooking",s[s.Automation=64]="Automation",s[s.Christmas=128]="Christmas",s[s.Misc=256]="Misc",s[s.Office=512]="Office",s[s.BlueprintUpgrader=1024]="BlueprintUpgrader",s[s.BlueprintStore=2048]="BlueprintStore",s[s.Halloween=4096]="Halloween",s[s.SpecialEvent=8192]="SpecialEvent",s))(le||{});const Ce={DefaultShoppingTag:892};var Se=(s=>(s[s.None=0]="None",s[s.RefreshableProvider=1]="RefreshableProvider",s))(Se||{}),ce=(s=>(s[s.Null=0]="Null",s[s.Exclusive=1]="Exclusive",s[s.Affordable=2]="Affordable",s[s.Charming=4]="Charming",s[s.Formal=8]="Formal",s[s.Kitchen=16]="Kitchen",s))(ce||{}),Ae="38";const xe=Number(Ae);function Ee(s,e){return Math.floor(Math.random()*(e-s))+s}function Oe(s,e){let a=s.length;for(;a-- >1;){let l=e===void 0?Ee(0,a+1):e.range(0,a+1);[s[a],s[l]]=[s[l],s[a]]}return s}class re{constructor(e,a){T(this,"fixedSeed");T(this,"instance");T(this,"random");typeof e=="string"&&(e=He(e)),this.fixedSeed=e,this.instance=a,this.random=new ye(e+Math.imul(124192293,a))}useSubcontext(e){return new re(this.fixedSeed,124192293*e+this.instance)}}class ye{constructor(e){T(this,"seed");const a=p=>Math.imul(1812433253,p)+1>>0,l=e>>0,F=a(l),r=a(F),t=a(r);this.seed=[l,F,r,t]}get value(){let e=this.seed.shift(),a=this.seed[2];return e^=e<<11,e^=e>>>8,a^=a>>>19,a=(a^e)>>0,this.seed.push(a),a}range(e,a){return(this.value>>>0)%(a-e)+e}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(e){return e[this.range(0,e.length)]}}function He(s){const a=new TextEncoder().encode(s);let l=5381,F=a.length;for(;F>0;){let r=--F;l=(l<<5)+l+a[r]}return l>>0}function Pe(s,e,a){return new re(a,s*1231231+e)}var Fe=(s=>(s[s.Generic=0]="Generic",s[s.Dish=1]="Dish",s[s.PrimaryTheme=3]="PrimaryTheme",s[s.SecondaryTheme=4]="SecondaryTheme",s[s.Franchise=5]="Franchise",s[s.Special=6]="Special",s))(Fe||{}),Z=(s=>(s[s.Base=0]="Base",s[s.Main=1]="Main",s[s.Extra=2]="Extra",s[s.Side=3]="Side",s[s.Starter=4]="Starter",s[s.Dessert=5]="Dessert",s[s.Null=6]="Null",s))(Z||{});const Ge=te.filter(s=>s.IsPurchasable||s.IsPurchasableAsUpgrade).length;class $e{constructor(e,a=0){T(this,"seed");T(this,"mapSize");T(this,"numTiles");T(this,"baseUpgradeChance");T(this,"OwnedAppliances");T(this,"Cards");T(this,"Theme");T(this,"cache",new Map);T(this,"cacheDay");this.seed=e,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=a,this.OwnedAppliances=[],this.Cards=[],this.Theme=ce.Null,this.cacheDay=-1}getLayoutInfo(){const a=new re(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,F;switch(a){case 0:F=70,l=2;break;case 4:F=84,l=2;break;case 1:case 5:F=60,l=1;break;case 2:case 6:F=9*13,l=3;break;case 3:case 7:F=12*16,l=4;break;default:throw new Error}return[l,F]}handleNewCardSpawnEffects(e){e!==void 0&&(e.Name==="Turbo"&&(this.baseUpgradeChance=.25),e.UnlockGroup===Fe.PrimaryTheme&&(this.Theme=ce[e.Name]))}handleNewCardRerollEffects(e){e!==void 0&&(this.OwnedAppliances=this.OwnedAppliances.concat(e.IngredientProviders.flatMap(a=>te.filter(l=>l.ID===a))))}addCard(e){e!==void 0&&(this.handleNewCardSpawnEffects(e),this.handleNewCardRerollEffects(e),this.Cards.push(e))}getPrngAdvancements(e,a){let l=0;for(let F=0;F<e.length;F++){const r=e[F];let t=r.blueprintCount;a%5===0&&(t+=3,F===0&&(t+=2)),l+=t*(Ge-1+1),r.spawnInside||(l+=qe(r.playerInside,this.numTiles)),l+=xe}return l}buildShopOptions(e,a,l){let F=[];for(const t of te)if(!(!t.IsPurchasable&&!t.IsPurchasableAsUpgrade)){var r=new Ie(t);if(r.Staple==Q.NonStaple||r.Staple==Q.WhenMissing){if((r.Tags&le.Basic)>le.None)r.Staple=Q.FixedStaple;else if(r.StapleWhenMissing){const i=r.Appliance.Name;i!="Research Desk"&&i!="Blueprint Cabinet"&&i!="Plates"&&console.log(`Unexpected ${r.Appliance.Name} StapleWhenMissing Appliance`),e.some(g=>g.ID===r.Appliance.ID)?r.Staple=Q.NonStaple:r.Staple=Q.WhenMissing}}const u=r.Appliance;if(u.SellOnlyAsDuplicate)e.some(i=>i.ID===u.ID)||(r.IsRemoved=!0);else if(u.RequiresForShop.length>0){let i=!1;for(const g of u.RequiresForShop)e.some(y=>y.ID===g)&&(i=!0);r.IsRemoved=!i}else u.SellOnlyAsUnique&&(u.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${u.Name}, ${u.ID}`),e.some(i=>i.ID===u.ID)&&(r.IsRemoved=!0));(r.Appliance.Name==="Sink"||r.Appliance.Name==="Plates")&&l.every(i=>!i.isMain)&&(r.IsRemoved=!0),r.Filter==Se.RefreshableProvider&&(e.some(i=>i.AllowRefreshes)||(r.IsRemoved=!0)),r.DecorationRequired!=ce.Null&&r.DecorationRequired!=a&&(r.IsRemoved=!0),u.RequiresProcessForShop.length>0&&(u.RequiresProcessForShop.some(i=>l.some(g=>g.RequiredProcesses.includes(i)))||(r.IsRemoved=!0)),F.push(r)}return F}initRandom(e){return Pe(823828,e,this.seed)}getAppliances(e,a){a!==this.cacheDay&&(this.cacheDay=a,this.cache.clear());const l=e.length===1,F=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards);let r=e[e.length-1].blueprintCount,t;if(a%5==0){l?r=10:r+=3,t=[];for(let g=0;g<r;g++)t[g]=le.Decoration;if(l)for(const g of[1,2])t[t.length-g]=le.SpecialEvent}else if(e.length>1){t=[];for(let g=0;g<r;g++)t[g]=Ce.DefaultShoppingTag}else{const g=Ce.DefaultShoppingTag,y=Math.max(1,r),f=Math.max(0,Math.min(F.filter(b=>b.Staple!==Q.NonStaple&&!b.IsRemoved).length,Math.max(2,4-Math.floor(a/5)),y)),R=Math.max(0,y-f);r=y,t=[];for(let b=0;b<f;b++)t[b]=le.Basic;for(let b=f;b<f+R;b++)t[b]=g}const p=this.initRandom(a).random;let u=this.getPrngAdvancements(e.slice(0,e.length-1),a);if(this.cache.has(u)&&this.cache.get(u).length>=r)return this.cache.get(u).slice(0,r);const i=u;for(;u--;)p.value;{const g=[...F],y=[],f=this.getUpgradeChance(a),R=[];for(let b=0;b<r;b++){const q=t[b],K=p.valueFloat<f;Oe(g,p);for(let I=0;I<g.length;I++){const A=g[I];if(!A.IsRemoved&&!R.includes(A.Appliance)&&!!A.MatchesRequestTags(q)&&!(!K&&A.Staple==Q.NonStaple&&A.SellAsUpgrade)){q!=le.Decoration&&R.push(A.Appliance),y[b]=A.Appliance;break}}y[b]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${b}`)}return this.cache.set(i,y),y}}getUpgradeChance(e){return 1-(1-Math.floor(e/5)*.1)*(1-this.baseUpgradeChance)}}function qe(s,e){return s?e-2:e-1}var ze=`373996608,Ice Cream,1,,,,-1533430406,False,False,5,1,2\r
...
`,Le=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0,0,5\r
1356267749,Salad,1,2087693779,1193867305:-712909563:380220741,True,False,0,-1,5\r
550743424,Pizza,1,2087693779:-1706154991:-523839730,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0,0,5\r
367917843,Dumplings,1,1972879238:-523839730:2087693779,925796718:-484165118:-452101383:380220741,True,False,0,2,8\r
-1778969928,Burgers,1,1972879238,759552160:380220741:385684499,True,False,0,-2,3\r
...
`;const ge=ze.trim().split(`\r
`).filter(s=>s).map(s=>{var ne,X;const[e,a,l,F,r,t,p,u,i,g,y,f]=s.split(","),R=Number(e),b=Number(l),q=F!=null&&F.length?F.split(":").map(L=>Number(L)):[],z=r.length?r.split(":").map(L=>Number(L)):[],K=t!=null&&t.length?(ne=t==null?void 0:t.split(":"))==null?void 0:ne.map(L=>Number(L)):[],I=p!=null&&p.length?(X=p==null?void 0:p.split(":"))==null?void 0:X.map(L=>Number(L)):[],A=u==="True",O=i==="True",w=Number(g),_=Number(y),de=Number(f);return{ID:R,Name:a,UnlockGroup:b,Requires:q,BlockedBy:z,RequiredProcesses:K,IngredientProviders:I,isMain:A,isStarterOrSide:O,DishType:w,CustomerMultiplier:_,DishValue:de}}),ke=[...[{ID:447437163,Name:"Country",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},ge.filter(s=>s.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},{ID:1958825350,Name:"Turbo",UnlockGroup:Fe.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0}]].sort((s,e)=>s.Name<e.Name?-1:1);["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(s=>ge.filter(e=>e.Name===s)[0]),Le.trim().split(`\r
`).filter(s=>s).map(s=>{var O,w;const[e,a,l,F,r,t,p,u,i,g]=s.split(","),y=Number(e),f=Number(l),R=F!=null&&F.length?(O=F==null?void 0:F.split(":"))==null?void 0:O.map(_=>Number(_)):[],b=r!=null&&r.length?(w=r==null?void 0:r.split(":"))==null?void 0:w.map(_=>Number(_)):[],q=t==="True",z=p==="True",K=Number(u),I=Number(i),A=Number(g);return{ID:y,Name:a,UnlockGroup:f,Requires:[],BlockedBy:[],RequiredProcesses:R,IngredientProviders:b,isMain:q,isStarterOrSide:z,DishType:K,CustomerMultiplier:I,DishValue:A}}).sort((s,e)=>s.Name<e.Name?-1:1);const Ue=[7,8,8,8,8,10,10,8,9,9,9,10,9,10,10],We=[122,143,159,169,169,215,215,218,240,252,252,288,263,300,300],he={};function pe(s){return he[s]===void 0&&(he[s]=te.filter(e=>e.Name===s)[0]),he[s]===void 0&&console.error(`Could not find ${s} appliance`),he[s]}const je=[(s,e)=>s[0]-e[0],(s,e)=>s[1]-e[1]];function me(s){let e=0;(s==null?void 0:s.deskTime)!==void 0&&(e+=s.deskTime);for(const a of Object.values(s.achieved))e+=s.cumulativeRerolls*2,e+=a.goalsPurchased+a.substitutesPurchased;return e}function Te(s,e){return(a,l)=>{const F=a.achieved[e],r=l.achieved[e],t=Math.min(F.goalsPurchased,s);let u=Math.min(r.goalsPurchased,s)-t;return u===0?F.goalsPurchased>=s||F.goalsPurchased+F.substitutesPurchased>=s&&r.goalsPurchased+r.substitutesPurchased>=s?F.substitutesPurchased-r.substitutesPurchased:r.substitutesPurchased-F.substitutesPurchased:u}}const Ve={"Copying Desk":4,"Metal Table":4};function Ke(s,e,a,l,F=!0,r=We,t=()=>{}){var Me,Be;let p={};const u=[],i=new Array(l.length).fill(0).map(()=>({})),g={};let y=0,f=0;const R={},b=e.some(d=>d.Name==="Turbo"),q=[];let z=[],K=0;const I={};for(const d of l){for(const o of d){const{goal:C,number:M,substitutes:N,skipMissing:c=!1}=o;for(const P of N)g[P]=C;I[C]?c||(I[C].number+=M):(I[C]={...o},c&&(I[C].number=0));for(let P=0;P<=K;P++){if(i[P]===void 0)debugger;i[P][C]?i[P][C].number+=M:i[P][C]={...o}}for(let P=K+1;P<i.length;P++){if(i[P]===void 0)debugger;i[P][C]||(i[P][C]={...o,number:0})}c||(f+=pe(C).PurchaseCost*M*(b?.5:1))}try{u.push(JSON.parse(JSON.stringify(I)))}catch{console.log(i),console.log(i[0]);debugger}K++}const A=i[0];p=u.shift();for(const d of Object.values(A)){const{goal:o,number:C}=d;R[o]={...d,substitutesPurchased:0,goalsPurchased:0},d.goal!=="Starter Bin"&&(q.push(Te(C,o)),z.push(Te(C,o)))}const O=new G([],[...q,(d,o)=>me(d)-me(o),(d,o)=>d.actionHistory.length-o.actionHistory.length,(d,o)=>d.cumulativeRerolls-o.cumulativeRerolls,(d,o)=>(d.day+1)%5?d.upgradesInProgress-o.upgradesInProgress:0]),w=b?7:5,_=[{spawnInside:!0,blueprintCount:w},{spawnInside:!1,playerInside:!1,blueprintCount:w}];F||_.push({spawnInside:!1,playerInside:!0,blueprintCount:w});const de=[{spawnInside:!0,blueprintCount:w},{spawnInside:!1,playerInside:!0,blueprintCount:w},{spawnInside:!1,playerInside:!1,blueprintCount:w}];function ne(d,o,C){const M={...d};for(const N of Object.values(o)){const c=N.goal;M[c]={...M[c]},M[c].goalsPurchased+=N.goalsPurchased,C&&(M[c].substitutesPurchased+=N.substitutesPurchased)}return M}let X=[];function L(d,o,C,M=!1){const N=o.fodderUsed;for(const c of d){let P=1+(c.achieved["Copying Desk"].goalsPurchased||c.achieved["Copying Desk"].substitutesPurchased?1:0);const Y=1+c.achieved["Blueprint Cabinet"].goalsPurchased;let k=Y;if(k*=P,k-=c.upgradesInProgress,k<0||k<N)continue;let B=c.cumulativeRerolls+o.cumulativeRerolls,h=B*(B+1)/2*10+c.applianceCosts;const S=ne(c.achieved,o.achieved,!1),n=ne(c.achieved,o.achieved,!0),$=_e(p,S);if(U<=0&&$>0||h>W)continue;let x=0,j=0,ee=0;{let se=W-h;for(const m of Object.values(o.achieved)){se-=m.goalsPurchased*pe(m.goal).PurchaseCost*(b?.5:1);let ae=!1;(se<0||m.substitutesPurchased)&&(ae=!0,se<0&&(x+=m.goalsPurchased),x+=m.substitutesPurchased,ee+=m.substitutesPurchased*(Ve[m.goal]??1)),m.goal==="Metal Table"&&m.goalsPurchased+m.substitutesPurchased&&(n["Copying Desk"].goalsPurchased||c.achieved["Copying Desk"].substitutesPurchased)&&(ae||j++,j++,ee++)}if(x>n["Blueprint Cabinet"].goalsPurchased+1)continue}h+=o.applianceCosts;const v=c.deskTime+Math.max(0,N-Y)*5*(c.achieved["Clipboard Stand"].goalsPurchased?.5:1)+(ee*5+Ue[o.day])*(n["Clipboard Stand"].goalsPurchased?.5:1),E={...o,rerollConfigs:[...c.rerollConfigs,o.rerollConfigs],achieved:n,money:W-h,actionHistory:[...c.actionHistory,...o.actionHistory],upgradesInProgress:x,cumulativeRerolls:c.cumulativeRerolls+o.cumulativeRerolls,applianceCosts:c.applianceCosts+o.applianceCosts,deskTime:v};if(!(x>n["Blueprint Cabinet"].goalsPurchased+1)){if(j&&(j===1||x+1<=n["Blueprint Cabinet"].goalsPurchased+1)&&(E.upgradesInProgress+=j,n["Metal Table"].goalsPurchased++,E.actionHistory.push("Copy Metal Table"),E.applianceCosts+=30),E.money>=0){if($<U&&(U=$,console.log(`best so far missing ${$} pieces `+be(E))),$<=0){O.add(E)&&Re();continue}else if(U<=0)continue}if(k>y&&(y=k),M){const se=c.cumulativeRerolls;for(let m=0;m<=k;m++)X[m]===void 0&&(X[m]=new G([],je)),X[m].add([se,h]);continue}C.add(E)}}return U}const ie=new G([{achieved:{...R},actionHistory:[],applianceCosts:0,cumulativeRerolls:0,rerollConfigs:[],upgradesInProgress:0,day:0,numFloor:0,money:0,fodderAvailable:0,deskTime:0}],[...q,(d,o)=>d.applianceCosts-o.applianceCosts,(d,o)=>d.cumulativeRerolls-o.cumulativeRerolls]);let U=1/0,D=0,W=b?30:0;const H=new $e(s),fe=["Plates","Research Desk"];let oe=[];{const d=["Booking Desk","Blueprint Cabinet"];te.filter(o=>d.includes(o.Name)).forEach(o=>H.OwnedAppliances.push(o))}for(const d of e)H.addCard(d);function Xe(d,o){let C=[{...d}];for(const M of o){let N=M.Name,c=d.achieved[M.Name],P=!1;if(!c){if(c=d.achieved[g[M.Name]],!c)continue;P=!0,N=g[M.Name]}if(!(c.goalsPurchased>=i[0][N].number)&&!(P&&c.goalsPurchased+c.substitutesPurchased>=i[0][N].number)){const Y=C.map(k=>{const B={...k};return B.achieved={...B.achieved},B.numFloor--,B.achieved[c.goal]={...c,goalsPurchased:c.goalsPurchased+(P?0:1),substitutesPurchased:c.substitutesPurchased+(P?1:0)},B.applianceCosts+=pe(N).PurchaseCost*(b?.5:1),B.actionHistory=[...B.actionHistory,`buy ${M.Name}`+(P?` for ${c.goal}`:"")],c.goal==="Starter Bin"&&(B.fodderPurchases=[...B.fodderPurchases],B.fodderPurchases[1]++),B});C=C.concat(Y)}}return C}for(;U;){const d=ie.array;ie.clear();const o=new G([],[...z,(h,S)=>h.cumulativeRerolls-S.cumulativeRerolls,(h,S)=>h.applianceCosts-S.applianceCosts]);if(W+=r[D],D++,D>14)break;if(D>1&&d.length===0){debugger;break}let C=1/0,M=10*1e3;const N=Math.min(C-1,1/0);if(W>=f){const h=Math.sqrt((W-f)/10*2);console.log(`Have ${W} on day ${D}, need ${f} to buy everything. Allows for ~${h} rerolls across all days`)}D%5||(C=1);const c=a.shift(),P=ge.filter(h=>h.Name===c)[0];H.handleNewCardSpawnEffects(P);const Y=H.getAppliances([{spawnInside:!0,blueprintCount:w}],D);if(fe.length)for(let h=fe.length-1;h>=0;h--){let S=Y.length;for(;S--;){const n=Y[S];if(n.Name===fe[h]){console.log(`buying ${n.Name} on day ${D}`),oe.push(n),fe.splice(h,1),W-=n.PurchaseCost*(b?.5:1),Y.splice(S,1);break}}}let k=new G([{day:D,rerollConfigs:[],achieved:{...R},numFloor:w,fodderAvailable:y,fodderUsed:0,money:W,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,fodderPurchases:[0,0]}],[(h,S)=>H.getPrngAdvancements(h.rerollConfigs,D)-H.getPrngAdvancements(S.rerollConfigs,D),(h,S)=>-H.getPrngAdvancements(h.rerollConfigs,D)+H.getPrngAdvancements(S.rerollConfigs,D),...z,(h,S)=>h.cumulativeRerolls-S.cumulativeRerolls,(h,S)=>h.applianceCosts-S.applianceCosts,(h,S)=>S.numFloor+S.fodderAvailable-h.numFloor+h.fodderAvailable,(h,S)=>h.numFloor-S.numFloor]);L(d,k.array[0],ie,!0);let B=1/0;e:for(;C--&&(B=Date.now()+M*.9**(((Be=(Me=k.array[0])==null?void 0:Me.rerollConfigs)==null?void 0:Be.length)??0),k.array[0]!==void 0);){const h=X.map(n=>n.array.reduce(($,[x,j])=>Math.min($,j+k.array[0].rerollConfigs.length*(x+1)*10),1/0));console.log(`Seed ${s} Day ${D} Reroll ${k.array[0].rerollConfigs.length} expanding ${k.array.length} states`),console.log({minSpentMoneyByExtraBlueprints:h});const S=k.array;if(!u.length&&U<=0){const n=S[0].rerollConfigs.length;if(n*((n+1)/2)*10+f>W){console.log("get me outta here!");break}}k.clear();for(const n of S){if(Date.now()>B){k.array.sort((v,E)=>v.numFloor-E.numFloor||v.fodderAvailable-E.fodderAvailable||E.applianceCosts-v.applianceCosts||Math.random()-.5);continue e}if(n.numFloor+n.fodderAvailable===0||n.money<n.rerollConfigs.length*10)continue;let $=0;if(h[0]>n.money)continue;for(let v=1;v<h.length;v++)if($++,h[v]>n.money){$=v-1;break}let x=N<n.rerollConfigs.length?n.numFloor:n.rerollConfigs.length?n.numFloor+Math.min(n.fodderAvailable,$-n.fodderUsed):w;{let v=n.actionHistory.length;for(;v--&&!n.actionHistory[v].includes("reroll");)if(n.actionHistory[v].includes("Starter Bin")){x=n.numFloor;break}}const j=N<n.rerollConfigs.length?n.numFloor:n.rerollConfigs.length?Math.max(1,n.numFloor):w;let ee;n.rerollConfigs.length===0?ee=de:N<n.rerollConfigs.length?ee=[n.rerollConfigs.at(-1)]:ee=_,oe.length&&n.rerollConfigs.length===1&&(H.OwnedAppliances.push(...oe),oe=[]),H.getAppliances([...n.rerollConfigs,{spawnInside:!0,blueprintCount:x}],n.day);for(const v of ee){const E=m=>{if(!k.add(m)||!o.add(m))return;m.fodderPurchases[0]+m.fodderPurchases[1]||L(d,m,ie)},se=[j];for(let m=x;m>j;m--)se.push(m);for(const m of se){const ae=[...n.rerollConfigs,{...v,blueprintCount:m}],es=ae.length===1?Y:H.getAppliances(ae,n.day),ue=m-n.numFloor;if(ue>n.fodderAvailable)debugger;const ss=Xe({...n,fodderPurchases:[n.fodderPurchases[1],0],money:n.money-n.rerollConfigs.length*10,rerollConfigs:ae,numFloor:ae.length===1?m-oe.length:m,fodderAvailable:n.fodderAvailable-ue,fodderUsed:n.fodderUsed+ue,cumulativeRerolls:n.rerollConfigs.length?n.cumulativeRerolls+1:0,actionHistory:n.rerollConfigs.length?[...n.actionHistory,`${ue?`take ${ue} out, `:""}reroll ${v.spawnInside?"I":v.playerInside?"OI":"OO"}`]:[`day ${n.day} spawn`,`spawn ${v.spawnInside?"I":v.playerInside?"OI":"OO"}`]},es);for(const as of ss)E(as);if(Date.now()>B)break}}}}if(H.addCard(P),U<=0){if(!u.length){t((U<=0?`full build on ${s} by day ${D}: 
`:"")+O.array.map(h=>be(h)).join(`
`));break}p=u.shift(),i.shift(),z=[];for(const{goal:h,number:S}of Object.values(i[0]))z.push(Te(S,h));U=1/0,X=[],Re(!0),ie.array=O.array,O.clear(),O.objectiveFunctions}}return D;function Re(d=!1){t(`tier ${l.length-u.length-(d?1:0)} build on ${s} by day ${D}${d?"":" (Partial)"}: 
`+O.array.map(o=>be(o)).join(`
`))}}function _e(s,e){let a=0;for(const l of Object.values(s)){let F=l.number;a+=Math.max(0,F-e[l.goal].goalsPurchased-e[l.goal].substitutesPurchased)}return a}function be(s){const e=s.cumulativeRerolls*(s.cumulativeRerolls+1)/2*10+s.applianceCosts;return`${s.day}: ${me(s)} ${s.cumulativeRerolls} ${s.applianceCosts} (${e}) ${s.cumulativeRerolls}, `+s.actionHistory.join(", ")}class Ye{constructor(e,a=[],l=[]){T(this,"seed");T(this,"mapSize");T(this,"frontDoor");T(this,"startingCards");T(this,"cards");T(this,"playerCount");T(this,"turbo");T(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=a,this.cards=l,this.playerCount=this.mapSize,this.turbo=this.startingCards.some(F=>{if(F===void 0){console.log({startingCards:a});debugger}return F.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCustomerCount(e);let l=this.startingCards.reduce((F,r)=>F+r.DishValue,0);if(this.getCardsByDay(e).some(F=>F.Name==="Double Helpings")&&(l+=3),Number.isNaN(a))debugger;if(Number.isNaN(l))debugger;return Je(this.playerCount)*(a*l+this.getBookingDeskCount(e)*this.getBookingDeskMoney(e))}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let a;this.turbo?a=e-1:(a=Math.max(0,Math.floor((e-1)/3)),e>5&&a++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,a)],console.log(`Day ${e} has ${this._cardsByDay[e].map(l=>l.Name).join(", ")}`)}return this._cardsByDay[e]}getBookingDeskCount(e){return Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e))+(this.turbo?3:this.getCardsByDay(e).filter(a=>a.Name.includes(" Rush")).length)}getGroupCount(e){const a=this.getExpectedCustomers(e),l=this.getCardsByDay(e).filter(t=>t.Name==="Closing Time").length*.2,F=this.getExpectedGroupSize(e),r=a*(1+l)/F;return console.log({custs:a,closingTimeAdjust:l,avgGroupSize:F,goalGroups:r}),Math.ceil(r)}getCustomerCount(e){return this.getGroupSizes(e).reduce((a,l)=>a+l,0)}getGroupSizes(e){const a=Pe(1997821,e,this.seed).random,l=this.getGroupCount(e),F=this.getCardsByDay(e).some(f=>f.Name==="Herd Mentality");let r=l,t=[],[p,u]=this.getGroupSizeRange(e);console.log({min:p,max:u,gc:l,herd:F});{let f=r-1;for(;f--;)a.value}for(;r--;)t.push(a.range(p,u+1)),!F&&r!==l-1&&a.value;let i=this.turbo?3:this.getCardsByDay(e).filter(f=>f.Name.includes(" Rush")).length;const g=Math.ceil(Math.max(1,this.getExpectedCustomers(e)*.15));let y=i*g;for(console.log({totalRushGroups:y});y--;)t.push(a.range(p,u+1));return console.log({groups:t}),t}getExpectedGroupSize(e){const a=this.getGroupSizeRange(e);return(a[0]+a[1])/2}getGroupSizeRange(e){let a=1,l=2;for(const F of this.getCardsByDay(e))switch(F.Name){case"Individual Dining":l--;break;case"Medium Groups":a++,l+=2;break;case"Large Groups":a+=2,l+=2;break;case"Flexible Dining":a--,l++;break;case"Community":const r=Math.floor((e-1)/3);a+=r,l+=r;break}return[a,l]}getExpectedCustomers(e){const a=this.getReductions(e),l=this.getDayLength(e),F=this.getPlayerModifier(),r=this.getCourseModifier(e),t=this.getDayRate(e),p=this.getCustomersPerHour(e),u=this.getAdvertisingModifier(e),i=.85**a*(l/25*t*F)/r*p*u;return console.log({reductions:a,dayLength:l,playerModifier:F,courseModifier:r,dayRate:t,kitchenParamCustomers:p,advertising:u,res:i}),i}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(l=>l.Name==="Advertising").length}getDayRate(e){let a=1;switch(e){case 1:a=1.25;break;case 2:a=1.5;break;default:a=1.5+.15*(e-3);break}return e>15&&(a+=(this.turbo?.1:0)*(e-15)**1.5),a}getCourseModifier(e){let a=1;const l=this.getCardsByDay(e);return l.some(F=>F.DishType===Z.Dessert)&&(a+=.25),l.some(F=>F.DishType===Z.Starter)&&(a+=.25),a}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let a=1;return this.turbo&&(a=1.5,a*=1+e/10),a}getReductions(e){return this.getCardsByDay(e).reduce((l,F)=>l+F.CustomerMultiplier,0)}getMapSize(){const a=new re(this.seed,5078598).useSubcontext(0).random.range(0,4);let l;switch(a){case 0:l=2;break;case 1:l=1;break;case 2:l=3;break;case 3:l=4;break;default:throw new Error}return l}getDoorInfo(){if(this.mapSize!==1)return-1;let e=new ye(new re(this.seed,98234234).useSubcontext(0).random.value),a=23;for(;a--;)e.value;return e.range(0,4)}}function Je(s){switch(s){case 1:return 1.25;case 2:return 1.1;default:return 1}}var ve=self;function Qe(s){console.log(`reporting - ${s.split(`
`)[0]}`),ve.postMessage(s)}const Ze=[{goal:"Copying Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Blueprint Cabinet",number:8,substitutes:[],skipMissing:!0},{goal:"Clipboard Stand",number:1,substitutes:[],skipMissing:!0},{goal:"Starter Bin",number:999,substitutes:["Auto Plater","Dining Table","Sink","Hob","Counter","Bin","Compactor Bin","Composter Bin","Conveyor","Dish Rack","Expanded Bin","Fire Extinguisher","Freezer","Kitchen Floor Protector","Mop","Plates","Pot Stack","Rolling Pin","Sharp Knife","Soaking Sink"],skipMissing:!0}];ve.onmessage=function(s){let{config:e,tiers:a,playerCount:l}=s.data;a=a.filter(f=>f.length);const F=[...Ze],r=a.flatMap(f=>f.flatMap(R=>[R.goal,...R.substitutes]));F[3].substitutes=F[3].substitutes.filter(f=>!r.some(R=>f===R)),a[a.length-1].push(...F);const t=e.cards.filter(f=>ke.some(R=>R.Name===f.Name)).length+1,p=e.cards.slice(0,t);e.blueprintCount===7&&p.push(ke.filter(f=>f.Name==="Turbo")[0]);let u=[];const i=e.cards.slice(t);console.log({startingCards:p,duringRunCards:i});let g=new Ye(e.seed,p,i);g.playerCount=l;let y=g.guessMoney(0);console.log({cumulative:y});for(let f=1;f<=15;f++)y+=g.guessMoney(f),u.push(y);console.log({expectedMoneyByDay:u}),Ke(e.seed,p,e.cards.slice(t).map(f=>f.Name),a,e.solo,u,Qe)}})();
