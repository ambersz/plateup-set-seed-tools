...
`,V=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0,0,5\r
1356267749,Salad,1,2087693779,1193867305:-712909563:380220741,True,False,0,-1,5\r
550743424,Pizza,1,2087693779:-1706154991:-523839730,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0,0,5\r
367917843,Dumplings,1,1972879238:-523839730:2087693779,925796718:-484165118:-452101383:380220741,True,False,0,2,8\r
-1778969928,Burgers,1,1972879238,759552160:380220741:385684499,True,False,0,-2,3\r
...
`,N=q.trim().split(`\r
`).filter(e=>e).map(e=>{var R,I;const[s,a,l,r,n,F,t,h,d,p,g,f]=e.split(","),k=Number(s),y=Number(l),C=r!=null&&r.length?r.split(":").map(u=>Number(u)):[],D=n.length?n.split(":").map(u=>Number(u)):[],B=F!=null&&F.length?(R=F==null?void 0:F.split(":"))==null?void 0:R.map(u=>Number(u)):[],b=t!=null&&t.length?(I=t==null?void 0:t.split(":"))==null?void 0:I.map(u=>Number(u)):[],M=h==="True",m=d==="True",T=Number(p),c=Number(g),x=Number(f);return{ID:k,Name:a,UnlockGroup:y,Requires:C,BlockedBy:D,RequiredProcesses:B,IngredientProviders:b,isMain:M,isStarterOrSide:m,DishType:T,CustomerMultiplier:c,DishValue:x}});function z(e,s=!0){const a=s&&e.some(l=>l.Name==="Community");return N.filter(l=>{if(e.some(r=>r.ID===l.ID)||l.BlockedBy.some(r=>e.some(n=>n.ID===r))||l.Requires.some(r=>!e.some(n=>n.ID===r)))return!1;if(l.isStarterOrSide)if(e.some(r=>r.isMain)){if(e.length&&e[0].DishType===i.Dessert)debugger}else return!1;return!(!a&&l.DishType===i.Base)}).sort((l,r)=>l.ID-r.ID)}const H=[{ID:447437163,Name:"Country",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0},N.filter(e=>e.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0},{ID:1958825350,Name:"Turbo",UnlockGroup:o.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:i.Null,CustomerMultiplier:0,DishValue:0}],G=[...H].sort((e,s)=>e.Name<s.Name?-1:1),L=["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>N.filter(s=>s.Name===e)[0]),W=V.trim().split(`\r
`).filter(e=>e).map(e=>{var m,T;const[s,a,l,r,n,F,t,h,d,p]=e.split(","),g=Number(s),f=Number(l),k=r!=null&&r.length?(m=r==null?void 0:r.split(":"))==null?void 0:m.map(c=>Number(c)):[],y=n!=null&&n.length?(T=n==null?void 0:n.split(":"))==null?void 0:T.map(c=>Number(c)):[],C=F==="True",D=t==="True",B=Number(h),b=Number(d),M=Number(p);return{ID:g,Name:a,UnlockGroup:f,Requires:[],BlockedBy:[],RequiredProcesses:k,IngredientProviders:y,isMain:C,isStarterOrSide:D,DishType:B,CustomerMultiplier:b,DishValue:M}}).sort((e,s)=>e.Name<s.Name?-1:1);class P{constructor(s,a){S(this,"fixedSeed");S(this,"instance");S(this,"random");typeof s=="string"&&(s=w(s)),this.fixedSeed=s,this.instance=a,this.random=new O(s+Math.imul(124192293,a))}useSubcontext(s){return new P(this.fixedSeed,124192293*s+this.instance)}}class O{constructor(s){S(this,"seed");const a=t=>Math.imul(1812433253,t)+1>>0,l=s>>0,r=a(l),n=a(r),F=a(n);this.seed=[l,r,n,F]}get value(){let s=this.seed.shift(),a=this.seed[2];return s^=s<<11,s^=s>>>8,a^=a>>>19,a=(a^s)>>0,this.seed.push(a),a}range(s,a){return(this.value>>>0)%(a-s)+s}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(s){return s[this.range(0,s.length)]}}function w(e){const a=new TextEncoder().encode(e);let l=5381,r=a.length;for(;r--;)l=(l<<5)+l+a[r];return l>>0}function J(e,s,a){return new P(a,e*1231231+s)}export{i as D,P as F,G as R,W as S,N as U,H as a,L as b,O as c,J as d,o as e,z as g};
