var j=Object.defineProperty;var J=(h,d,m)=>d in h?j(h,d,{enumerable:!0,configurable:!0,writable:!0,value:m}):h[d]=m;var S=(h,d,m)=>(J(h,typeof d!="symbol"?d+"":d,m),m);(function(){"use strict";var h=(a=>(a[a.Generic=0]="Generic",a[a.Dish=1]="Dish",a[a.PrimaryTheme=3]="PrimaryTheme",a[a.SecondaryTheme=4]="SecondaryTheme",a[a.Special=6]="Special",a))(h||{}),d=(a=>(a[a.Base=0]="Base",a[a.Main=1]="Main",a[a.Extra=2]="Extra",a[a.Side=3]="Side",a[a.Starter=4]="Starter",a[a.Dessert=5]="Dessert",a[a.Null=6]="Null",a))(d||{}),m=`373996608,Ice Cream,1,,,,-1533430406,False,False,5\r
...
`;const D=m.split(`\r
`).filter(a=>a).map(a=>{var B,M;const[e,s,l,F,n,u,r,i,T,c]=a.split(","),t=Number(e),p=Number(l),o=F!=null&&F.length?F.split(":").map(f=>Number(f)):[],g=n.length?n.split(":").map(f=>Number(f)):[],k=u!=null&&u.length?(B=u==null?void 0:u.split(":"))==null?void 0:B.map(f=>Number(f)):[],V=r!=null&&r.length?(M=r==null?void 0:r.split(":"))==null?void 0:M.map(f=>Number(f)):[],K=i==="True",Y=T==="True",_=Number(c);return{ID:t,Name:s,UnlockGroup:p,Requires:o,BlockedBy:g,RequiredProcesses:k,IngredientProviders:V,isMain:K,isStarterOrSide:Y,DishType:_}});function R(a){return D.filter(e=>!(a.some(s=>s.ID===e.ID)||e.BlockedBy.some(s=>a.some(l=>l.ID===s))||e.Requires.some(s=>!a.some(l=>l.ID===s))||e.isStarterOrSide&&!a.some(s=>s.isMain)||e.DishType===d.Base)).sort((e,s)=>e.ID-s.ID)}h.Special,d.Null;class b{constructor(e,s){S(this,"fixedSeed");S(this,"instance");S(this,"random");typeof e=="string"&&(e=v(e)),this.fixedSeed=e,this.instance=s,this.random=new w(e+Math.imul(124192293,s))}useSubcontext(e){return new b(this.fixedSeed,124192293*e+this.instance)}}class w{constructor(e){S(this,"seed");const s=r=>Math.imul(1812433253,r)+1>>0,l=e>>0,F=s(l),n=s(F),u=s(n);this.seed=[l,F,n,u]}get value(){let e=this.seed.shift(),s=this.seed[2];return e^=e<<11,e^=e>>>8,s^=s>>>19,s=(s^e)>>0,this.seed.push(s),s}range(e,s){return(this.value>>>0)%(s-e)+e}get valueFloat(){return(this.value<<9>>>0)/4294967295}}function v(a){const s=new TextEncoder().encode(a);let l=5381,F=s.length;for(;F>0;){let n=--F;l=(l<<5)+l+s[n]}return l>>0}class x{constructor(){}GetOptions(e,s,l){const F=l.random,n=R(e);let u=n.length+1;for(s!==5&&(u+=n.length+1);u--;)F.value;let r=E(n,F);F.valueFloat<.1&&r.sort((o,g)=>{let k=0;return o.Requires.length&&k--,g.Requires.length&&k++,k});const T=s===5?h.PrimaryTheme:h.Dish,c=s===5?h.PrimaryTheme:h.Generic;let t=null,p=null;for(const o of r)if(!(o.UnlockGroup!==T&&o.UnlockGroup!==c)&&(t===null||t.UnlockGroup!==T&&o.UnlockGroup===T?t=o:(p===null||p.UnlockGroup!==c&&o.UnlockGroup===c)&&(p=o),t&&t.UnlockGroup===T&&p&&p.UnlockGroup===c))break;return[t,p]}}function E(a,e){return a.map(l=>[l,e.valueFloat]).sort((l,F)=>l[1]-F[1]).map(l=>l[0])}class I{constructor(e){S(this,"cards");S(this,"unlockPack");S(this,"seed");this.cards=[],this.unlockPack=new x,this.seed=e}addCard(e){e!==void 0&&this.cards.push(e)}getUnlockOptions(e){const l=G(848292,e,this.seed).useSubcontext(1);return this.unlockPack.GetOptions(this.cards,e,l)}}function G(a,e,s){return new b(s,a*1231231+e)}class N{constructor(e){S(this,"seed");S(this,"mapSize");this.seed=e,this.mapSize=this.getMapSize()}getMapSize(){const s=new b(this.seed,5078598).useSubcontext(0).random.range(0,4);let l;switch(s){case 0:l=2;break;case 1:l=1;break;case 2:l=3;break;case 3:l=4;break;default:throw new Error}return l}}var A=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
-1995745069,False,False,SyncModsViewHolder,False,False,,,0,0,0,False`;const H=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing"],L=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean"];A.split(`\r
`).map(a=>{const e=a.split(",");let s={};for(let l=0;l<e.length;l++){let F;switch(L[l]){case"number":F=Number(e[l]);break;case"boolean":F=e[l]==="True";break;case"number[]":e[l]===""?F=[]:F=e[l].split(":").map(n=>Number(n));break;default:F=e[l]}s[H[l]]=F}return s}).filter(a=>a.IsPurchasable||a.IsPurchasableAsUpgrade).length;var O=self;let C=!1;O.onmessage=function(a){const e=a;console.log("Worker: Message received from main script"),e.data.type==="start"?(C=!0,z(e.data.data)):(console.log("breaking search"),C=!1)};async function z({goalCards:a,goalAppliances:e=[],mapSizes:s,maxSeeds:l=10,partial:F=!1}){const n=new MessageChannel;let u;n.port2.onmessage=t=>{u()};let r="az2mpjp3";const i=a[0].cards;let T=[-1/0,[]],c=l;for(;C&&c;){const t=new Promise(g=>{u=g});for(n.port1.postMessage(null),await t,r="az";r.length<8;)r+=y[Math.floor(Math.random()*y.length)];const p=new N(r).mapSize;if(!s.includes(p))continue;const o=U(r,i,a,e,F);if(o[0]>=T[0]){if(!Number.isFinite(o[0]))continue;T=o,c--;const g=JSON.stringify({seed:r,metric:[o[0],o[1]]});console.log(g),W({seed:r,cards:o[1],blueprints:[]})}}}function W(a){postMessage({type:"result",data:a})}function U(a,e,s,l,F=!1){const n=new I(a);for(const i of e)n.addCard(i);let u=0,r=1;for(;r<15;r++){const i=n.getUnlockOptions(r),T=P(i[0],s[r]),c=P(i[1],s[r]);let t=-1;if(T>-1&&c>-1)T<c?t=0:t=1;else if(T===-1&&c===-1){if(!F)return[-1/0,[]];t=Math.floor(Math.random()*2),u++}else T>=0?t=0:t=1;if(!i[t]){debugger;throw console.log({options:i}),new Error}n.addCard(i[t])}return[r-u,n.cards.map(i=>i.Name)]}const y="abcdefghijklmnopqrstuvwxyz123456789";function q(a,e){for(let s=0;s<a.length;s++)if(a[s].ID===e.ID)return s;return-1}function P(a,e){return e.include?q(e.cards,a):e.cards.some(s=>s.ID===a.ID)?-1:0}})();
