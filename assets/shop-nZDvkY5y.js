var M=Object.defineProperty;var v=(e,a,F)=>a in e?M(e,a,{enumerable:!0,configurable:!0,writable:!0,value:F}):e[a]=F;var i=(e,a,F)=>(v(e,typeof a!="symbol"?a+"":a,F),F);import{S as A}from"./utils-Q-HaJtwR.js";import{F as D,a as I}from"./prng-ACD5049E.js";import{c as N}from"./unlocks-ENjzZK3S.js";const w=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False,False,60\r
...
`,x=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing","AllowRefreshes","PurchaseCost"],E=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean","boolean","number"],O=w.trim().split(`\r
`).map(e=>{const a=e.split(",");let F={};for(let l=0;l<a.length;l++){let r;switch(E[l]){case"number":r=Number(a[l]);break;case"boolean":r=a[l]==="True";break;case"number[]":a[l]===""?r=[]:r=a[l].split(":").map(s=>Number(s));break;default:r=a[l]}F[x[l]]=r}return F});class U{constructor(a){i(this,"Staple");i(this,"Tags");i(this,"StapleWhenMissing");i(this,"Appliance");i(this,"IsRemoved");i(this,"Filter");i(this,"DecorationRequired");i(this,"SellAsUpgrade");this.Appliance=a,this.Tags=a.ShoppingTags,this.DecorationRequired=a.ThemeRequired,this.SellAsUpgrade=a.IsPurchasableAsUpgrade,this.Filter=a.ShopRequirementFilter,this.StapleWhenMissing=a.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(a){return a&1?this.Staple!==0:a&this.Tags?this.Staple===0:!1}}var h=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(h||{}),d=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(d||{});const R={DefaultShoppingTag:892};var k=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(k||{}),p=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(p||{});const C=O,y="38",q=Number(y),W=C.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class Q{constructor(a,F=0){i(this,"seed");i(this,"mapSize");i(this,"numTiles");i(this,"baseUpgradeChance");i(this,"OwnedAppliances");i(this,"Cards");i(this,"Theme");i(this,"cache",new Map);i(this,"cacheDay");this.seed=a,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=F,this.OwnedAppliances=[],this.Cards=[],this.Theme=p.Null,this.cacheDay=-1}getLayoutInfo(){const F=new D(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,r;switch(F){case 0:r=70,l=2;break;case 4:r=84,l=2;break;case 1:case 5:r=60,l=1;break;case 2:case 6:r=9*13,l=3;break;case 3:case 7:r=12*16,l=4;break;default:throw new Error}return[l,r]}handleNewCardSpawnEffects(a){a!==void 0&&(a.Name==="Turbo"&&(this.baseUpgradeChance=.25),a.UnlockGroup===N.PrimaryTheme&&(this.Theme=p[a.Name]))}handleNewCardRerollEffects(a){a!==void 0&&(this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(F=>C.filter(l=>l.ID===F))))}addCard(a){a!==void 0&&(this.handleNewCardSpawnEffects(a),this.handleNewCardRerollEffects(a),this.Cards.push(a))}getPrngAdvancements(a,F){let l=0;for(let r=0;r<a.length;r++){const s=a[r];let t=s.blueprintCount;F%5===0&&(t+=3,r===0&&(t+=2)),l+=t*(W-1+1),s.spawnInside||(l+=L(s.playerInside,this.numTiles)),l+=q}return l}buildShopOptions(a,F,l){let r=[];for(const t of C)if(!(!t.IsPurchasable&&!t.IsPurchasableAsUpgrade)){var s=new U(t);if(s.Staple==h.NonStaple||s.Staple==h.WhenMissing){if((s.Tags&d.Basic)>d.None)s.Staple=h.FixedStaple;else if(s.StapleWhenMissing){const u=s.Appliance.Name;u!="Research Desk"&&u!="Blueprint Cabinet"&&u!="Plates"&&console.log(`Unexpected ${s.Appliance.Name} StapleWhenMissing Appliance`),a.some(n=>n.ID===s.Appliance.ID)?s.Staple=h.NonStaple:s.Staple=h.WhenMissing}}const o=s.Appliance;if(o.SellOnlyAsDuplicate)a.some(u=>u.ID===o.ID)||(s.IsRemoved=!0);else if(o.RequiresForShop.length>0){let u=!1;for(const n of o.RequiresForShop)a.some(c=>c.ID===n)&&(u=!0);s.IsRemoved=!u}else o.SellOnlyAsUnique&&(o.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${o.Name}, ${o.ID}`),a.some(u=>u.ID===o.ID)&&(s.IsRemoved=!0));(s.Appliance.Name==="Sink"||s.Appliance.Name==="Plates")&&l.every(u=>!u.isMain)&&(s.IsRemoved=!0),s.Filter==k.RefreshableProvider&&(a.some(u=>u.AllowRefreshes)||(s.IsRemoved=!0)),s.DecorationRequired!=p.Null&&s.DecorationRequired!=F&&(s.IsRemoved=!0),o.RequiresProcessForShop.length>0&&(o.RequiresProcessForShop.some(u=>l.some(n=>n.RequiredProcesses.includes(u)))||(s.IsRemoved=!0)),r.push(s)}return r}initRandom(a){return I(823828,a,this.seed)}getAppliances(a,F){F!==this.cacheDay&&(this.cacheDay=F,this.cache.clear());const l=a.length===1,r=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards);let s=a[a.length-1].blueprintCount,t;if(F%5==0){l?s=10:s+=3,t=[];for(let n=0;n<s;n++)t[n]=d.Decoration;if(l)for(const n of[1,2])t[t.length-n]=d.SpecialEvent}else if(a.length>1){t=[];for(let n=0;n<s;n++)t[n]=R.DefaultShoppingTag}else{const n=R.DefaultShoppingTag,c=Math.max(1,s),m=Math.max(0,Math.min(r.filter(T=>T.Staple!==h.NonStaple&&!T.IsRemoved).length,Math.max(2,4-Math.floor(F/5)),c)),S=Math.max(0,c-m);s=c,t=[];for(let T=0;T<m;T++)t[T]=d.Basic;for(let T=m;T<m+S;T++)t[T]=n}const b=this.initRandom(F).random;let o=this.getPrngAdvancements(a.slice(0,a.length-1),F);if(this.cache.has(o)&&this.cache.get(o).length>=s)return this.cache.get(o).slice(0,s);const u=o;for(;o--;)b.value;{const n=[...r],c=[],m=this.getUpgradeChance(F),S=[];for(let T=0;T<s;T++){const P=t[T],B=b.valueFloat<m;A(n,b);for(let g=0;g<n.length;g++){const f=n[g];if(f.IsRemoved||S.includes(f.Appliance)||!f.MatchesRequestTags(P)||!B&&f.Staple==h.NonStaple&&f.SellAsUpgrade)continue;P!=d.Decoration&&S.push(f.Appliance),c[T]=f.Appliance;break}c[T]==null}return this.cache.set(u,c),c}}getUpgradeChance(a){return 1-(1-Math.floor(a/5)*.1)*(1-this.baseUpgradeChance)}}function L(e,a){return e?a-2:a-1}export{C as A,Q as S};
