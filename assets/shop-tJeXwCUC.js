var M=Object.defineProperty;var v=(e,a,F)=>a in e?M(e,a,{enumerable:!0,configurable:!0,writable:!0,value:F}):e[a]=F;var t=(e,a,F)=>(v(e,typeof a!="symbol"?a+"":a,F),F);import{F as P}from"./prng-1rWzft78.js";import{a as A}from"./unlocks-8mfgXCLy.js";const I=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
`).map(e=>{const a=e.split(",");let F={};for(let l=0;l<a.length;l++){let n;switch(N[l]){case"number":n=Number(a[l]);break;case"boolean":n=a[l]==="True";break;case"number[]":a[l]===""?n=[]:n=a[l].split(":").map(s=>Number(s));break;default:n=a[l]}F[D[l]]=n}return F});class w{constructor(a){t(this,"Staple");t(this,"Tags");t(this,"StapleWhenMissing");t(this,"Appliance");t(this,"IsRemoved");t(this,"Filter");t(this,"DecorationRequired");t(this,"SellAsUpgrade");this.Appliance=a,this.Tags=a.ShoppingTags,this.DecorationRequired=a.ThemeRequired,this.SellAsUpgrade=a.IsPurchasableAsUpgrade,this.Filter=a.ShopRequirementFilter,this.StapleWhenMissing=a.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(a){return a&1?this.Staple!==0:a&this.Tags?this.Staple===0:!1}}var f=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(f||{}),m=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(m||{});const k={DefaultShoppingTag:892};var B=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(B||{}),S=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(S||{});const x="38",E=Number(x);function O(e,a){let F=e.length;for(;F-- >1;){let l=a.range(0,F+1);[e[F],e[l]]=[e[l],e[F]]}return e}const Y="bdghjmqrtvwxy346789",q=g.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class V{constructor(a,F=0){t(this,"seed");t(this,"mapSize");t(this,"numTiles");t(this,"baseUpgradeChance");t(this,"OwnedAppliances");t(this,"Cards");t(this,"Theme");this.seed=a,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=F,this.OwnedAppliances=[],this.Cards=[],this.Theme=S.Null}getLayoutInfo(){const F=new P(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,n;switch(F){case 0:n=70,l=2;break;case 4:n=84,l=2;break;case 1:case 5:n=60,l=1;break;case 2:case 6:n=9*13,l=3;break;case 3:case 7:n=12*16,l=4;break;default:throw new Error}return[l,n]}addCard(a){a!==void 0&&(this.Cards.push(a),this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(F=>g.filter(l=>l.ID===F))),a.UnlockGroup===A.PrimaryTheme&&(this.Theme=S[a.Name]))}getPrngAdvancements(a,F){let l=0;for(let n=0;n<a.length;n++){const s=a[n];let T=s.blueprintCount;F%5===0&&(T+=3,n===0&&(T+=2)),l+=T*(q-1+1),s.spawnInside||(l+=U(s.playerInside,this.numTiles)),l+=E}return l}buildShopOptions(a,F,l){let n=[];for(const T of g)if(!(!T.IsPurchasable&&!T.IsPurchasableAsUpgrade)){var s=new w(T);if(s.Staple==f.NonStaple||s.Staple==f.WhenMissing){if((s.Tags&m.Basic)>m.None)s.Staple=f.FixedStaple;else if(s.StapleWhenMissing){const r=s.Appliance.Name;r!="Research Desk"&&r!="Blueprint Cabinet"&&r!="Plates"&&console.log(`Unexpected ${s.Appliance.Name} StapleWhenMissing Appliance`),a.includes(s.Appliance)?s.Staple=f.NonStaple:s.Staple=f.WhenMissing}}const u=s.Appliance;if(u.SellOnlyAsDuplicate)a.includes(u)||(s.IsRemoved=!0);else if(u.RequiresForShop.length>0){let r=!1;for(const o of u.RequiresForShop)a.some(h=>h.ID===o)&&(r=!0);s.IsRemoved=!r}else u.SellOnlyAsUnique&&(u.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${u.Name}, ${u.ID}`),a.some(r=>r.ID===u.ID)&&(s.IsRemoved=!0));(s.Appliance.Name==="Sink"||s.Appliance.Name==="Plates")&&l.every(r=>!r.isMain)&&(s.IsRemoved=!0),s.Filter==B.RefreshableProvider&&(s.IsRemoved=!1),s.DecorationRequired!=S.Null&&s.DecorationRequired!=F&&(s.IsRemoved=!0),u.RequiresProcessForShop.length>0&&(u.RequiresProcessForShop.some(r=>l.some(o=>o.RequiredProcesses.includes(r)))||(s.IsRemoved=!0)),n.push(s)}return n}initRandom(a){return new P(this.seed,823828*1231231+a)}getAppliances(a,F){const l=a.length===1,n=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards),s=this.initRandom(F).random;let T=this.getPrngAdvancements(a.slice(0,a.length-1),F);for(;T--;)s.value;let c=a[a.length-1].blueprintCount,u;if(F%5==0){l?c=10:c+=3,u=[];for(let r=0;r<c;r++)u[r]=m.Decoration;if(l)for(const r of[1,2])u[u.length-r]=m.SpecialEvent}else if(a.length>1){u=[];for(let r=0;r<c;r++)u[r]=k.DefaultShoppingTag}else{const r=k.DefaultShoppingTag,o=Math.max(1,c),h=Math.max(0,Math.min(4,Math.max(2,4-Math.floor(F/5)),o)),b=Math.max(0,o-h);c=o,u=[];for(let i=0;i<h;i++)u[i]=m.Basic;for(let i=h;i<h+b;i++)u[i]=r}{const r=[...n],o=[],h=1-(1-Math.floor(F/5)*.1)*(1-this.baseUpgradeChance),b=[];for(let i=0;i<c;i++){const C=u[i],R=s.valueFloat<h;O(r,s);for(let p=0;p<r.length;p++){const d=r[p];if(!d.IsRemoved&&!b.includes(d.Appliance)&&!!d.MatchesRequestTags(C)&&!(!R&&d.Staple==f.NonStaple&&d.SellAsUpgrade)){C!=m.Decoration&&b.push(d.Appliance),o[i]=d.Appliance;break}}o[i]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${i}`)}return o}}}function U(e,a){return e?a-2:a-1}export{g as A,Y as I,V as S};
