var $s=Object.defineProperty;var Us=(W,Q,ue)=>Q in W?$s(W,Q,{enumerable:!0,configurable:!0,writable:!0,value:ue}):W[Q]=ue;var m=(W,Q,ue)=>Us(W,typeof Q!="symbol"?Q+"":Q,ue);(function(){"use strict";class W{constructor(e,a){m(this,"array");m(this,"objectiveFunctions");this.array=Q(e,a),this.objectiveFunctions=a}clear(){this.array=[]}add(e){let a=this.array.length;for(;a--;){let{better:l,worse:r}=ue(e,this.array[a],this.objectiveFunctions);if(r)return!1;l&&this.array.splice(a,1)}return this.array.push(e),!0}}function Q(s,e){if(!s.length)return s;const a=[...s];let l=[];l.push(a.pop());e:for(;a.length;){const r=a.pop();let F=l.length;for(;F--;){let{better:i,worse:f}=ue(r,l[F],e);if(f)continue e;i&&l.splice(F,1)}l.push(r)}return l}function ue(s,e,a){let l=!0,r=!0,F=0;for(;(l||r)&&F<a.length;){const i=a[F](s,e);i<0?r=!1:i>0&&(l=!1),F++}return{better:l,worse:r}}var cs=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False,False,60\r
...
`).filter(s=>s).map(s=>{var H,Pe;const[e,a,l,r,F,i,f,c,t,d,g,p]=s.split(","),x=Number(e),T=Number(l),K=r!=null&&r.length?r.split(":").map(ee=>Number(ee)):[],z=F.length?F.split(":").map(ee=>Number(ee)):[],X=i!=null&&i.length?(H=i==null?void 0:i.split(":"))==null?void 0:H.map(ee=>Number(ee)):[],$=f!=null&&f.length?(Pe=f==null?void 0:f.split(":"))==null?void 0:Pe.map(ee=>Number(ee)):[],E=c==="True",j=t==="True",re=Number(d),Fe=Number(g),_=Number(p);return{ID:x,Name:a,UnlockGroup:T,Requires:K,BlockedBy:z,RequiredProcesses:X,IngredientProviders:$,isMain:E,isStarterOrSide:j,DishType:re,CustomerMultiplier:Fe,DishValue:_}}),Ms=[...[{ID:447437163,Name:"Country",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},Oe.filter(s=>s.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0},{ID:1958825350,Name:"Turbo",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:Z.Null,CustomerMultiplier:0,DishValue:0}]].sort((s,e)=>s.Name<e.Name?-1:1);["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(s=>Oe.filter(e=>e.Name===s)[0]),Rs.trim().split(`\r
`).filter(s=>s).map(s=>{var j,re;const[e,a,l,r,F,i,f,c,t,d]=s.split(","),g=Number(e),p=Number(l),x=r!=null&&r.length?(j=r==null?void 0:r.split(":"))==null?void 0:j.map(Fe=>Number(Fe)):[],T=F!=null&&F.length?(re=F==null?void 0:F.split(":"))==null?void 0:re.map(Fe=>Number(Fe)):[],K=i==="True",z=f==="True",X=Number(c),$=Number(t),E=Number(d);return{ID:g,Name:a,UnlockGroup:p,Requires:[],BlockedBy:[],RequiredProcesses:x,IngredientProviders:T,isMain:K,isStarterOrSide:z,DishType:X,CustomerMultiplier:$,DishValue:E}}).sort((s,e)=>s.Name<e.Name?-1:1);const Ds=[7,8,8,8,8,10,10,8,9,9,9,10,9,10,10],Bs=[122,143,159,169,169,215,215,218,240,252,252,288,263,300,300],we={};function le(s){return we[s]===void 0&&(we[s]=Ce.filter(e=>e.Name===s)[0]),we[s]===void 0&&console.error(`Could not find ${s} appliance`),we[s]}const ws=[(s,e)=>s[0]-e[0],(s,e)=>s[1]-e[1]];function Se(s){let e=0;(s==null?void 0:s.deskTime)!==void 0&&(e+=s.deskTime);for(const a of Object.values(s.achieved))e+=s.cumulativeRerolls*2,e+=s.actionHistory.filter(l=>l==="spawn OI"||l==="spawn OO").length*3,e+=s.actionHistory.reduce((l,r)=>{var F;return r.includes("take ")?l+3+Number((F=r.match(/(\d+)/))==null?void 0:F[0]):l},0),e+=a.goalsPurchased+a.substitutesPurchased;return e}function Ge(s,e){return(a,l)=>{const r=a.achieved[e],F=l.achieved[e],i=Math.min(r.goalsPurchased,s);let c=Math.min(F.goalsPurchased,s)-i;return c===0?r.goalsPurchased>=s||r.goalsPurchased+r.substitutesPurchased>=s&&F.goalsPurchased+F.substitutesPurchased>=s?r.goalsPurchased+r.substitutesPurchased-(F.goalsPurchased+F.substitutesPurchased):F.substitutesPurchased-r.substitutesPurchased:c}}const Ye={"Copying Desk":3,"Metal Table":4,"Power Sink":4,"Dish Washer":4,"Wash Basin":4,"Soaking Sink":4,"Heated Mixer":3,"Conveyor Mixer":3,"Rapid Mixer":3,"Danger Hob":2,"Safety Hob":2,"Grabber - Rotating":2,"Smart Grabber":2};function Ns(s,e,a,l,r=!0,F=Bs,i=Ds,f=()=>{}){var as,ls,rs,Fs;let c={},t=[];const d=[],g=new Array(l.length).fill(0).map(()=>({})),p={};let x=0,T=0;const K={},z=e.some(h=>h.Name==="Turbo"),X=[];let $=[],E=0;const j={};for(const h of l){for(const u of h){const{goal:y,number:R,substitutes:D,skipMissing:C=!1}=u;for(const k of D)p[k]=y;j[y]?C||(j[y].number+=R):(j[y]={...u},C&&(j[y].number=0));for(let k=0;k<=E;k++){if(g[k]===void 0)debugger;g[k][y]?g[k][y].number+=R:g[k][y]={...u}}for(let k=E+1;k<g.length;k++){if(g[k]===void 0)debugger;g[k][y]||(g[k][y]={...u,number:0})}C||(T+=le(y).PurchaseCost*R*(z?.5:1))}try{d.push(JSON.parse(JSON.stringify(j)))}catch{console.log(g),console.log(g[0]);debugger}E++}const re=g[0],Fe=Object.values(re).sort((h,u)=>le(h.goal).PurchaseCost-le(u.goal).PurchaseCost).map(h=>h.goal);c=d.shift();for(const h of Object.values(re)){const{goal:u,number:y}=h;K[u]={...h,substitutesPurchased:0,goalsPurchased:0},h.goal!=="Starter Bin"&&(X.push(Ge(y,u)),$.push(Ge(y,u)))}const _=new W([],[...X,(h,u)=>u.money-h.money,(h,u)=>Se(h)-Se(u),(h,u)=>h.actionHistory.length-u.actionHistory.length,(h,u)=>h.cumulativeRerolls-u.cumulativeRerolls,(h,u)=>(h.day+1)%5?h.upgradesInProgress-u.upgradesInProgress:0]),H=z?7:5,Pe=[{spawnInside:!0,blueprintCount:H},{spawnInside:!1,playerInside:!1,blueprintCount:H}];r||Pe.push({spawnInside:!1,playerInside:!0,blueprintCount:H});const ee=[{spawnInside:!0,blueprintCount:H},{spawnInside:!1,playerInside:!0,blueprintCount:H},{spawnInside:!1,playerInside:!1,blueprintCount:H}];function Ze(h,u,y){const R={...h};for(const D of Object.values(u)){const C=D.goal;R[C]={...R[C]},C==="Copying Desk"&&(R[C].goalsPurchased+=R[C].substitutesPurchased,R[C].substitutesPurchased=0),R[C].goalsPurchased+=D.goalsPurchased,y&&(R[C].substitutesPurchased+=D.substitutesPurchased)}return R}let ke=[];function Xe(h,u,y,R=!1){var G,S,v,q,U,o,n,M,se,fe,V,B,me,pe,w,ne,Le,Ae,te,Re;const D=u.fodderUsed,C=Object.values(u.achieved).some(b=>b.substitutesPurchased)&&!((G=u.achieved["Research Desk"])!=null&&G.goalsPurchased),k=u.actionHistory.at(-1)==="buy Blueprint Cabinet"&&((S=u.actionHistory.at(-2))!=null&&S.includes("reroll"))?1:0;e:for(const b of h){if(C&&!es&&!((v=b.achieved["Research Desk"])!=null&&v.goalsPurchased))continue;let ze=1+(b.achieved["Copying Desk"].goalsPurchased?1:0);const ns=b.achieved["Blueprint Cabinet"].goalsPurchased;let ie=ns;if(ie-=t.length,ie-=b.upgradesInProgress,ie*=ze,ie<0||ie<D)continue;let ts=b.cumulativeRerolls+u.cumulativeRerolls,Me=ts*(ts+1)/2*10+b.applianceCosts;const $e=u.actionHistory.length?Ze(b.achieved,u.achieved,!1):b.achieved,A=u.actionHistory.length?Ze(b.achieved,u.achieved,!0):b.achieved,De=Is(c,$e);if(J<=0&&De>0||u.cumulativeRerolls&&Me>I)continue;let Te=0,be=0,is=[],xe=0,Ue=1;const We=A["Blueprint Cabinet"].goalsPurchased-t.length-k,os=((q=b.achieved["Discount Desk"])==null?void 0:q.goalsPurchased)??0+((U=b.achieved["Discount Desk"])==null?void 0:U.substitutesPurchased)??0?.5:1;{let L=I-Me;for(const Y of Fe){const N=u.achieved[Y];L-=N.goalsPurchased*le(N.goal).PurchaseCost*(z?.5:1)*os;let us=!1;(L<0||N.substitutesPurchased)&&(N.goal==="Copying Desk"&&be&&(be=0,xe--),us=!0,L<0&&(Te+=N.goalsPurchased),Te+=N.substitutesPurchased,N.substitutesPurchased&&(xe++,Ye[N.goal]&&(Ue*=Ye[N.goal]))),(N.goal==="Metal Table"||N.goal==="Grabber - Rotating"||N.goal==="Portioner"||N.goal==="Grabber")&&N.goalsPurchased+N.substitutesPurchased&&A[Y].goalsPurchased+A[Y].substitutesPurchased<A[Y].number&&(b.achieved["Copying Desk"].goalsPurchased||A["Copying Desk"].goalsPurchased&&L>60)&&(us||be++,be++,is.push(N.goal),xe++)}if(Te>We)continue e}Me+=u.applianceCosts*os;let ye=100,Ee=P>1?160:100,He=50;switch(((o=A==null?void 0:A.Portioner)==null?void 0:o.goalsPurchased)??0){case 0:break;case 1:ye*=.75;break;case 2:default:switch(ye/=4,(((n=A["Grabber - Rotating"])==null?void 0:n.goalsPurchased)+((M=A.Grabber)==null?void 0:M.goalsPurchased)+((se=b.achieved["Grabber - Rotating"])==null?void 0:se.substitutesPurchased)+((fe=b.achieved.Grabber)==null?void 0:fe.substitutesPurchased))*((V=b.achieved["Copying Desk"])==null?void 0:V.goalsPurchased)){case 0:break;default:ye/=2}break}switch(((B=$e["Danger Hob"])==null?void 0:B.goalsPurchased)+((me=$e["Danger Hob"])==null?void 0:me.substitutesPurchased)&&(ye*=.75),((pe=A["Scrubbing Brush"])==null?void 0:pe.goalsPurchased)??0){case 0:break;case 1:default:He/=3}switch(Math.max((((w=b.achieved["Power Sink"])==null?void 0:w.goalsPurchased)??0)+(((ne=b.achieved["Power Sink"])==null?void 0:ne.substitutesPurchased)??0),((Le=A["Power Sink"])==null?void 0:Le.goalsPurchased)??0)){case 0:break;case 1:default:He/=2/.75}{let L=P<6?(((Ae=A["Table - Fancy Cloth"])==null?void 0:Ae.goalsPurchased)??0)+1:0;switch(P){case 1:case 2:case 3:break;case 4:L++;break;case 5:L+=2;break;case 6:default:L+=4;break}Ee/=L}P>=5&&(Ee/=2);const zs=b.deskTime+(Ue-1)*20+Math.max(0,D-ns)*5*((te=b.achieved["Clipboard Stand"])!=null&&te.goalsPurchased?.5:1)+(xe*Ue*5+(i[u.day]??i.at(-1)??0))*((Re=A["Clipboard Stand"])!=null&&Re.goalsPurchased?.5:1)+Math.max(ye+He,Ee)+ye+He+Ee,oe={...u,rerollConfigs:[...b.rerollConfigs,u.rerollConfigs],achieved:A,money:I-Me,actionHistory:[...b.actionHistory,...u.actionHistory],upgradesInProgress:Te,cumulativeRerolls:b.cumulativeRerolls+u.cumulativeRerolls,applianceCosts:b.applianceCosts+u.applianceCosts,deskTime:zs};if(!(Te>We)){if(be&&(be===1||Te+1<=We))for(const L of is)oe.upgradesInProgress+=be,A[L].goalsPurchased++,oe.actionHistory.push(`copy ${L}`),oe.applianceCosts+=30;if(oe.money>=0&&(!oe.upgradesInProgress||d.length)){if(De<J&&(J=De,console.log(`best so far missing ${De} pieces `+Ne(oe,I))),De<=0){if(_.add(oe)){ss();continue}}else if(J<=0)continue}if(ie>x&&(x=ie),R){const L=b.cumulativeRerolls;for(let Y=0;Y<=ie;Y++)ke[Y]===void 0&&(ke[Y]=new W([],ws)),ke[Y].add([L,Me]);continue}y.add(oe)}}return J}const qe={...K};qe["Blueprint Cabinet"]={...qe["Blueprint Cabinet"],goalsPurchased:1};const ve=new W([{achieved:qe,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,rerollConfigs:[],upgradesInProgress:0,day:0,numFloor:0,money:0,fodderAvailable:0,deskTime:0}],[...X,(h,u)=>h.applianceCosts-u.applianceCosts,(h,u)=>h.cumulativeRerolls-u.cumulativeRerolls]);let J=1/0,P=0,I=0;const O=new Ps(s),Ie=["Research Desk","Plates"];let es=!1,ge=[];{const h=["Booking Desk","Blueprint Cabinet"];Ce.filter(u=>h.includes(u.Name)).forEach(u=>O.OwnedAppliances.push(u))}for(const h of e)O.addCard(h);function Ls(h,u,y){let R=[{...h}],D=[],C=[];const k=JSON.parse(JSON.stringify(h.achieved));for(const G of u){let S=G.Name,v=k[S],q=!1;if(!v||v.goalsPurchased>=g[0][S].number){if(v=k[p[G.Name]],!v)continue;q=!0,S=p[G.Name]}if(!(q&&v.goalsPurchased+v.substitutesPurchased>=g[0][S].number)&&!(v.goalsPurchased>=g[0][S].number)){S==="Table - Fancy Cloth"&&(q=!1),q?v.substitutesPurchased++:v.goalsPurchased++;{const U=o=>{const n={...o};n.achieved={...n.achieved},n.numFloor--,n.achieved[S]={...n.achieved[S],goalsPurchased:n.achieved[S].goalsPurchased+(q?0:1),substitutesPurchased:n.achieved[S].substitutesPurchased+(q?1:0)};const M=S==="Starter Bin"||S==="Table - Fancy Cloth"?le(G.Name).PurchaseCost:Math.max(le(G.Name).PurchaseCost,le(S).PurchaseCost);return n.applianceCosts+=M*(z?.5:1),n.actionHistory=[...n.actionHistory,`buy ${G.Name}`+(q?` for ${S}`:"")],S==="Starter Bin"&&(n.fodderPurchases=[...n.fodderPurchases],n.fodderPurchases[1]++,n.achieved[S].substitutesPurchased--),n};if(S!=="Starter Bin"){const o=R.map(U),n=D.map(U),M=C.map(U);R=o.concat(R),D=n.concat(D),C=M.concat(C),o.forEach(y)}else D=D.concat(C),C=(C.length?C:R).map(U)}}}return R.concat(D).concat(C)}for(;J;){let h=ve.array;ve.clear();const u=new W([],[...$,(o,n)=>o.cumulativeRerolls-n.cumulativeRerolls,(o,n)=>o.applianceCosts-n.applianceCosts]);if(I+=F[P]??F.at(-1)??0,P++,P>14&&(z||!a.length)){debugger;break}if(P>1&&h.length===0){debugger;break}h.sort((o,n)=>Se(o)-Se(n)),console.log(`fastest so far: ${Ne(h[0],I)}`),h.every(o=>o.achieved["Copying Desk"].goalsPurchased)&&(t=t.map(o=>(I-=60/2,o-1)),t=t.filter(o=>o>0));let y=5,R=.5*60*1e3;const D=Math.min(y-1,1/0);if(I>=T){const o=Math.sqrt((I-T)/10*2);console.log(`Have ${I} on day ${P}, need ${T} to buy everything. Allows for ~${o} rerolls across all days`)}P%5||(y=1);let C;(z||P===5||!(P%3))&&(C=a.shift());const k=Oe.filter(o=>o.Name===C)[0];O.handleNewCardSpawnEffects(k);const G=O.getAppliances([{spawnInside:!0,blueprintCount:H}],P);O.handleNewCardRerollEffects(k);let S=[];if(Ie.length)for(let o=Ie.length-1;o>=0;o--){let n=G.length;for(;n--;){const M=G[n];if(M.Name===Ie[o]){if(console.log(`buying ${M.Name} on day ${P}`),I-h.reduce((fe,V)=>Math.min(fe,V.applianceCosts+10/2*(V.cumulativeRerolls+1)*V.cumulativeRerolls),1/0)<M.PurchaseCost*(z?.5:1)){console.log("not enough money-- skip for now");continue}ge.push(M),Ie.splice(o,1),I-=M.PurchaseCost*(z?.5:1),G.splice(n,1);break}}S=ge.map(M=>`Buy ${M.Name}`)}let v=new W([{day:P,rerollConfigs:[],achieved:{...K},numFloor:H,fodderAvailable:x,fodderUsed:0,money:I,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,fodderPurchases:[0,0]}],[(o,n)=>O.getPrngAdvancements(o.rerollConfigs,P)-O.getPrngAdvancements(n.rerollConfigs,P),(o,n)=>-O.getPrngAdvancements(o.rerollConfigs,P)+O.getPrngAdvancements(n.rerollConfigs,P),...$,(o,n)=>o.cumulativeRerolls-n.cumulativeRerolls,(o,n)=>o.applianceCosts-n.applianceCosts,(o,n)=>n.numFloor+n.fodderAvailable-o.numFloor+o.fodderAvailable,(o,n)=>o.numFloor-n.numFloor]);Xe(h,v.array[0],ve,!0);let q=1/0;const U=ke.map(o=>o.array.reduce((n,[M,se])=>Math.min(n,se+v.array[0].rerollConfigs.length*(M+1)*10),1/0));e:for(;y--&&(ge.length&&((ls=(as=v.array[0])==null?void 0:as.rerollConfigs)==null?void 0:ls.length)===1&&(ge.some(n=>n.Name==="Research Desk")&&(es=!0),O.OwnedAppliances.push(...ge),ge=[],S=[]),q=Date.now()+R,v.array[0]!==void 0);){console.log(`Seed ${s} Day ${P} Reroll ${v.array[0].rerollConfigs.length} expanding ${v.array.length} states`),console.log({minSpentMoneyByExtraBlueprints:U});const o=v.array;if(!d.length&&J<=0){const n=o[0].rerollConfigs.length;if(n*((n+1)/2)*10+T>I){console.log("get me outta here!");break}}v.clear();for(const n of o){if(Date.now()>q){v.array.sort((me,pe)=>-1*(me.applianceCosts-pe.applianceCosts));continue e}if(n.numFloor+n.fodderAvailable===0||n.money<n.rerollConfigs.length*10)continue;let M=0;if(U[0]>n.money)continue;for(let B=1;B<U.length;B++)if(M++,U[B]>n.money){M=B-1;break}let se=D<n.rerollConfigs.length?n.numFloor:n.rerollConfigs.length?n.numFloor+Math.min(n.fodderAvailable,M-n.fodderUsed):H;{let B=n.actionHistory.length;for(;B--&&!n.actionHistory[B].includes("reroll");)if(n.actionHistory[B].includes("Starter Bin")){se=n.numFloor;break}}const fe=D<n.rerollConfigs.length?n.numFloor:n.rerollConfigs.length?Math.max(1,n.numFloor):H;let V;n.rerollConfigs.length===0?V=ee:D<n.rerollConfigs.length?V=[n.rerollConfigs.at(-1)]:V=Pe,O.getAppliances([...n.rerollConfigs,{spawnInside:!0,blueprintCount:se}],n.day);for(const B of V){const me=w=>{if(!v.add(w)||!u.add(w))return;w.fodderPurchases[0]+w.fodderPurchases[1]||Xe(h,w,ve)},pe=[fe];for(let w=se;w>fe;w--)pe.push(w);for(const w of pe){const ne=[...n.rerollConfigs,{...B,blueprintCount:w}],Ae=[...ne.length===1?G:O.getAppliances(ne,n.day)].sort((b,ze)=>b.PurchaseCost-ze.PurchaseCost),te=w-n.numFloor;if(te>n.fodderAvailable)debugger;const Re={...n,fodderPurchases:[n.fodderPurchases[1],0],money:n.money-n.rerollConfigs.length*10,rerollConfigs:ne,numFloor:ne.length===1?w-ge.length:w,fodderAvailable:n.fodderAvailable-te,fodderUsed:n.fodderUsed+te,cumulativeRerolls:n.rerollConfigs.length?n.cumulativeRerolls+1:0,actionHistory:n.rerollConfigs.length?[...n.actionHistory,`${te?`take ${te} out, `:""}reroll ${B.spawnInside?"I":B.playerInside?"OI":"OO"}`]:[`day ${n.day} spawn`,`spawn ${B.spawnInside?"I":B.playerInside?"OI":"OO"}`,...S]};if(me(Re),Ls(Re,Ae,me),Date.now()>q)break}}}}if(O.addCard(k),J<=0){if(!d.length){_.array.sort((o,n)=>o.deskTime-n.deskTime),f((J<=0?`full build on ${s} by day ${P}: 
`:"")+_.array.map(o=>Ne(o,I)).join(`
`));break}{const o=(((rs=d[0]["Blueprint Cabinet"])==null?void 0:rs.number)??0)-(((Fs=c["Blueprint Cabinet"])==null?void 0:Fs.number)??0);if(o+t.length>2)debugger;for(let n=0;n<o;n++)t.push(1)}for(const o of Object.values(c))o.number&&O.OwnedAppliances.push(le(o.goal));c=d.shift(),g.shift(),$=[];for(const{goal:o,number:n}of Object.values(g[0]))$.push(Ge(n,o));J=1/0,ke=[],ss(!0),ve.array=_.array,_.clear(),_.objectiveFunctions}}return P;function ss(h=!1){f(`tier ${l.length-d.length-(h?1:0)} build on ${s} by day ${P}${h?"":" (Partial)"}: 
`+_.array.slice(0,100).map(u=>Ne(u,I)).join(`
`))}}function Is(s,e){let a=0;for(const l of Object.values(s)){let r=l.number;a+=Math.max(0,r-e[l.goal].goalsPurchased-e[l.goal].substitutesPurchased)}return a}function Ne(s,e){const a=s.cumulativeRerolls*(s.cumulativeRerolls+1)/2*10+s.applianceCosts;return`${s.day}: ${Se(s)} total rerolls: ${s.cumulativeRerolls}, appliance costs: ${s.applianceCosts} (money spent: ${a}/${e}), `+s.actionHistory.join(", ")}const As={"Diner (1)":1,"Small (2)":2,"Medium (2)":2,"Large (3)":3,"Huge (4)":4};class xs{constructor(e,a=[],l=[]){m(this,"seed");m(this,"mapSize");m(this,"frontDoor");m(this,"startingCards");m(this,"cards");m(this,"playerCount");m(this,"turbo");m(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=a,this.cards=l,this.playerCount=As[this.mapSize],this.turbo=this.startingCards.some(r=>{if(r===void 0){console.log({startingCards:a});debugger}return r.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCardsByDay(e),l=1+a.filter(t=>t.Name==="All You Can Eat"||t.Name==="Double Helpings").length*.25,r=this.getCustomerCount(e)*l;let F=this.startingCards.reduce((t,d)=>t+d.DishValue,0);if(a.some(t=>t.Name==="Ice Cream")&&(this.startingCards.some(t=>t.DishType=Z.Dessert)||(F=(F+2)/2)),a.some(t=>t.Name==="Doughnut")&&(F=5),a.some(t=>t.Name==="Double Helpings")&&F&&(F+=3),Number.isNaN(r))debugger;if(Number.isNaN(F))debugger;const i=Es(this.playerCount),f=this.getBookingDeskCount(e),c=this.getBookingDeskMoney(e);return i*(r*F+f*c)}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let a;this.turbo?a=e-1:(a=Math.max(0,Math.floor((e-1)/3)),e>5&&a++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,a)]}return this._cardsByDay[e]}getBookingDeskCount(e,a=1){const l=Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e));if(this.getCardsByDay(e).some(t=>t.Name==="Herd Mentality"))return Math.min(l,3)+1;const r=[],F=this.getCardsByDay(e);let i=1;(this.turbo||F.some(t=>t.Name==="Morning Rush"))&&(r.push(.2),i++),(this.turbo||F.some(t=>t.Name==="Lunch Rush"))&&(r.push(.5),i++),(this.turbo||F.some(t=>t.Name==="Dinner Rush"))&&(r.push(.8),i++);const f=a/this.getDayLength(e),c=.1/l;for(let t=1;t<l;t++){const d=t/l,g=d-c-f,p=d+c+f;let x=!1;for(const T of r)if(g<=T&&p>=T){x=!0;break}x||i++}return i}getNonRushGroupCount(e){const a=this.getExpectedCustomers(e),l=this.getCardsByDay(e).filter(i=>i.Name==="Closing Time?").length*.2,r=this.getExpectedGroupSize(e),F=a*(1+l)/r;return Math.ceil(F)}getCustomerCount(e){return this.getGroupSizes(e).reduce((a,l)=>a+l,0)}getGroupSizes(e){const a=_e(1997821,e,this.seed).random,l=this.getNonRushGroupCount(e),r=this.getCardsByDay(e).some(p=>p.Name==="Herd Mentality");let F=l,i=[],[f,c]=this.getGroupSizeRange(e);{let p=F-1;for(;p--;)a.value}for(;F--;)i.push(a.range(f,c+1)),!r&&F!==l-1&&a.value;let t=this.turbo?3:this.getCardsByDay(e).filter(p=>p.Name.includes(" Rush")).length;const d=Math.ceil(Math.max(1,this.getExpectedCustomers(e)*.15));let g=t*d;for(;g--;)i.push(a.range(f,c+1));return i}getExpectedGroupSize(e){const a=this.getGroupSizeRange(e);return(a[0]+a[1])/2}getGroupSizeRange(e){let a=1,l=2;for(const r of this.getCardsByDay(e))switch(r.Name){case"Individual Dining":l--;break;case"Medium Groups":a++,l+=2;break;case"Large Groups":a+=2,l+=2;break;case"Flexible Dining":a--,l++;break;case"Community":const F=Math.floor((e-1)/3);a+=F,l+=F;break}return[a,l]}getExpectedCustomers(e){const a=this.getReductions(e),l=this.getDayLength(e),r=this.getPlayerModifier(),F=this.getCourseModifier(e),i=this.getDayRate(e),f=this.getCustomersPerHour(e),c=this.getAdvertisingModifier(e);return .85**a*(l/25*i*r)/F*f*c}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(l=>l.Name==="Advertising").length}getDayRate(e){let a=1;switch(e){case 1:a=1.25;break;case 2:a=1.5;break;default:a=1.5+.15*(e-3);break}return e>15&&(a+=(this.turbo?.1:0)*(e-15)**1.5),a}getCourseModifier(e){let a=1;const l=this.getCardsByDay(e);return l.some(r=>r.DishType===Z.Dessert||r.Name==="Black Coffee"||r.Name==="Cakes")&&(a+=.25),l.some(r=>r.DishType===Z.Starter)&&(a+=.25),a}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let a=1;return this.turbo&&(a=1.5,a*=1+e/10),a}getReductions(e){return this.getCardsByDay(e).reduce((l,r)=>l+r.CustomerMultiplier,0)}getMapSize(){const a=new he(this.seed,5078598).useSubcontext(0).random.range(0,8);let l;switch(a){case 0:l="Small (2)";break;case 4:l="Medium (2)";break;case 1:case 5:l="Diner (1)";break;case 2:case 6:l="Large (3)";break;case 3:case 7:l="Huge (4)";break;default:throw new Error}return l}getLayoutInfo(){const a=new he(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,r;switch(a){case 0:r=70,l=2;break;case 4:r=84,l=2;break;case 1:case 5:r=60,l=1;break;case 2:case 6:r=9*13,l=3;break;case 3:case 7:r=12*16,l=4;break;default:throw new Error}return[l,r]}getDoorInfo(){if(this.mapSize!=="Diner (1)")return-1;let e=new Ke(new he(this.seed,98234234).useSubcontext(0).random.value),a=23;for(;a--;)e.value;return e.range(0,4)}}function Es(s){switch(s){case 1:return 1.25;case 2:return 1.1;default:return 1}}function Hs(s,e,a,l){let r=[],F=[];const i=s.cards.slice(e);let f=new xs(s.seed,a,i);f.playerCount=l;for(let c=1;c<=15;c++)r.push(f.guessMoney(c)),F.push(f.getBookingDeskCount(c));return r[0]+=f.guessMoney(0),{expectedMoneyByDay:r,expectedBookingDesksByDay:F}}var Qe=self;function Os(s){Qe.postMessage(s)}const Gs=["Copying Desk","Blueprint Cabinet","Clipboard Stand","Research Desk"],qs=[{goal:"Copying Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Blueprint Cabinet",number:8,substitutes:[],skipMissing:!0},{goal:"Clipboard Stand",number:1,substitutes:[],skipMissing:!0},{goal:"Research Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Starter Bin",number:999,substitutes:Ce.filter(s=>!Gs.includes(s.Name)).map(s=>s.Name),skipMissing:!0}];Qe.onmessage=s=>{let{config:e,tiers:a,playerCount:l}=s.data;for(;!a.at(-1).length;)a.pop();const r=[...qs],F=a.flatMap(g=>g.flatMap(p=>[p.goal,...p.substitutes])),i=r.length-1;r[i].substitutes=r[i].substitutes.filter(g=>!F.some(p=>g===p)),a[a.length-1].push(...r);const f=e.cards.filter(g=>Ms.some(p=>p.Name===g.Name)).length+1,c=e.cards.slice(0,f);let{expectedMoneyByDay:t,expectedBookingDesksByDay:d}=Hs(e,f,c,l);Ns(e.seed,c,e.cards.slice(f).map(g=>g.Name),a,e.solo,t,d,Os)}})();
