...
-373772933,Simple Cloth Table,5,,,,,False,False,6`;const y=p.split(`\r
`).filter(e=>e).map(e=>{var B,N;const[s,a,r,l,n,t,o,c,F,h]=e.split(","),d=Number(s),S=Number(r),H=l!=null&&l.length?l.split(":").map(k=>Number(k)):[],L=n.length?n.split(":").map(k=>Number(k)):[],V=t!=null&&t.length?(B=t==null?void 0:t.split(":"))==null?void 0:B.map(k=>Number(k)):[],_=o!=null&&o.length?(N=o==null?void 0:o.split(":"))==null?void 0:N.map(k=>Number(k)):[],Q=c==="True",W=F==="True",Y=Number(h);return{ID:d,Name:a,UnlockGroup:S,Requires:H,BlockedBy:L,RequiredProcesses:V,IngredientProviders:_,isMain:Q,isStarterOrSide:W,DishType:Y}});function m(e,s=!0){const a=s&&e.some(r=>r.Name==="Community");return y.filter(r=>!(e.some(l=>l.ID===r.ID)||r.BlockedBy.some(l=>e.some(n=>n.ID===l))||r.Requires.some(l=>!e.some(n=>n.ID===l))||r.isStarterOrSide&&!e.some(l=>l.isMain)||!a&&r.DishType===u.Base)).sort((r,l)=>r.ID-l.ID)}i.Special,u.Null,i.Special,u.Null,i.Special,u.Null,y.filter(e=>e.Name==="Community")[0],i.Special,u.Null,i.Special,u.Null,["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>y.filter(s=>s.Name===e)[0]);class g{constructor(s,a){f(this,"fixedSeed");f(this,"instance");f(this,"random");typeof s=="string"&&(s=v(s)),this.fixedSeed=s,this.instance=a,this.random=new D(s+Math.imul(124192293,a))}useSubcontext(s){return new g(this.fixedSeed,124192293*s+this.instance)}}class D{constructor(s){f(this,"seed");const a=o=>Math.imul(1812433253,o)+1>>0,r=s>>0,l=a(r),n=a(l),t=a(n);this.seed=[r,l,n,t]}get value(){let s=this.seed.shift(),a=this.seed[2];return s^=s<<11,s^=s>>>8,a^=a>>>19,a=(a^s)>>0,this.seed.push(a),a}range(s,a){return(this.value>>>0)%(a-s)+s}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(s){return s[this.range(0,s.length)]}}function v(e){const a=new TextEncoder().encode(e);let r=5381,l=a.length;for(;l>0;){let n=--l;r=(r<<5)+r+a[n]}return r>>0}class C{constructor(){f(this,"encourageGroups",[i.Special])}GetOptions(s,a,r){const l=r.random;let n=0;for(a!==15&&(n=this.getPad(s,a));n--;)l.value;let t=this.sortCandidates(s,a,r.random);const[o,c]=this.getUnlockGroups(a);let F=null,h=null;for(const d of t)if(!(d.UnlockGroup!==o&&d.UnlockGroup!==c)&&(F===null||F.UnlockGroup!==o&&d.UnlockGroup===o?F=d:(h===null||h.UnlockGroup!==c&&d.UnlockGroup===c)&&(h=d),F&&F.UnlockGroup===o&&h&&h.UnlockGroup===c))break;return[F,h]}getPad(s,a){if(a===15)return 0;let r=m(s).length+1;return a===5&&(r*=2),r}sortCandidates(s,a,r){let l=m(s),n=P(l,r);return r.valueFloat<.5&&n.sort((o,c)=>{let F=0;return T(o)&&F--,T(c)&&F++,F}),n}getUnlockGroups(s){return s===15?[i.Franchise,i.Franchise]:s===5?[i.PrimaryTheme,i.PrimaryTheme]:[i.Dish,i.Generic]}}class w extends C{getPad(s,a){let r=m(s,!1).length+1;return a!==5&&(r*=2),r}sortCandidates(s,a,r){let l=m(s),n=P(l,r);return r.valueFloat<.1&&n.sort((o,c)=>{let F=0;return this.encourageGroups.includes(o.UnlockGroup)&&F--,this.encourageGroups.includes(c.UnlockGroup)&&F++,F}),n}}class G extends C{constructor(){super(...arguments);f(this,"ThanksgivingCards",["Turkey","Nut Roast"])}getPad(a,r){if(r===15)return 0;let l=m(a,!1).length+1;if(r===5){let n=m(a);l+=n.length+2}return l}sortCandidates(a,r,l){let n=r===5||r===15?m(a,!1):m(a),t=P(n,l);return l.valueFloat<.5&&t.sort((F,h)=>{let d=0;return T(F,!1)&&d--,T(h,!1)&&d++,d}),r!==5&&r!==15&&l.valueFloat<.25&&t.sort((h,d)=>{let S=0;return this.ThanksgivingCards.includes(h.Name)&&S++,this.ThanksgivingCards.includes(d.Name)&&S--,S}),t}getUnlockGroups(a){return a===15?[i.Franchise,i.Franchise]:a===5?[i.PrimaryTheme,i.PrimaryTheme]:[i.Dish,i.Dish]}}function P(e,s){return e.map(r=>[r,s.valueFloat]).sort((r,l)=>r[1]-l[1]).map(r=>r[0])}class R{constructor(s){f(this,"cards");f(this,"unlockPack");f(this,"seed");this.cards=[],this.unlockPack=new C,this.seed=s}addCard(s){if(s!==void 0){switch(s.Name){case"Community":this.unlockPack=new G;break;case"Turbo":this.unlockPack=new w;break}this.cards.push(s)}}getUnlockOptions(s){const r=x(848292,s,this.seed).useSubcontext(1);return this.unlockPack.GetOptions(this.cards,s,r)}getCustomers(s,a=1){return[]}getGroupSizeRange(s){if(this.cards.some(n=>n.Name==="Community")){const n=Math.floor((s-1)/3);return[n+1,n+2]}let r=1,l=2;return this.cards.some(n=>n.Name==="Individual Dining")?[1,1]:(this.cards.some(n=>n.Name==="Medium Groups")&&(r++,l+=2),this.cards.some(n=>n.Name==="Large Groups")&&(r+=2,l+=4),this.cards.some(n=>n.Name==="Flexible Groups")&&(r--,l++),[r,l])}}function x(e,s,a){return new g(a,e*1231231+s)}function T(e,s=!0){return e.UnlockGroup===i.Special||e.DishType===u.Main||e.DishType===u.Extra?!0:s?!!e.Requires.length:!1}const b="bdghjmqrtvwxy346789";function I(){let e="";for(;e.length<8;)e+=b[Math.floor(Math.random()*b.length)];return e}class E{constructor(s){f(this,"seed");f(this,"mapSize");this.seed=s,this.mapSize=this.getMapSize()}getMapSize(){const a=new g(this.seed,5078598).useSubcontext(0).random.range(0,4);let r;switch(a){case 0:r=2;break;case 1:r=1;break;case 2:r=3;break;case 3:r=4;break;default:throw new Error}return r}}const M=[3,5,6,9,12],U=self;U.onmessage=e=>{let s;switch(e.data.type){case"strict":s=O;break;case"flex":s=A;break;default:throw new Error}const{allowedTables:a,startingDishes:r,mapSettings:l}=e.data.data,n=[...r],t=new R("");for(const o of l)t.addCard(o);for(;n.length;){const o=I(),c=new E(o).getMapSize();if(!a.includes(c))continue;t.seed=o;const F=Math.floor(Math.random()*n.length);t.cards=[...l,n[F]],s(t)&&(z({seed:o,mapSize:c,startingDish:n[F].Name}),n.splice(F,1))}};function z(e){q({type:"result",data:e})}function q(e){postMessage(e)}function O(e){let s=[e.cards];for(let a=0;a<5;a++){const r=new Set;let l=[];for(const n of s){e.cards=n;debugger;const t=e.getUnlockOptions(M[a]);if(r.add(t[0].Name),r.add(t[1].Name),r.size>2)return!1;l.push([...n,t[0]]),l.push([...n,t[1]])}s=l}return!0}function A(e){let s=[e.cards];const a=new Set;for(let r=0;r<5;r++){let l=[];for(const n of s){e.cards=n;const t=e.getUnlockOptions(M[r]);if(a.add(t[0].Name),a.add(t[1].Name),a.size>10)return!1;l.push([...n,t[0]]),l.push([...n,t[1]])}s=l}return!0}})();
