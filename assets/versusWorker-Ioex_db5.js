var re=Object.defineProperty;var ae=(u,h,p)=>h in u?re(u,h,{enumerable:!0,configurable:!0,writable:!0,value:p}):u[h]=p;var g=(u,h,p)=>(ae(u,typeof h!="symbol"?h+"":h,p),p);(function(){"use strict";var u=(t=>(t[t.Generic=0]="Generic",t[t.Dish=1]="Dish",t[t.PrimaryTheme=3]="PrimaryTheme",t[t.SecondaryTheme=4]="SecondaryTheme",t[t.Franchise=5]="Franchise",t[t.Special=6]="Special",t))(u||{}),h=(t=>(t[t.Base=0]="Base",t[t.Main=1]="Main",t[t.Extra=2]="Extra",t[t.Side=3]="Side",t[t.Starter=4]="Starter",t[t.Dessert=5]="Dessert",t[t.Null=6]="Null",t))(h||{}),p=`373996608,Ice Cream,1,,,,-1533430406,False,False,5,1,2\r
...
`,A=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0,0,5\r
1356267749,Salad,1,2087693779,1193867305:-712909563:380220741,True,False,0,-1,5\r
550743424,Pizza,1,2087693779:-1706154991:-523839730,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0,0,5\r
367917843,Dumplings,1,1972879238:-523839730:2087693779,925796718:-484165118:-452101383:380220741,True,False,0,2,8\r
-1778969928,Burgers,1,1972879238,759552160:380220741:385684499,True,False,0,-2,3\r
...
`;const N=p.trim().split(`\r
`).filter(t=>t).map(t=>{var H,U;const[e,s,r,a,n,i,o,c,l,F,d,m]=t.split(","),T=Number(e),C=Number(r),v=a!=null&&a.length?a.split(":").map(k=>Number(k)):[],R=n.length?n.split(":").map(k=>Number(k)):[],w=i!=null&&i.length?(H=i==null?void 0:i.split(":"))==null?void 0:H.map(k=>Number(k)):[],x=o!=null&&o.length?(U=o==null?void 0:o.split(":"))==null?void 0:U.map(k=>Number(k)):[],G=c==="True",D=l==="True",M=Number(F),y=Number(d),se=Number(m);return{ID:T,Name:s,UnlockGroup:C,Requires:v,BlockedBy:R,RequiredProcesses:w,IngredientProviders:x,isMain:G,isStarterOrSide:D,DishType:M,CustomerMultiplier:y,DishValue:se}});function f(t,e=!0){const s=e&&t.some(r=>r.Name==="Community");return N.filter(r=>{if(t.some(a=>a.ID===r.ID)||r.BlockedBy.some(a=>t.some(n=>n.ID===a))||r.Requires.some(a=>!t.some(n=>n.ID===a)))return!1;if(r.isStarterOrSide)if(t.some(a=>a.isMain)){if(t.length&&t[0].DishType===h.Dessert)debugger}else return!1;return!(!s&&r.DishType===h.Base)}).sort((r,a)=>r.ID-a.ID)}[...[{ID:447437163,Name:"Country",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:h.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:h.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:h.Null,CustomerMultiplier:0,DishValue:0},N.filter(t=>t.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:h.Null,CustomerMultiplier:0,DishValue:0},{ID:1958825350,Name:"Turbo",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:h.Null,CustomerMultiplier:0,DishValue:0}]].sort((t,e)=>t.Name<e.Name?-1:1),["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(t=>N.filter(e=>e.Name===t)[0]),A.trim().split(`\r
`).filter(t=>t).map(t=>{var D,M;const[e,s,r,a,n,i,o,c,l,F]=t.split(","),d=Number(e),m=Number(r),T=a!=null&&a.length?(D=a==null?void 0:a.split(":"))==null?void 0:D.map(y=>Number(y)):[],C=n!=null&&n.length?(M=n==null?void 0:n.split(":"))==null?void 0:M.map(y=>Number(y)):[],v=i==="True",R=o==="True",w=Number(c),x=Number(l),G=Number(F);return{ID:d,Name:s,UnlockGroup:m,Requires:[],BlockedBy:[],RequiredProcesses:T,IngredientProviders:C,isMain:v,isStarterOrSide:R,DishType:w,CustomerMultiplier:x,DishValue:G}}).sort((t,e)=>t.Name<e.Name?-1:1);class S{constructor(e,s){g(this,"fixedSeed");g(this,"instance");g(this,"random");typeof e=="string"&&(e=L(e)),this.fixedSeed=e,this.instance=s,this.random=new z(e+Math.imul(124192293,s))}useSubcontext(e){return new S(this.fixedSeed,124192293*e+this.instance)}}class z{constructor(e){g(this,"seed");const s=o=>Math.imul(1812433253,o)+1>>0,r=e>>0,a=s(r),n=s(a),i=s(n);this.seed=[r,a,n,i]}get value(){let e=this.seed.shift(),s=this.seed[2];return e^=e<<11,e^=e>>>8,s^=s>>>19,s=(s^e)>>0,this.seed.push(s),s}range(e,s){return(this.value>>>0)%(s-e)+e}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(e){return e[this.range(0,e.length)]}}function L(t){const s=new TextEncoder().encode(t);let r=5381,a=s.length;for(;a--;)r=(r<<5)+r+s[a];return r>>0}function E(t,e,s){return new S(s,t*1231231+e)}class B{constructor(){g(this,"encourageGroups",[u.Special])}GetOptions(e,s,r){const a=r.random;let n=0;for(s!==15&&(n=this.getPad(e,s));n--;)a.value;let i=this.sortCandidates(e,s,r.random);const[o,c]=this.getUnlockGroups(s);let l=null,F=null;for(const d of i)if(!(d.UnlockGroup!==o&&d.UnlockGroup!==c)&&(l===null||l.UnlockGroup!==o&&d.UnlockGroup===o?l=d:(F===null||F.UnlockGroup!==c&&d.UnlockGroup===c)&&(F=d),l&&l.UnlockGroup===o&&F&&F.UnlockGroup===c))break;return[l,F]}getPad(e,s){if(s===15)return 0;let r=f(e).length+1;return s===5&&(r*=2),r}sortCandidates(e,s,r){let a=f(e),n=P(a,r);return r.valueFloat<.5&&n.sort((o,c)=>{let l=0;return b(o)&&l--,b(c)&&l++,l}),n}getUnlockGroups(e){return e===15?[u.Franchise,u.Franchise]:e===5?[u.PrimaryTheme,u.PrimaryTheme]:[u.Dish,u.Generic]}}class O extends B{getPad(e,s){let r=f(e,!1).length+1;return s!==5&&(r*=2),r}sortCandidates(e,s,r){let a=f(e),n=P(a,r);return r.valueFloat<.1&&n.sort((c,l)=>{let F=0;return c.Requires.length&&F--,l.Requires.length&&F++,F}),n}}class V extends B{constructor(){super(...arguments);g(this,"ThanksgivingCards",["Turkey","Nut Roast"])}getPad(s,r){if(r===15)return 0;let a=f(s,!1).length+1;if(r===5){let n=f(s);a+=n.length+2}return a}sortCandidates(s,r,a){let n=r===5||r===15?f(s,!1):f(s),i=P(n,a);return a.valueFloat<.5&&i.sort((l,F)=>{let d=0;return b(l,!1)&&d--,b(F,!1)&&d++,d}),r!==5&&r!==15&&a.valueFloat<.25&&i.sort((F,d)=>{let m=0;return this.ThanksgivingCards.includes(F.Name)&&m++,this.ThanksgivingCards.includes(d.Name)&&m--,m}),i}getUnlockGroups(s){return s===15?[u.Franchise,u.Franchise]:s===5?[u.PrimaryTheme,u.PrimaryTheme]:[u.Dish,u.Dish]}}function P(t,e){return t.map(r=>[r,e.valueFloat]).sort((r,a)=>r[1]-a[1]).map(r=>r[0])}class j{constructor(e){g(this,"cards");g(this,"unlockPack");g(this,"seed");this.cards=[],this.unlockPack=new B,this.seed=e}addCard(e){if(e!==void 0){switch(e.Name){case"Community":this.unlockPack=new V;break;case"Turbo":this.unlockPack=new O;break}this.cards.push(e)}}getUnlockOptions(e){const r=E(848292,e,this.seed).useSubcontext(1);return this.unlockPack.GetOptions(this.cards,e,r)}getCustomers(e,s=1){return[]}getGroupSizeRange(e){if(this.cards.some(n=>n.Name==="Community")){const n=Math.floor((e-1)/3);return[n+1,n+2]}let r=1,a=2;return this.cards.some(n=>n.Name==="Individual Dining")?[1,1]:(this.cards.some(n=>n.Name==="Medium Groups")&&(r++,a+=2),this.cards.some(n=>n.Name==="Large Groups")&&(r+=2,a+=4),this.cards.some(n=>n.Name==="Flexible Groups")&&(r--,a++),[r,a])}}function b(t,e=!0){return t.UnlockGroup===u.Special||t.DishType===h.Main||t.DishType===h.Extra?!0:e?!!t.Requires.length:!1}const I="bdghjmqrtvwxy346789",_="1c,1d,1e,1f,1g,1h,1i,1j,1k,1l,1m,1n,1o,1p,1q,1r,1s,1t,1u,1v,1w,1x,1y,1z,13,14,15,16,17,18,19,2c,2d,2e,2f,2g,2h,2i,2j,2k,2l,2m,2n,2o,2p,2q,2r,2s,2t,2u,2v,2w,2x,2y,2z,23,24,25,26,27,28,29,3c,3d,3e,3f,3g,3h,3i,3j,3k,3l,3m,3n,3o,3p,3q,3r,3s,3t,3u,3v,3w,3x,3y,3z,33,34,35,36,37,38,39,4c,4d,4e,4f,4g,4h,4i,4j,4k,4l,4m,4n,4o,4p,4q,4r,4s,4t,4u,4v,4w,4x,4y,4z,43,44,45,46,47,48,49,5c,5d,5e,5f,5g,5h,5i,5j,5k,5l,5m,5n,5o,5p,5q,5r,5s,5t,5u,5v,5w,5x,5y,5z,53,54,55,56,57,58,59,6c,6d,6e,6f,6g,6h,6i,6j,6k,6l,6m,6n,6o,6p,6q,6r,6s,6t,6u,6v,6w,6x,6y,6z,63,64,65,66,67,68,69,7c,7d,7e,7f,7g,7h,7i,7j,7k,7l,7m,7n,7o,7p,7q,7r,7s,7t,7u,7v,7w,7x,7y,7z,73,74,75,76,77,78,79,8c,8d,8e,8f,8g,8h,8i,8j,8k,8l,8m,8n,8o,8p,8q,8r,8s,8t,8u,8v,8w,8x,8y,8z,83,84,85,86,87,88,89".split(",");for(const t of _);function W(){let t="";for(;t.length<8;)t+=I[Math.floor(Math.random()*I.length)];return t}const Q={"Diner (1)":1,"Small (2)":2,"Medium (2)":2,"Large (3)":3,"Huge (4)":4};class Y{constructor(e,s=[],r=[]){g(this,"seed");g(this,"mapSize");g(this,"frontDoor");g(this,"startingCards");g(this,"cards");g(this,"playerCount");g(this,"turbo");g(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=s,this.cards=r,this.playerCount=Q[this.mapSize],this.turbo=this.startingCards.some(a=>{if(a===void 0){console.log({startingCards:s});debugger}return a.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const s=this.getCardsByDay(e),r=1+s.filter(l=>l.Name==="All You Can Eat"||l.Name==="Double Helpings").length*.25,a=this.getCustomerCount(e)*r;let n=this.startingCards.reduce((l,F)=>l+F.DishValue,0);if(s.some(l=>l.Name==="Ice Cream")&&(this.startingCards.some(l=>l.DishType=h.Dessert)||(n=(n+2)/2)),s.some(l=>l.Name==="Doughnut")&&(n=5),s.some(l=>l.Name==="Double Helpings")&&n&&(n+=3),Number.isNaN(a))debugger;if(Number.isNaN(n))debugger;const i=J(this.playerCount),o=this.getBookingDeskCount(e),c=this.getBookingDeskMoney(e);return i*(a*n+o*c)}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let s;this.turbo?s=e-1:(s=Math.max(0,Math.floor((e-1)/3)),e>5&&s++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,s)]}return this._cardsByDay[e]}getBookingDeskCount(e,s=1){const r=Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e));if(this.getCardsByDay(e).some(l=>l.Name==="Herd Mentality"))return Math.min(r,3)+1;const a=[],n=this.getCardsByDay(e);let i=1;(this.turbo||n.some(l=>l.Name==="Morning Rush"))&&(a.push(.2),i++),(this.turbo||n.some(l=>l.Name==="Lunch Rush"))&&(a.push(.5),i++),(this.turbo||n.some(l=>l.Name==="Dinner Rush"))&&(a.push(.8),i++);const o=s/this.getDayLength(e),c=.1/r;for(let l=1;l<r;l++){const F=l/r,d=F-c-o,m=F+c+o;let T=!1;for(const C of a)if(d<=C&&m>=C){T=!0;break}T||i++}return i}getNonRushGroupCount(e){const s=this.getExpectedCustomers(e),r=this.getCardsByDay(e).filter(i=>i.Name==="Closing Time?").length*.2,a=this.getExpectedGroupSize(e),n=s*(1+r)/a;return Math.ceil(n)}getCustomerCount(e){return this.getGroupSizes(e).reduce((s,r)=>s+r,0)}getGroupSizes(e){const s=E(1997821,e,this.seed).random,r=this.getNonRushGroupCount(e),a=this.getCardsByDay(e).some(m=>m.Name==="Herd Mentality");let n=r,i=[],[o,c]=this.getGroupSizeRange(e);{let m=n-1;for(;m--;)s.value}for(;n--;)i.push(s.range(o,c+1)),!a&&n!==r-1&&s.value;let l=this.turbo?3:this.getCardsByDay(e).filter(m=>m.Name.includes(" Rush")).length;const F=Math.ceil(Math.max(1,this.getExpectedCustomers(e)*.15));let d=l*F;for(;d--;)i.push(s.range(o,c+1));return i}getExpectedGroupSize(e){const s=this.getGroupSizeRange(e);return(s[0]+s[1])/2}getGroupSizeRange(e){let s=1,r=2;for(const a of this.getCardsByDay(e))switch(a.Name){case"Individual Dining":r--;break;case"Medium Groups":s++,r+=2;break;case"Large Groups":s+=2,r+=2;break;case"Flexible Dining":s--,r++;break;case"Community":const n=Math.floor((e-1)/3);s+=n,r+=n;break}return[s,r]}getExpectedCustomers(e){const s=this.getReductions(e),r=this.getDayLength(e),a=this.getPlayerModifier(),n=this.getCourseModifier(e),i=this.getDayRate(e),o=this.getCustomersPerHour(e),c=this.getAdvertisingModifier(e);return .85**s*(r/25*i*a)/n*o*c}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(r=>r.Name==="Advertising").length}getDayRate(e){let s=1;switch(e){case 1:s=1.25;break;case 2:s=1.5;break;default:s=1.5+.15*(e-3);break}return e>15&&(s+=(this.turbo?.1:0)*(e-15)**1.5),s}getCourseModifier(e){let s=1;const r=this.getCardsByDay(e);return r.some(a=>a.DishType===h.Dessert||a.Name==="Black Coffee"||a.Name==="Cakes")&&(s+=.25),r.some(a=>a.DishType===h.Starter)&&(s+=.25),s}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let s=1;return this.turbo&&(s=1.5,s*=1+e/10),s}getReductions(e){return this.getCardsByDay(e).reduce((r,a)=>r+a.CustomerMultiplier,0)}getMapSize(){const s=new S(this.seed,5078598).useSubcontext(0).random.range(0,8);let r;switch(s){case 0:r="Small (2)";break;case 4:r="Medium (2)";break;case 1:case 5:r="Diner (1)";break;case 2:case 6:r="Large (3)";break;case 3:case 7:r="Huge (4)";break;default:throw new Error}return r}getLayoutInfo(){const s=new S(this.seed,5078598).useSubcontext(0).random.range(0,8);let r,a;switch(s){case 0:a=70,r=2;break;case 4:a=84,r=2;break;case 1:case 5:a=60,r=1;break;case 2:case 6:a=9*13,r=3;break;case 3:case 7:a=12*16,r=4;break;default:throw new Error}return[r,a]}getDoorInfo(){if(this.mapSize!=="Diner (1)")return-1;let e=new z(new S(this.seed,98234234).useSubcontext(0).random.value),s=23;for(;s--;)e.value;return e.range(0,4)}}function J(t){switch(t){case 1:return 1.25;case 2:return 1.1;default:return 1}}const q=[3,5,6,9,12],Z=self;Z.onmessage=t=>{let e;switch(t.data.type){case"strict":e=$;break;case"flex":e=ee;break;default:throw new Error}const{allowedTables:s,startingDishes:r,mapSettings:a}=t.data.data,n=[...r],i=new j("");for(const o of a)i.addCard(o);for(;n.length;){const o=W(),c=new Y(o).getMapSize();if(!s.includes(c))continue;i.seed=o;const l=Math.floor(Math.random()*n.length);i.cards=[...a,n[l]],e(i)&&(K({seed:o,mapSize:c,startingDish:n[l].Name}),n.splice(l,1))}};function K(t){X({type:"result",data:t})}function X(t){postMessage(t)}function $(t){let e=[t.cards];for(let s=0;s<5;s++){const r=new Set;let a=[];for(const n of e){t.cards=n;debugger;const i=t.getUnlockOptions(q[s]);if(r.add(i[0].Name),r.add(i[1].Name),r.size>2)return!1;a.push([...n,i[0]]),a.push([...n,i[1]])}e=a}return!0}function ee(t){let e=[t.cards];const s=new Set;for(let r=0;r<5;r++){let a=[];for(const n of e){t.cards=n;const i=t.getUnlockOptions(q[r]);if(s.add(i[0].Name),s.add(i[1].Name),s.size>10)return!1;a.push([...n,i[0]]),a.push([...n,i[1]])}e=a}return!0}})();
