var Je=Object.defineProperty;var Qe=(e,a,s)=>a in e?Je(e,a,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[a]=s;var y=(e,a,s)=>(Qe(e,typeof a!="symbol"?a+"":a,s),s);(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))l(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&l(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function l(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();var V,p,Ee,M,ie,Oe,Q,D={},De=[],Xe=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,G=Array.isArray;function w(e,a){for(var s in a)e[s]=a[s];return e}function Ie(e){var a=e.parentNode;a&&a.removeChild(e)}function X(e,a,s){var l,n,r,i={};for(r in a)r=="key"?l=a[r]:r=="ref"?n=a[r]:i[r]=a[r];if(arguments.length>2&&(i.children=arguments.length>3?V.call(arguments,2):s),typeof e=="function"&&e.defaultProps!=null)for(r in e.defaultProps)i[r]===void 0&&(i[r]=e.defaultProps[r]);return U(e,i,l,n,null)}function U(e,a,s,l,n){var r={type:e,props:a,key:s,ref:l,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,constructor:void 0,__v:n??++Ee,__i:-1,__u:0};return n==null&&p.vnode!=null&&p.vnode(r),r}function x(e){return e.children}function P(e,a){this.props=e,this.context=a}function N(e,a){if(a==null)return e.__?N(e.__,e.__i+1):null;for(var s;a<e.__k.length;a++)if((s=e.__k[a])!=null&&s.__e!=null)return s.__e;return typeof e.type=="function"?N(e):null}function ze(e){var a,s;if((e=e.__)!=null&&e.__c!=null){for(e.__e=e.__c.base=null,a=0;a<e.__k.length;a++)if((s=e.__k[a])!=null&&s.__e!=null){e.__e=e.__c.base=s.__e;break}return ze(e)}}function ue(e){(!e.__d&&(e.__d=!0)&&M.push(e)&&!L.__r++||ie!==p.debounceRendering)&&((ie=p.debounceRendering)||Oe)(L)}function L(){var e,a,s,l,n,r,i,u,t;for(M.sort(Q);e=M.shift();)e.__d&&(a=M.length,l=void 0,r=(n=(s=e).__v).__e,u=[],t=[],(i=s.__P)&&((l=w({},n)).__v=n.__v+1,p.vnode&&p.vnode(l),ne(i,l,n,s.__n,i.ownerSVGElement!==void 0,32&n.__u?[r]:null,u,r??N(n),!!(32&n.__u),t),l.__.__k[l.__i]=l,$e(u,l,t),l.__e!=r&&ze(l)),M.length>a&&M.sort(Q));L.__r=0}function He(e,a,s,l,n,r,i,u,t,o,c){var F,m,_,T,S,d=l&&l.__k||De,f=a.length;for(s.__d=t,ea(s,a,d),t=s.__d,F=0;F<f;F++)(_=s.__k[F])!=null&&typeof _!="boolean"&&typeof _!="function"&&(m=_.__i===-1?D:d[_.__i]||D,_.__i=F,ne(e,_,m,n,r,i,u,t,o,c),T=_.__e,_.ref&&m.ref!=_.ref&&(m.ref&&Fe(m.ref,null,_),c.push(_.ref,_.__c||T,_)),S==null&&T!=null&&(S=T),65536&_.__u||m.__k===_.__k?t=Ue(_,t,e):typeof _.type=="function"&&_.__d!==void 0?t=_.__d:T&&(t=T.nextSibling),_.__d=void 0,_.__u&=-196609);s.__d=t,s.__e=S}function ea(e,a,s){var l,n,r,i,u,t=a.length,o=s.length,c=o,F=0;for(e.__k=[],l=0;l<t;l++)(n=e.__k[l]=(n=a[l])==null||typeof n=="boolean"||typeof n=="function"?null:typeof n=="string"||typeof n=="number"||typeof n=="bigint"||n.constructor==String?U(null,n,null,null,n):G(n)?U(x,{children:n},null,null,null):n.__b>0?U(n.type,n.props,n.key,n.ref?n.ref:null,n.__v):n)!=null?(n.__=e,n.__b=e.__b+1,u=aa(n,s,i=l+F,c),n.__i=u,r=null,u!==-1&&(c--,(r=s[u])&&(r.__u|=131072)),r==null||r.__v===null?(u==-1&&F--,typeof n.type!="function"&&(n.__u|=65536)):u!==i&&(u===i+1?F++:u>i?c>t-i?F+=u-i:F--:F=u<i&&u==i-1?u-i:0,u!==l+F&&(n.__u|=65536))):(r=s[l])&&r.key==null&&r.__e&&(r.__e==e.__d&&(e.__d=N(r)),ee(r,r,!1),s[l]=null,c--);if(c)for(l=0;l<o;l++)(r=s[l])!=null&&!(131072&r.__u)&&(r.__e==e.__d&&(e.__d=N(r)),ee(r,r))}function Ue(e,a,s){var l,n;if(typeof e.type=="function"){for(l=e.__k,n=0;l&&n<l.length;n++)l[n]&&(l[n].__=e,a=Ue(l[n],a,s));return a}return e.__e!=a&&(s.insertBefore(e.__e,a||null),a=e.__e),a&&a.nextSibling}function q(e,a){return a=a||[],e==null||typeof e=="boolean"||(G(e)?e.some(function(s){q(s,a)}):a.push(e)),a}function aa(e,a,s,l){var n=e.key,r=e.type,i=s-1,u=s+1,t=a[s];if(t===null||t&&n==t.key&&r===t.type)return s;if(l>(t!=null&&!(131072&t.__u)?1:0))for(;i>=0||u<a.length;){if(i>=0){if((t=a[i])&&!(131072&t.__u)&&n==t.key&&r===t.type)return i;i--}if(u<a.length){if((t=a[u])&&!(131072&t.__u)&&n==t.key&&r===t.type)return u;u++}}return-1}function _e(e,a,s){a[0]==="-"?e.setProperty(a,s??""):e[a]=s==null?"":typeof s!="number"||Xe.test(a)?s:s+"px"}function z(e,a,s,l,n){var r;e:if(a==="style")if(typeof s=="string")e.style.cssText=s;else{if(typeof l=="string"&&(e.style.cssText=l=""),l)for(a in l)s&&a in s||_e(e.style,a,"");if(s)for(a in s)l&&s[a]===l[a]||_e(e.style,a,s[a])}else if(a[0]==="o"&&a[1]==="n")r=a!==(a=a.replace(/(PointerCapture)$|Capture$/,"$1")),a=a.toLowerCase()in e?a.toLowerCase().slice(2):a.slice(2),e.l||(e.l={}),e.l[a+r]=s,s?l?s.u=l.u:(s.u=Date.now(),e.addEventListener(a,r?fe:ce,r)):e.removeEventListener(a,r?fe:ce,r);else{if(n)a=a.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(a!=="width"&&a!=="height"&&a!=="href"&&a!=="list"&&a!=="form"&&a!=="tabIndex"&&a!=="download"&&a!=="rowSpan"&&a!=="colSpan"&&a!=="role"&&a in e)try{e[a]=s??"";break e}catch{}typeof s=="function"||(s==null||s===!1&&a[4]!=="-"?e.removeAttribute(a):e.setAttribute(a,s))}}function ce(e){var a=this.l[e.type+!1];if(e.t){if(e.t<=a.u)return}else e.t=Date.now();return a(p.event?p.event(e):e)}function fe(e){return this.l[e.type+!0](p.event?p.event(e):e)}function ne(e,a,s,l,n,r,i,u,t,o){var c,F,m,_,T,S,d,f,h,v,C,R,j,O,K,k=a.type;if(a.constructor!==void 0)return null;128&s.__u&&(t=!!(32&s.__u),r=[u=a.__e=s.__e]),(c=p.__b)&&c(a);e:if(typeof k=="function")try{if(f=a.props,h=(c=k.contextType)&&l[c.__c],v=c?h?h.props.value:c.__:l,s.__c?d=(F=a.__c=s.__c).__=F.__E:("prototype"in k&&k.prototype.render?a.__c=F=new k(f,v):(a.__c=F=new P(f,v),F.constructor=k,F.render=la),h&&h.sub(F),F.props=f,F.state||(F.state={}),F.context=v,F.__n=l,m=F.__d=!0,F.__h=[],F._sb=[]),F.__s==null&&(F.__s=F.state),k.getDerivedStateFromProps!=null&&(F.__s==F.state&&(F.__s=w({},F.__s)),w(F.__s,k.getDerivedStateFromProps(f,F.__s))),_=F.props,T=F.state,F.__v=a,m)k.getDerivedStateFromProps==null&&F.componentWillMount!=null&&F.componentWillMount(),F.componentDidMount!=null&&F.__h.push(F.componentDidMount);else{if(k.getDerivedStateFromProps==null&&f!==_&&F.componentWillReceiveProps!=null&&F.componentWillReceiveProps(f,v),!F.__e&&(F.shouldComponentUpdate!=null&&F.shouldComponentUpdate(f,F.__s,v)===!1||a.__v===s.__v)){for(a.__v!==s.__v&&(F.props=f,F.state=F.__s,F.__d=!1),a.__e=s.__e,a.__k=s.__k,a.__k.forEach(function(I){I&&(I.__=a)}),C=0;C<F._sb.length;C++)F.__h.push(F._sb[C]);F._sb=[],F.__h.length&&i.push(F);break e}F.componentWillUpdate!=null&&F.componentWillUpdate(f,F.__s,v),F.componentDidUpdate!=null&&F.__h.push(function(){F.componentDidUpdate(_,T,S)})}if(F.context=v,F.props=f,F.__P=e,F.__e=!1,R=p.__r,j=0,"prototype"in k&&k.prototype.render){for(F.state=F.__s,F.__d=!1,R&&R(a),c=F.render(F.props,F.state,F.context),O=0;O<F._sb.length;O++)F.__h.push(F._sb[O]);F._sb=[]}else do F.__d=!1,R&&R(a),c=F.render(F.props,F.state,F.context),F.state=F.__s;while(F.__d&&++j<25);F.state=F.__s,F.getChildContext!=null&&(l=w(w({},l),F.getChildContext())),m||F.getSnapshotBeforeUpdate==null||(S=F.getSnapshotBeforeUpdate(_,T)),He(e,G(K=c!=null&&c.type===x&&c.key==null?c.props.children:c)?K:[K],a,s,l,n,r,i,u,t,o),F.base=a.__e,a.__u&=-161,F.__h.length&&i.push(F),d&&(F.__E=F.__=null)}catch(I){a.__v=null,t||r!=null?(a.__e=u,a.__u|=t?160:32,r[r.indexOf(u)]=null):(a.__e=s.__e,a.__k=s.__k),p.__e(I,a,s)}else r==null&&a.__v===s.__v?(a.__k=s.__k,a.__e=s.__e):a.__e=sa(s.__e,a,s,l,n,r,i,t,o);(c=p.diffed)&&c(a)}function $e(e,a,s){a.__d=void 0;for(var l=0;l<s.length;l++)Fe(s[l],s[++l],s[++l]);p.__c&&p.__c(a,e),e.some(function(n){try{e=n.__h,n.__h=[],e.some(function(r){r.call(n)})}catch(r){p.__e(r,n.__v)}})}function sa(e,a,s,l,n,r,i,u,t){var o,c,F,m,_,T,S,d=s.props,f=a.props,h=a.type;if(h==="svg"&&(n=!0),r!=null){for(o=0;o<r.length;o++)if((_=r[o])&&"setAttribute"in _==!!h&&(h?_.localName===h:_.nodeType===3)){e=_,r[o]=null;break}}if(e==null){if(h===null)return document.createTextNode(f);e=n?document.createElementNS("http://www.w3.org/2000/svg",h):document.createElement(h,f.is&&f),r=null,u=!1}if(h===null)d===f||u&&e.data===f||(e.data=f);else{if(r=r&&V.call(e.childNodes),d=s.props||D,!u&&r!=null)for(d={},o=0;o<e.attributes.length;o++)d[(_=e.attributes[o]).name]=_.value;for(o in d)_=d[o],o=="children"||(o=="dangerouslySetInnerHTML"?F=_:o==="key"||o in f||z(e,o,null,_,n));for(o in f)_=f[o],o=="children"?m=_:o=="dangerouslySetInnerHTML"?c=_:o=="value"?T=_:o=="checked"?S=_:o==="key"||u&&typeof _!="function"||d[o]===_||z(e,o,_,d[o],n);if(c)u||F&&(c.__html===F.__html||c.__html===e.innerHTML)||(e.innerHTML=c.__html),a.__k=[];else if(F&&(e.innerHTML=""),He(e,G(m)?m:[m],a,s,l,n&&h!=="foreignObject",r,i,r?r[0]:s.__k&&N(s,0),u,t),r!=null)for(o=r.length;o--;)r[o]!=null&&Ie(r[o]);u||(o="value",T!==void 0&&(T!==e[o]||h==="progress"&&!T||h==="option"&&T!==d[o])&&z(e,o,T,d[o],!1),o="checked",S!==void 0&&S!==e[o]&&z(e,o,S,d[o],!1))}return e}function Fe(e,a,s){try{typeof e=="function"?e(a):e.current=a}catch(l){p.__e(l,s)}}function ee(e,a,s){var l,n;if(p.unmount&&p.unmount(e),(l=e.ref)&&(l.current&&l.current!==e.__e||Fe(l,null,a)),(l=e.__c)!=null){if(l.componentWillUnmount)try{l.componentWillUnmount()}catch(r){p.__e(r,a)}l.base=l.__P=null,e.__c=void 0}if(l=e.__k)for(n=0;n<l.length;n++)l[n]&&ee(l[n],a,s||typeof e.type!="function");s||e.__e==null||Ie(e.__e),e.__=e.__e=e.__d=void 0}function la(e,a,s){return this.constructor(e,s)}function ra(e,a,s){var l,n,r,i;p.__&&p.__(e,a),n=(l=typeof s=="function")?null:s&&s.__k||a.__k,r=[],i=[],ne(a,e=(!l&&s||a).__k=X(x,null,[e]),n||D,D,a.ownerSVGElement!==void 0,!l&&s?[s]:n?null:a.firstChild?V.call(a.childNodes):null,r,!l&&s?s:n?n.__e:a.firstChild,l,i),$e(r,e,i)}V=De.slice,p={__e:function(e,a,s,l){for(var n,r,i;a=a.__;)if((n=a.__c)&&!n.__)try{if((r=n.constructor)&&r.getDerivedStateFromError!=null&&(n.setState(r.getDerivedStateFromError(e)),i=n.__d),n.componentDidCatch!=null&&(n.componentDidCatch(e,l||{}),i=n.__d),i)return n.__E=n}catch(u){e=u}throw e}},Ee=0,P.prototype.setState=function(e,a){var s;s=this.__s!=null&&this.__s!==this.state?this.__s:this.__s=w({},this.state),typeof e=="function"&&(e=e(w({},s),this.props)),e&&w(s,e),e!=null&&this.__v&&(a&&this._sb.push(a),ue(this))},P.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),ue(this))},P.prototype.render=x,M=[],Oe=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Q=function(e,a){return e.__v.__b-a.__v.__b},L.__r=0;var ae,b,Y,de,se=0,We=[],$=[],pe=p.__b,he=p.__r,me=p.diffed,ve=p.__c,Te=p.unmount;function na(e,a){p.__h&&p.__h(b,e,se||a),se=0;var s=b.__H||(b.__H={__:[],__h:[]});return e>=s.__.length&&s.__.push({__V:$}),s.__[e]}function Z(e){return se=1,Fa(Le,e)}function Fa(e,a,s){var l=na(ae++,2);if(l.t=e,!l.__c&&(l.__=[s?s(a):Le(void 0,a),function(u){var t=l.__N?l.__N[0]:l.__[0],o=l.t(t,u);t!==o&&(l.__N=[o,l.__[1]],l.__c.setState({}))}],l.__c=b,!b.u)){var n=function(u,t,o){if(!l.__c.__H)return!0;var c=l.__c.__H.__.filter(function(m){return m.__c});if(c.every(function(m){return!m.__N}))return!r||r.call(this,u,t,o);var F=!1;return c.forEach(function(m){if(m.__N){var _=m.__[0];m.__=m.__N,m.__N=void 0,_!==m.__[0]&&(F=!0)}}),!(!F&&l.__c.props===u)&&(!r||r.call(this,u,t,o))};b.u=!0;var r=b.shouldComponentUpdate,i=b.componentWillUpdate;b.componentWillUpdate=function(u,t,o){if(this.__e){var c=r;r=void 0,n(u,t,o),r=c}i&&i.call(this,u,t,o)},b.shouldComponentUpdate=n}return l.__N||l.__}function ta(){for(var e;e=We.shift();)if(e.__P&&e.__H)try{e.__H.__h.forEach(W),e.__H.__h.forEach(le),e.__H.__h=[]}catch(a){e.__H.__h=[],p.__e(a,e.__v)}}p.__b=function(e){b=null,pe&&pe(e)},p.__r=function(e){he&&he(e),ae=0;var a=(b=e.__c).__H;a&&(Y===b?(a.__h=[],b.__h=[],a.__.forEach(function(s){s.__N&&(s.__=s.__N),s.__V=$,s.__N=s.i=void 0})):(a.__h.forEach(W),a.__h.forEach(le),a.__h=[],ae=0)),Y=b},p.diffed=function(e){me&&me(e);var a=e.__c;a&&a.__H&&(a.__H.__h.length&&(We.push(a)!==1&&de===p.requestAnimationFrame||((de=p.requestAnimationFrame)||oa)(ta)),a.__H.__.forEach(function(s){s.i&&(s.__H=s.i),s.__V!==$&&(s.__=s.__V),s.i=void 0,s.__V=$})),Y=b=null},p.__c=function(e,a){a.some(function(s){try{s.__h.forEach(W),s.__h=s.__h.filter(function(l){return!l.__||le(l)})}catch(l){a.some(function(n){n.__h&&(n.__h=[])}),a=[],p.__e(l,s.__v)}}),ve&&ve(e,a)},p.unmount=function(e){Te&&Te(e);var a,s=e.__c;s&&s.__H&&(s.__H.__.forEach(function(l){try{W(l)}catch(n){a=n}}),s.__H=void 0,a&&p.__e(a,s.__v))};var ge=typeof requestAnimationFrame=="function";function oa(e){var a,s=function(){clearTimeout(l),ge&&cancelAnimationFrame(a),setTimeout(e)},l=setTimeout(s,100);ge&&(a=requestAnimationFrame(s))}function W(e){var a=b,s=e.__c;typeof s=="function"&&(e.__c=void 0,s()),b=a}function le(e){var a=b;e.__c=e.__(),b=a}function Le(e,a){return typeof a=="function"?a(e):a}function ia(e,a){for(var s in a)e[s]=a[s];return e}function be(e,a){for(var s in e)if(s!=="__source"&&!(s in a))return!0;for(var l in a)if(l!=="__source"&&e[l]!==a[l])return!0;return!1}function ye(e){this.props=e}(ye.prototype=new P).isPureReactComponent=!0,ye.prototype.shouldComponentUpdate=function(e,a){return be(this.props,e)||be(this.state,a)};var Se=p.__b;p.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),Se&&Se(e)};var ua=p.__e;p.__e=function(e,a,s,l){if(e.then){for(var n,r=a;r=r.__;)if((n=r.__c)&&n.__c)return a.__e==null&&(a.__e=s.__e,a.__k=s.__k),n.__c(e,a)}ua(e,a,s,l)};var ke=p.unmount;function qe(e,a,s){return e&&(e.__c&&e.__c.__H&&(e.__c.__H.__.forEach(function(l){typeof l.__c=="function"&&l.__c()}),e.__c.__H=null),(e=ia({},e)).__c!=null&&(e.__c.__P===s&&(e.__c.__P=a),e.__c=null),e.__k=e.__k&&e.__k.map(function(l){return qe(l,a,s)})),e}function Ve(e,a,s){return e&&s&&(e.__v=null,e.__k=e.__k&&e.__k.map(function(l){return Ve(l,a,s)}),e.__c&&e.__c.__P===a&&(e.__e&&s.appendChild(e.__e),e.__c.__e=!0,e.__c.__P=s)),e}function J(){this.__u=0,this.t=null,this.__b=null}function Ge(e){var a=e.__.__c;return a&&a.__a&&a.__a(e)}function H(){this.u=null,this.o=null}p.unmount=function(e){var a=e.__c;a&&a.__R&&a.__R(),a&&32&e.__u&&(e.type=null),ke&&ke(e)},(J.prototype=new P).__c=function(e,a){var s=a.__c,l=this;l.t==null&&(l.t=[]),l.t.push(s);var n=Ge(l.__v),r=!1,i=function(){r||(r=!0,s.__R=null,n?n(u):u())};s.__R=i;var u=function(){if(!--l.__u){if(l.state.__a){var t=l.state.__a;l.__v.__k[0]=Ve(t,t.__c.__P,t.__c.__O)}var o;for(l.setState({__a:l.__b=null});o=l.t.pop();)o.forceUpdate()}};l.__u++||32&a.__u||l.setState({__a:l.__b=l.__v.__k[0]}),e.then(i,i)},J.prototype.componentWillUnmount=function(){this.t=[]},J.prototype.render=function(e,a){if(this.__b){if(this.__v.__k){var s=document.createElement("div"),l=this.__v.__k[0].__c;this.__v.__k[0]=qe(this.__b,s,l.__O=l.__P)}this.__b=null}var n=a.__a&&X(x,null,e.fallback);return n&&(n.__u&=-33),[X(x,null,a.__a?null:e.children),n]};var Ce=function(e,a,s){if(++s[1]===s[0]&&e.o.delete(a),e.props.revealOrder&&(e.props.revealOrder[0]!=="t"||!e.o.size))for(s=e.u;s;){for(;s.length>3;)s.pop()();if(s[1]<s[0])break;e.u=s=s[2]}};(H.prototype=new P).__a=function(e){var a=this,s=Ge(a.__v),l=a.o.get(e);return l[0]++,function(n){var r=function(){a.props.revealOrder?(l.push(n),Ce(a,e,l)):n()};s?s(r):r()}},H.prototype.render=function(e){this.u=null,this.o=new Map;var a=q(e.children);e.revealOrder&&e.revealOrder[0]==="b"&&a.reverse();for(var s=a.length;s--;)this.o.set(a[s],this.u=[1,0,this.u]);return e.children},H.prototype.componentDidUpdate=H.prototype.componentDidMount=function(){var e=this;this.o.forEach(function(a,s){Ce(e,s,a)})};var _a=typeof Symbol<"u"&&Symbol.for&&Symbol.for("react.element")||60103,ca=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,fa=/^on(Ani|Tra|Tou|BeforeInp|Compo)/,da=/[A-Z0-9]/g,pa=typeof document<"u",ha=function(e){return(typeof Symbol<"u"&&typeof Symbol()=="symbol"?/fil|che|rad/:/fil|che|ra/).test(e)};P.prototype.isReactComponent={},["componentWillMount","componentWillReceiveProps","componentWillUpdate"].forEach(function(e){Object.defineProperty(P.prototype,e,{configurable:!0,get:function(){return this["UNSAFE_"+e]},set:function(a){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:a})}})});var Pe=p.event;function ma(){}function va(){return this.cancelBubble}function Ta(){return this.defaultPrevented}p.event=function(e){return Pe&&(e=Pe(e)),e.persist=ma,e.isPropagationStopped=va,e.isDefaultPrevented=Ta,e.nativeEvent=e};var ga={enumerable:!1,configurable:!0,get:function(){return this.class}},we=p.vnode;p.vnode=function(e){typeof e.type=="string"&&function(a){var s=a.props,l=a.type,n={};for(var r in s){var i=s[r];if(!(r==="value"&&"defaultValue"in s&&i==null||pa&&r==="children"&&l==="noscript"||r==="class"||r==="className")){var u=r.toLowerCase();r==="defaultValue"&&"value"in s&&s.value==null?r="value":r==="download"&&i===!0?i="":u==="ondoubleclick"?r="ondblclick":u!=="onchange"||l!=="input"&&l!=="textarea"||ha(s.type)?u==="onfocus"?r="onfocusin":u==="onblur"?r="onfocusout":fa.test(r)?r=u:l.indexOf("-")===-1&&ca.test(r)?r=r.replace(da,"-$&").toLowerCase():i===null&&(i=void 0):u=r="oninput",u==="oninput"&&n[r=u]&&(r="oninputCapture"),n[r]=i}}l=="select"&&n.multiple&&Array.isArray(n.value)&&(n.value=q(s.children).forEach(function(t){t.props.selected=n.value.indexOf(t.props.value)!=-1})),l=="select"&&n.defaultValue!=null&&(n.value=q(s.children).forEach(function(t){t.props.selected=n.multiple?n.defaultValue.indexOf(t.props.value)!=-1:n.defaultValue==t.props.value})),s.class&&!s.className?(n.class=s.class,Object.defineProperty(n,"className",ga)):(s.className&&!s.class||s.class&&s.className)&&(n.class=n.className=s.className),a.props=n}(e),e.$$typeof=_a,we&&we(e)};var Be=p.__r;p.__r=function(e){Be&&Be(e),e.__c};var Me=p.diffed;p.diffed=function(e){Me&&Me(e);var a=e.props,s=e.__e;s!=null&&e.type==="textarea"&&"value"in a&&a.value!==s.value&&(s.value=a.value==null?"":a.value)};const ba=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False\r
...
`,ya=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing"],Sa=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean"],E=ba.split(`\r
`).map(e=>{const a=e.split(",");let s={};for(let l=0;l<a.length;l++){let n;switch(Sa[l]){case"number":n=Number(a[l]);break;case"boolean":n=a[l]==="True";break;case"number[]":a[l]===""?n=[]:n=a[l].split(":").map(r=>Number(r));break;default:n=a[l]}s[ya[l]]=n}return s});console.log({Appliances:E});class ka{constructor(a){y(this,"Staple");y(this,"Tags");y(this,"StapleWhenMissing");y(this,"Appliance");y(this,"IsRemoved");y(this,"Filter");y(this,"DecorationRequired");y(this,"SellAsUpgrade");this.Appliance=a,this.Tags=a.ShoppingTags,this.DecorationRequired=a.ThemeRequired,this.SellAsUpgrade=a.IsPurchasableAsUpgrade,this.Filter=a.ShopRequirementFilter,this.StapleWhenMissing=a.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(a){return a&1?this.Staple!==0:a&this.Tags?this.Staple===0:!1}}var B=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(B||{}),A=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(A||{});const xe={DefaultShoppingTag:892};var je=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(je||{}),re=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(re||{});console.log({Appliances:E});const Ca=38;function Pa(e,a){let s=e.length;for(;s-- >1;){let l=a.range(0,s+1);[e[s],e[l]]=[e[l],e[s]]}return e}class te{constructor(a,s){y(this,"fixedSeed");y(this,"instance");y(this,"random");typeof a=="string"&&(a=Ke(a)),this.fixedSeed=a,this.instance=s,this.random=new wa(a+Math.imul(124192293,s))}useSubcontext(a){return new te(this.fixedSeed,124192293*a+this.instance)}}class wa{constructor(a){y(this,"seed");const s=u=>Math.imul(1812433253,u)+1>>0,l=a>>0,n=s(l),r=s(n),i=s(r);this.seed=[l,n,r,i]}get value(){let a=this.seed.shift(),s=this.seed[2];return a^=a<<11,a^=a>>>8,s^=s>>>19,s=(s^a)>>0,this.seed.push(s),s}range(a,s){return(this.value>>>0)%(s-a)+a}valueFloat(){return(this.value<<9>>>0)/4294967295}}function Ke(e){const s=new TextEncoder().encode(e);let l=5381,n=s.length;for(;n>0;){let r=--n;l=(l<<5)+l+s[r]}return l>>0}const Ba=["azq7nnr5","aztyybbn","azzl75ps","azfrpdtn","azx7du9f","azuk8x3h","azfrioyp","azsjncr5","azx1pdvg","az3dvf9n","azogzs1j","azdrxikt","azor2ecm","azv3vjqc","azm79wsl","az4gzho1","az4rdcny","azc6txsh","aza892mm","az4s7okx","az9jyczp","az8ys73s","azo2i2cw","azrhwuox","azeuphhl","azoizg49","az2xqai6","az2ylrdd","az5xnena","az29g4uu","azjnc9s9","azmq4vw5","azkeqani","azqey8eg"];console.log(Ba.map(e=>Ke(e)).join(","));let Re=0,Ae=0,Ne=0;const Ma=E.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class xa{constructor(a,s=0){y(this,"seed");y(this,"mapSize");y(this,"baseUpgradeChance");y(this,"OwnedAppliances");y(this,"Cards");this.seed=a,this.mapSize=1,this.baseUpgradeChance=s,this.OwnedAppliances=[],this.Cards=[]}addCard(a){a!==void 0&&(this.Cards.push(a),this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(s=>E.filter(l=>l.ID===s))))}getPrngAdvancements(a){let s=0;for(const l of a)s+=l.blueprintCount*(Ma-1+1),l.spawnInside||(s+=Ra(l.playerInside,this.mapSize)),s+=Ca;return s}buildShopOptions(a,s,l){let n=[];for(const i of E)if(!(!i.IsPurchasable&&!i.IsPurchasableAsUpgrade)){var r=new ka(i);if(r.Staple==B.NonStaple||r.Staple==B.WhenMissing){if((r.Tags&A.Basic)>A.None)r.Staple=B.FixedStaple;else if(r.StapleWhenMissing){const o=r.Appliance.Name;o!="Research Desk"&&o!="Blueprint Cabinet"&&o!="Plates"&&console.log(`Unexpected ${r.Appliance.Name} StapleWhenMissing Appliance`),a.includes(r.Appliance)?r.Staple=B.NonStaple:r.Staple=B.WhenMissing}}const t=r.Appliance;if(t.SellOnlyAsDuplicate)a.includes(t)||(r.IsRemoved=!0);else if(t.RequiresForShop.length>0){let o=!1;for(const c of t.RequiresForShop)a.some(F=>F.ID===c)&&(o=!0);r.IsRemoved=!o}else t.SellOnlyAsUnique&&(t.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${t.Name}, ${t.ID}`),r.IsRemoved=!0);r.Filter==je.RefreshableProvider,r.DecorationRequired!=re.Null&&r.DecorationRequired!=s&&(r.IsRemoved=!0),t.RequiresProcessForShop.length>0&&(t.RequiresProcessForShop.some(o=>l.some(c=>c.RequiredProcesses.includes(o)))||(r.IsRemoved=!0)),n.push(r)}return n}initRandom(a){return new te(this.seed,823828*1231231+a)}getAppliances(a,s){const l=a.length===1,n=this.buildShopOptions(this.OwnedAppliances,re.Null,this.Cards),r=this.initRandom(s).random;let i=this.getPrngAdvancements(a.slice(0,a.length-1));for(;i--;)r.value;let u=a[a.length-1].blueprintCount,t;if(s%5==0){l&&(u=8),t=[];for(let o=0;o<u;o++)t[o]=A.Decoration}else if(a.length>1){t=[];for(let o=0;o<u;o++)t[o]=xe.DefaultShoppingTag}else{const o=xe.DefaultShoppingTag,c=Math.max(1,u),F=Math.max(0,Math.min(4,Math.max(2,4-Math.floor(s/5)),c)),m=Math.max(0,c-F);u=c,t=[];for(let _=0;_<F;_++)t[_]=A.Basic;for(let _=F;_<F+m;_++)t[_]=o}{const o=[...n],c=[],F=1-(1-Math.floor(s/5)*.1)*(1-this.baseUpgradeChance),m=[];for(let _=0;_<u;_++){const T=t[_],d=r.valueFloat()<F;Ne+=F,d?Re++:Ae++,Pa(o,r);for(let f=0;f<o.length;f++){const h=o[f];if(!h.IsRemoved&&!m.includes(h.Appliance)&&!!h.MatchesRequestTags(T)&&!(!d&&h.Staple==B.NonStaple&&h.SellAsUpgrade)){T!=A.Decoration&&m.push(h.Appliance),c[_]=h.Appliance;break}}c[_]==null&&console.log(`Wasn't able to find a valid roll for blueprint ${_}`)}return console.log({upgradesAllowed:Re,upgradesDisallowed:Ae,expectedUpgrades:Ne}),c}}}function Ra(e,a){let s=60;switch(a){case 1:s=60;break;case 2:s=70;break;case 3:s=9*13;break;case 4:s=16*12;break;default:console.log(`Unknown Map Size ${a}`),s=60;break}return e?s-2:s-1}const Aa=`-85470894,Black Coffee,-1316622579,-1609758240\r
...
`,Ye=Aa.split(`\r
`).map(e=>{var t,o;const[a,s,l,n]=e.split(","),r=Number(a),i=((t=l==null?void 0:l.split(":"))==null?void 0:t.map(c=>Number(c)))??[],u=((o=n==null?void 0:n.split(":"))==null?void 0:o.map(c=>Number(c)))??[];return{ID:r,Name:s,RequiredProcesses:i,IngredientProviders:u}});console.log({Unlocks:Ye});var Na=0;function g(e,a,s,l,n,r){var i,u,t={};for(u in a)u=="ref"?i=a[u]:t[u]=a[u];var o={type:e,props:t,key:s,ref:i,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,constructor:void 0,__v:--Na,__i:-1,__u:0,__source:n,__self:r};if(typeof e=="function"&&(i=e.defaultProps))for(u in i)t[u]===void 0&&(t[u]=i[u]);return p.vnode&&p.vnode(o),o}const Ea=[!0,!1],Oa=[!0,!1];function Da(e){return[5,8,10,12,13,15,16,18,19,20,21,22,23,24,25][e-1]+1}const Ia=["Breakfast",,,"Breakfast Eggs",,"Exclusive","Breakfast Extras",,,"Breakfast Beans",,,"Pumpkin Seed"],za=({seed:e,day:a=1,blueprintCount:s,upgradeChance:l,ownedAppliances:n,cardsByDay:r})=>{console.log({ownedAppliances:n});const i=new xa(e,l);for(let d=0;d<=a;d++)if(r[d]){const f=Ye.filter(h=>h.Name===r[d])[0];f&&i.addCard(f)}const u=Object.entries(n).filter(d=>d[1]).map(d=>d[0]).map(d=>E.filter(f=>f.Name===d)[0]);for(const d of u)d&&i.OwnedAppliances.push(d);console.log(i.OwnedAppliances);let t=[];for(const d of Oa)for(const f of Ea)if(t.push({spawnInside:d,playerInside:d?void 0:f,blueprintCount:s}),d)break;const o=[];let c=[[],[],[],[]];for(let d=0;d<t.length;d++)for(let f=0;f<t.length;f++){o.push([t[d],t[f]]);const h=[t[d].spawnInside,t[d].playerInside,t[f].spawnInside,t[f].playerInside];for(let v=0;v<h.length;v++)c[v].length&&c[v].at(-1).val===h[v]?c[v].at(-1).run+=1:c[v].push({val:h[v],run:1})}let F=[];const m=s,_=4,T=Da(a);console.log({day:a,CAP:T});for(let d=0;d<T;d++){const f=[];for(const h of d?o:o.map(v=>[v[0]])){const v=[...h];d&&v.splice(-1,1,{...v.at(-1),blueprintCount:m+_}),f.push(i.getAppliances(v,a).map(C=>C.Name))}if(F.push(f),d)for(let h=0;h<o.length;h++)o[h].push(o[h][o[h].length-1])}const S=(d,f)=>{switch(d){case 0:return f?"Spawn Inside":"Spawn Outside";case 1:return f===void 0?"":f?"Stand Inside at End of Day":"Everyone Outside at End of Day";case 2:return f?"Spawn Inside for Rerolls":"Spawn Outside for Rerolls";case 3:return f===void 0?"":f?"Someone Inside when Rerolling":"Everyone Outside when Rerolling";default:throw new Error("Too Many Headers")}};return g("table",{children:[g("thead",{children:c.map((d,f)=>g("tr",{children:[!f&&g("th",{colSpan:1,rowSpan:4,children:"Reroll #"}),d.map(h=>h.val!==void 0&&g("th",{colSpan:h.run,rowSpan:S(f,h.val).indexOf("Spawn Inside")>-1?2:1,scope:"colgroup",children:S(f,h.val)}))]}))}),F.map((d,f)=>g("tr",{children:[g("th",{children:f||"Spawn"}),f?d.map(h=>g("td",{colspan:1,children:h.map((v,C)=>g("span",{class:C<m?"":"ghost",children:v+(C<h.length-1?", ":"")}))})):g("td",{style:"text-align:center;",colSpan:16,children:d[0].join(", ")})]}))]})},Ze=["Blueprint Cabinet","Plates","Research Desk"],oe={};for(const e of Ze)oe[e]=!1;oe["Blueprint Cabinet"]=!0;const Ha="t4tmhm8r",Ua=()=>{const[e,a]=Z(Ha),[s,l]=Z(1),[n,r]=Z(oe);let i=[];switch(e){case"az95tz5z":i=["Stir Fry","Broccoli","Steak Stir Fry","Mashed Potato","Mushroom Stir Fry","Affordable","Ice Cream","Herd Mentality","Roast Potato","Health and Safety","Victorian Standards","Instant Service","All You Can Eat","Bamboo","Chips"];break;case"t4tmhm8r":i=Ia;break;default:i=[];break}const u={seed:e,day:s,upgradeChance:e.indexOf("az")>-1?.25:0,blueprintCount:e.indexOf("az")>-1?7:5,ownedAppliances:n,cardsByDay:i},t=F=>{l(Number(F.target.value))},o=F=>{a(F.target.value)},c=F=>{const m=F.target;r(_=>({..._,[m.id]:m.checked}))};return g(x,{children:[g("h3",{children:["Seed: ",g("input",{value:e,disabled:!0,onChange:o})]}),g("label",{children:"Shop after completing day "}),g("input",{style:"border:none;width:2.5em",type:"number",value:s,onChange:t}),g("div",{children:Ze.map(F=>g("div",{style:"margin:5	px",children:[g("label",{for:F,children:["Own ",F,"?"]}),g("input",{type:"checkbox",checked:n[F],id:F,onChange:c})]}))}),g(za,{...u})]})};ra(g(Ua,{}),document.getElementById("app"));
