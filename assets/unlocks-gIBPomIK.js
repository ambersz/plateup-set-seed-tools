...
-373772933,Simple Cloth Table,5,,,,,False,False,6`,q=pr.split(`\r
`).filter(e=>e).map(e=>{var U,L;const[r,a,n,s,t,o,i,_,c,v]=e.split(","),b=Number(r),F=Number(n),H=s!=null&&s.length?s.split(":").map(h=>Number(h)):[],he=t.length?t.split(":").map(h=>Number(h)):[],me=o!=null&&o.length?(U=o==null?void 0:o.split(":"))==null?void 0:U.map(h=>Number(h)):[],ve=i!=null&&i.length?(L=i==null?void 0:i.split(":"))==null?void 0:L.map(h=>Number(h)):[],ye=_==="True",Se=c==="True",ge=Number(v);return{ID:b,Name:a,UnlockGroup:F,Requires:H,BlockedBy:he,RequiredProcesses:me,IngredientProviders:ve,isMain:ye,isStarterOrSide:Se,DishType:ge}});function mr(e,r=!0){const a=r&&e.some(n=>n.Name==="Community");return q.filter(n=>!(e.some(s=>s.ID===n.ID)||n.BlockedBy.some(s=>e.some(t=>t.ID===s))||n.Requires.some(s=>!e.some(t=>t.ID===s))||n.isStarterOrSide&&!e.some(s=>s.isMain)||!a&&n.DishType===m.Base)).sort((n,s)=>n.ID-s.ID)}const vr=[{ID:447437163,Name:"Country",UnlockGroup:y.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null},{ID:2002876295,Name:"City",UnlockGroup:y.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null},{ID:-1864906012,Name:"Alpine",UnlockGroup:y.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null},q.filter(e=>e.Name==="Community")[0],{ID:1766067755,Name:"Romantic",UnlockGroup:y.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null},{ID:1958825350,Name:"Turbo",UnlockGroup:y.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null}],yr=["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(e=>q.filter(r=>r.Name===e)[0]);export{m as D,w as F,vr as R,yr as S,Be as T,y as U,Ne as _,q as a,mr as g,le as h,ie as p,oe as s,hr as w,R as y};
